  ...
  (function(w) {
      ...
      a.CenteredSeriesMixin = {
        getCenter: function() {
          var a = this.options,
              ...
              g;
          for (k = 0; 4 > k; ++k)
            g = c[k], a = 2 > k || 2 === k && /%$/.test(g), c[k] = n(g, [b, e, f, c[2]][k]) + (a ? h : 0);
          c[3] > c[2] && (c[3] = c[2]);
          return c;
        },
    ...
    (function(a) {
      ...
      n(r.prototype, {
        ...
        setOptions: function(a) {
          this.options = p(this.defaultOptions, this.chart.angular ? {background: {}} : void 0, a);
        },
        render: function() {
          var a = this.options,
          ...
          if (b)
            for (b = e(b), a = Math.max(b.length, this.background.length || 0), c = 0; c < a; c++)
              b[c] && this.axis ? this.renderBackground(p(this.defaultBackgroundOptions, b[c]), c) : this.background[c] && (this.background[c] = this.background[c].destroy(), this.background.splice(c, 1));
        },
    ...
    (function(a) {
      var r = a.each,
          ...
          k = a.Axis.prototype,
          g = a.Tick.prototype;
      a.radialAxisExtended || (a.radialAxisExtended = !0, c = {
        getOffset: p,
        redraw: function() {
          this.isDirty = !1;
        },
        ...
        getLinePath: function(b, c) {
          ...
          this.isCircular || void 0 !== c ? (c = this.chart.renderer.symbols.arc(this.left + b[0], this.top + b[1], a, a, {
            start: this.startAngleRad,
            end: this.endAngleRad,
            open: !0,
            innerR: 0
          }), c.xBounds = [this.left + b[0]], c.yBounds = [this.top + b[1] - a]) : (c = this.postTranslate(this.angleRad, a), c = ["M", b[0] + d.plotLeft, b[1] + d.plotTop, "L", c.x, c.y]);
          return c;
        },
        ...
        getPlotBandPath: function(b, c, a) {
          var d = this.center,
              ...
              p,
              y = this.isCircular;
          "polygon" === this.options.gridLineInterpolation ? d = this.getPlotLinePath(b).concat(this.getPlotLinePath(c, !0)) : (b = Math.max(b, this.min), c = Math.min(c, this.max), y || (m[0] = this.translate(b), m[1] = this.translate(c)), m = t(m, function(b) {
            u.test(b) && (b = h(b, 10) * g / 100);
            return b;
          }), "circle" !== a.shape && y ? (b = f + this.translate(b), c = f + this.translate(c)) : (b = -Math.PI / 2, c = 1.5 * Math.PI, p = !0), m[0] -= k, m[2] -= k, d = this.chart.renderer.symbols.arc(this.left + d[0], this.top + d[1], m[0], m[0], {
            start: Math.min(b, c),
            end: Math.max(b, c),
        ...
        getPlotLinePath: function(b, c) {
          var d = this,
              ...
              k,
              e;
          d.isCircular ? e = ["M", a[0] + f.plotLeft, a[1] + f.plotTop, "L", g.x, g.y] : "circle" === d.options.gridLineInterpolation ? (b = d.translate(b)) && (e = d.getLinePath(0, b)) : (r(f.xAxis, function(b) {
            b.pane === d.pane && (m = b);
          }), e = [], b = d.translate(b), a = m.tickPositions, m.autoConnect && (a = a.concat([a[0]])), c && (a = [].concat(a).reverse()), r(a, function(c, d) {
            k = m.getPosition(c, b);
        ...
        if (d) {
          ...
          m && (v(this, f), this.defaultRadialOptions = (x = k) ? this.defaultRadialXOptions : n(this.defaultYAxisOptions, this.defaultRadialYOptions));
        d || m ? (this.isRadial = !0, a.inverted = !1, p.chart.zoomType = null) : this.isRadial = !1;
        y && x && (y.axis = this);
        b.call(this, a, g);
        !u && y && (d || m) && (b = this.options, this.angleRad = (b.angle || 0) * Math.PI / 180, this.startAngleRad = (h.startAngle - 90) * Math.PI / 180, this.endAngleRad = (e(h.endAngle, h.startAngle + 360) - 90) * Math.PI / 180, this.offset = b.offset || 0, this.isCircular = x);
        ...
        d.isRadial ? (b = d.getPosition(this.pos, d.center[2] / 2 + e(k.distance, -25)), "auto" === k.rotation ? g.attr({rotation: q}) : null === m && (m = d.chart.renderer.fontMetrics(g.styles.fontSize).b - g.getBBox().height / 2), null === u && (d.isCircular ? (this.label.getBBox().width > d.len * d.tickInterval / (d.max - d.min) && (l = 0), u = q > l && q < 180 - l ? "left" : q > 180 + l && q < 360 - l ? "right" : "center") : u = "center", g.attr({align: u})), b.x += k.x, b.y += m) : b = b.call(this, c, a, g, f, k, p, x, h);
        return b;
      }), b(g, "getMarkPath", function(b, c, a, g, f, k, e) {
        var d = this.axis;
        d.isRadial ? (b = d.getPosition(this.pos, d.center[2] / 2 + g), c = ["M", c, a, "L", b.x, b.y]) : c = b.call(this, c, a, g, f, k, e);
        return c;
      }));
    })(w);
    (function(a) {
      ...
      n("arearange", "area", {
        ...
        translate: function() {
          ...
          r(b.points, function(f) {
            var g = f.low,
                d = f.high,
                m = f.plotY;
            null === d || null === g ? (f.isNull = !0, f.plotY = null) : (f.plotLow = m, f.plotHigh = c.translate(a ? b.modifyValue(d, f) : d, 0, 1, 0, 1), a && (f.yBottom = f.plotHigh));
          });
        ...
        getGraphPath: function(b) {
          ...
          b = b || this.points;
          for (k = b.length; k--; )
            d = b[k], d.isNull || l || q || b[k + 1] && !b[k + 1].isNull || a.push({
              plotX: d.plotX,
              plotY: d.plotY,
              doCurve: !1
            }), m = {
              ...
              plotY: d.plotHigh,
              isNull: d.isNull
            }, a.push(m), c.push(m), d.isNull || l || q || b[k - 1] && !b[k - 1].isNull || a.push({
              plotX: d.plotX,
              plotY: d.plotY,
              doCurve: !1
            });
        ...
        drawDataLabels: function() {
          ...
          if (g.enabled || this._hasPointLabels) {
            for (a = c; a--; )
              if (l = b[a])
                q = u ? l.plotHigh < l.plotLow : l.plotHigh > l.plotLow, l.y = l.high, l._plotY = l.plotY, l.plotY = l.plotHigh, k[a] = l.dataLabel, l.dataLabel = l.dataLabelUpper, l.below = q, z ? d || (g.align = q ? "right" : "left") : m || (g.verticalAlign = q ? "top" : "bottom"), g.x = g.xHigh, g.y = g.yHigh;
            e.drawDataLabels && e.drawDataLabels.apply(this, arguments);
            for (a = c; a--; )
              if (l = b[a])
                q = u ? l.plotHigh < l.plotLow : l.plotHigh > l.plotLow, l.dataLabelUpper = l.dataLabel, l.dataLabel = k[a], l.y = l.low, l.plotY = l._plotY, l.below = !q, z ? d || (g.align = q ? "left" : "right") : m || (g.verticalAlign = q ? "bottom" : "top"), g.x = g.xLow, g.y = g.yLow;
            e.drawDataLabels && e.drawDataLabels.apply(this, arguments);
          }
          g.align = d;
          g.verticalAlign = m;
        ...
        drawPoints: function() {
          ...
          for (a = 0; a < b; )
            c = this.points[a], c.lowerGraphic = c.graphic, c.graphic = c.upperGraphic, c._plotY = c.plotY, c._plotX = c.plotX, c.plotY = c.plotHigh, t(c.plotHighX) && (c.plotX = c.plotHighX), c._isInside = c.isInside, this.chart.polar || (c.isInside = c.isTopInside = void 0 !== c.plotY && 0 <= c.plotY && c.plotY <= this.yAxis.len && 0 <= c.plotX && c.plotX <= this.xAxis.len), a++;
          e.drawPoints.apply(this, arguments);
          for (a = 0; a < b; )
            c = this.points[a], c.upperGraphic = c.graphic, c.graphic = c.lowerGraphic, c.isInside = c._isInside, c.plotY = c._plotY, c.plotX = c._plotX, a++;
        },
        ...
        destroyElements: function() {
          r(["lowerGraphic", "upperGraphic"], function(b) {
    ...
    (function(a) {
      ...
      e("columnrange", "arearange", t(r.column, r.arearange, {
        pointRange: null,
        marker: null,
        states: {hover: {halo: !1}}
      }), {
        translate: function() {
          ...
          v(b.points, function(f) {
            ...
            Math.abs(h) < e ? (e -= h, h += e, n -= e / 2) : 0 > h && (h *= -1, n -= h);
            m ? (g = f.barX + k, f.shapeType = "path", f.shapeArgs = {d: b.polarArc(n + h, n, g, g + f.pointWidth)}) : (q.height = h, q.y = n, f.tooltipPos = d.inverted ? [c.len + c.pos - d.plotLeft - n - h / 2, a.len + a.pos - d.plotTop - q.x - q.width / 2, h] : [a.left - d.plotLeft + q.x + q.width / 2, c.pos - d.plotTop + n + h / 2, h]);
          });
        },
        directTouch: !0,
      ...
      h("gauge", "line", {
        ...
        translate: function() {
          ...
          r(this.points, function(c) {
            ...
            v(h) ? (h = h / 180 * Math.PI, x = Math.max(b.startAngleRad - h, Math.min(b.endAngleRad + h, x))) : !1 === a.wrap && (x = Math.max(b.startAngleRad, Math.min(b.endAngleRad, x)));
            x = 180 * x / Math.PI;
            c.shapeType = "path";
            c.shapeArgs = {
              d: d.path || ["M", -l, -q / 2, "L", f, -q / 2, g, -e / 2, g, e / 2, f, q / 2, -l, q / 2, "z"],
              translateX: k[0],
              translateY: k[1],
              rotation: x
            };
        ...
        drawPoints: function() {
          ...
          r(b.points, function(c) {
            var a = c.graphic,
                ...
                f = d.d,
                k = t(g.dial, c.dial);
            a ? (a.animate(d), d.d = f) : (c.graphic = m[c.shapeType](d).attr({
              rotation: d.rotation,
              zIndex: 1
          ...
          k ? k.animate({
            translateX: a[0],
            translateY: a[1]
          }) : (b.pivot = m.circle(0, 0, n(d.radius, 5)).attr({zIndex: 2}).addClass("highcharts-pivot").translate(a[0], a[1]).add(b.group), b.pivot.attr({
        ...
        animate: function(b) {
          var c = this;
          b || (r(c.points, function(b) {
            var a = b.graphic;
            a && (a.attr({rotation: 180 * c.yAxis.startAngleRad / Math.PI}), a.animate({rotation: b.shapeArgs.rotation}, c.options.animation));
          }), c.animate = null);
        },
        render: function() {
        ...
        drawPoints: function() {
          ...
          r(a.points, function(e) {
            var z = e.graphic,
                ...
                I = {},
                C = e.color || a.color;
            void 0 !== e.plotY && (l = J.width, q = Math.floor(J.x), p = q + l, n = Math.round(l / 2), c = Math.floor(x ? e.q1Plot : e.lowPlot), f = Math.floor(x ? e.q3Plot : e.lowPlot), k = Math.floor(e.highPlot), g = Math.floor(e.lowPlot), z || (e.graphic = z = b.g("point").add(a.group), e.stem = b.path().addClass("highcharts-boxplot-stem").add(z), B && (e.whiskers = b.path().addClass("highcharts-boxplot-whisker").add(z)), x && (e.box = b.path(void 0).addClass("highcharts-boxplot-box").add(z)), e.medianShape = b.path(void 0).addClass("highcharts-boxplot-median").add(z)), y.stroke = e.stemColor || h.stemColor || C, y["stroke-width"] = t(e.stemWidth, h.stemWidth, h.lineWidth), y.dashstyle = e.stemDashStyle || h.stemDashStyle, e.stem.attr(y), B && (H.stroke = e.whiskerColor || h.whiskerColor || C, H["stroke-width"] = t(e.whiskerWidth, h.whiskerWidth, h.lineWidth), e.whiskers.attr(H)), x && (w.fill = e.fillColor || h.fillColor || C, w.stroke = h.lineColor || C, w["stroke-width"] = h.lineWidth || 0, e.box.attr(w)), I.stroke = e.medianColor || h.medianColor || C, I["stroke-width"] = t(e.medianWidth, h.medianWidth, h.lineWidth), e.medianShape.attr(I), m = e.stem.strokeWidth() % 2 / 2, u = q + n + m, e.stem[r]({d: ["M", u, f, "L", u, k, "M", u, c, "L", u, g]}), x && (m = e.box.strokeWidth() % 2 / 2, c = Math.floor(c) + m, f = Math.floor(f) + m, q += m, p += m, e.box[r]({d: ["M", q, f, "L", q, c, "L", p, c, "L", p, f, "L", q, f, "z"]})), B && (m = e.whiskers.strokeWidth() % 2 / 2, k += m, g += m, v = /%$/.test(B) ? n * parseFloat(B) / 100 : B / 2, e.whiskers[r]({d: ["M", u - v, k, "L", u + v, k, "M", u - v, g, "L", u + v, g]})), d = Math.round(e.medianPlot), m = e.medianShape.strokeWidth() % 2 / 2, d += m, e.medianShape[r]({d: ["M", q, d, "L", p, d]}));
          });
        },
        setStackedPoints: v
      });
      ...
      e("waterfall", "column", {
        ...
        translate: function() {
          ...
          for (b = k.length; f < b; f++)
            g = k[f], l = this.processedYData[f], d = g.shapeArgs, m = y && a.stacks[(this.negStacks && l < w ? "-" : "") + this.stackKey], A = this.getStackIndicator(A, g.x, this.index), n = t(m && m[g.x].points[A.key], [0, l]), g.isSum ? g.y = r(l) : g.isIntermediateSum && (g.y = r(l - p)), e = Math.max(q, q + g.y) + n[0], d.y = a.translate(e, 0, 1, 0, 1), g.isSum ? (d.y = a.translate(n[1], 0, 1, 0, 1), d.height = Math.min(a.translate(n[0], 0, 1, 0, 1), a.len) - d.y) : g.isIntermediateSum ? (d.y = a.translate(n[1], 0, 1, 0, 1), d.height = Math.min(a.translate(p, 0, 1, 0, 1), a.len) - d.y, p = n[1]) : (d.height = 0 < l ? a.translate(q, 0, 1, 0, 1) - d.y : a.translate(q, 0, 1, 0, 1) - a.translate(q - l, 0, 1, 0, 1), q += m && m[g.x] ? m[g.x].total : l), 0 > d.height && (d.y += d.height, d.height *= -1), g.plotY = d.y = Math.round(d.y) - this.borderWidth % 2 / 2, d.height = Math.max(Math.round(d.height), .001), g.yBottom = d.y + d.height, d.height <= x && !g.isNull ? (d.height = x, d.y -= v, g.plotY = d.y, g.minPointLengthOffset = 0 > g.y ? -v : v) : g.minPointLengthOffset = 0, d = g.plotY + (g.negative ? d.height : 0), this.chart.inverted ? g.tooltipPos[0] = a.len - d : g.tooltipPos[1] = d;
        },
        processData: function(b) {
          ...
          for (h = 0; h < g; h++)
            q = a[h], k = f && f[h] ? f[h] : {}, "sum" === q || k.isSum ? a[h] = r(m) : "intermediateSum" === q || k.isIntermediateSum ? a[h] = r(d) : (m += q, d += q), e = Math.min(m, e), l = Math.max(m, l);
        ...
        getCrispPath: function() {
          ...
          for (l = 1; l < a; l++) {
            e = b[l].shapeArgs;
            m = b[l - 1].shapeArgs;
            e = ["M", m.x + (k ? 0 : m.width), m.y + b[l - 1].minPointLengthOffset + f, "L", e.x + (k ? m.width : 0), m.y + b[l - 1].minPointLengthOffset + f];
        ...
        setStackedPoints: function() {
          ...
          for (f = 1; f < a; f++)
            b.data[f].isSum || b.data[f].isIntermediateSum || (this.stackedYData[f] += this.stackedYData[f - 1]);
        },
    ...
    (function(a) {
      ...
      v("polygon", "scatter", {
        ...
        type: "polygon",
        getGraphPath: function() {
          for (var a = r.prototype.getGraphPath.call(this),
              p = a.length + 1; p--; )
    ...
    (function(a) {
      ...
      g("bubble", "scatter", {
        ...
        getRadii: function(b, a, c, d) {
          ...
          for (g = e.length; k < g; k++)
            f = e[k], l.sizeByAbsoluteValue && null !== f && (f = Math.abs(f - q), a = Math.max(a - q, Math.abs(b - q)), b = 0), null === f ? f = null : f < b ? f = c / 2 - 1 : (f = 0 < u ? (f - b) / u : .5, h && 0 <= f && (f = Math.sqrt(f)), f = Math.ceil(c + f * (d - c)) / 2), m.push(f);
          this.radii = m;
        },
        animate: function(b) {
          var a = this.options.animation;
          b || (p(this.points, function(b) {
            var c = b.graphic,
                d;
            c && c.width && (d = {
              x: c.x,
        ...
        translate: function() {
          ...
          for (b = c.length; b--; )
            g = c[b], f = k ? k[b] : 0, e(f) && f >= this.minPxSize / 2 ? (g.marker = a.extend(g.marker, {
              radius: f,
              width: 2 * f,
              height: 2 * f
            }), g.dlBox = {
        ...
        haloPath: function(b) {
          return f.prototype.haloPath.call(this, 0 === b ? 0 : (this.marker ? this.marker.radius || 0 : 0) + b);
        },
        ttBelow: !1
      });
      t.prototype.beforePadding = function() {
        ...
        p(this.series, function(d) {
          var f = d.options;
          !d.bubblePadding || !d.visible && g.options.chart.ignoreHiddenSeries || (a.allowZoomOutside = !0, G.push(d), h && (p(["minSize", "maxSize"], function(b) {
            var a = f[b],
                d = /%$/.test(a),
                a = c(a);
            w[b] = d ? y * a / 100 : a;
          }), d.minPxSize = w.minSize, d.maxPxSize = Math.max(w.maxSize, w.minSize), d = d.zData, d.length && (A = b(f.zMin, Math.min(A, Math.max(v(d), !1 === f.displayNegative ? f.zThreshold : -Number.MAX_VALUE))), E = b(f.zMax, Math.max(E, r(d))))));
        });
        p(G, function(b) {
          var c = b[n],
              d = c.length,
          ...
          if (0 < F)
            for (; d--; )
              e(c[d]) && a.dataMin <= c[d] && c[d] <= a.dataMax && (g = b.radii[d], f = Math.min((c[d] - t) * D - g, f), k = Math.max((c[d] - t) * D + g, k));
        });
        G.length && 0 < F && !this.isLog && (k -= d, D *= (d + f - k) / d, p([["min", "userMin", f], ["max", "userMax", k]], function(c) {
    ...
    (function(a) {
      ...
      if (!a.polarExtended) {
        ...
        p.searchPointByAngle = function(b) {
          ...
          return this.searchKDTree({clientX: 180 + -180 / Math.PI * Math.atan2(b.chartX - f[0] - a.plotLeft, b.chartY - f[1] - a.plotTop)});
        };
        ...
        p.toXY = function(b) {
          ...
          this.kdByAngle ? (f = (k / Math.PI * 180 + this.xAxis.pane.options.startAngle) % 360, 0 > f && (f += 360), b.clientX = f) : b.clientX = b.plotX;
        };
        t.spline && (n(t.spline.prototype, "getPointSpline", function(b, a, f, k) {
          this.chart.polar ? k ? (b = this.getConnectors(a, k, !0, this.connectEnds), b = ["C", b.prevPointCont.rightContX, b.prevPointCont.rightContY, b.leftContX, b.leftContY, b.plotX, b.plotY]) : b = ["M", f.plotX, f.plotY] : b = b.call(this, a, f, k);
          return b;
        }), t.areasplinerange && (t.areasplinerange.prototype.getPointSpline = t.spline.prototype.getPointSpline));
        ...
        n(p, "getGraphPath", function(b, a) {
          ...
          if (this.chart.polar) {
            ...
            !1 !== this.options.connectEnds && void 0 !== g && (this.connectEnds = !0, a.splice(a.length, 0, a[g]), d = !0);
            r(a, function(b) {
        ...
        var h = function(b, a) {
          ...
          c.polar ? c.renderer.isSVG && (!0 === e && (e = {}), a ? (b = {
            ...
            scaleX: .001,
            scaleY: .001
          }, g.attr(b), d && d.attr(b)) : (b = {
            translateX: n,
            translateY: l,
            scaleX: 1,
            scaleY: 1
          }, g.animate(b, e), d && d.animate(b, e), this.animate = null)) : b.call(this, a);
        };
        n(p, "animate", h);
        t.column && (t = t.column.prototype, t.polarArc = function(b, a, f, e) {
        ...
        }, n(t, "animate", h), n(t, "translate", function(a) {
          var b = this.xAxis,
              f = b.startAngleRad,
              e,
              g,
          ...
          this.chart.polar ? (a = c.rectPlotX / Math.PI * 180, null === e.align && (e.align = 20 < a && 160 > a ? "left" : 200 < a && 340 > a ? "right" : "center"), null === e.verticalAlign && (e.verticalAlign = 45 > a || 315 < a ? "bottom" : 135 < a && 225 > a ? "top" : "middle"), p.alignDataLabel.call(this, c, f, e, g, d)) : a.call(this, c, f, e, g, d);
        }));
        ...
        a.addEvent(a.Chart.prototype, "beforeGetAxes", function() {
          this.pane || (this.pane = []);
          r(a.splat(this.options.pane), function(b) {
            new a.Pane(b, this);
          }, this);
        });
