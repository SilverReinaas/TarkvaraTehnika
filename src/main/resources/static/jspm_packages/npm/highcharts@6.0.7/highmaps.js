  ...
  (function(S, J) {
    ...
    (function(a) {
      ...
      a.Fx.prototype = {
        dSetter: function() {
          ...
          if (1 === u)
            t = this.toD;
          else if (q === g.length && 1 > u)
            for (; q--; )
              r = parseFloat(a[q]), t[q] = isNaN(r) ? g[q] : u * parseFloat(g[q] - r) + r;
          else
            t = g;
        ...
        update: function() {
          ...
          if (this[g + "Setter"])
            ...
            a.attr ? a.element && a.attr(g, t, null, !0) : a.style[g] = t + this.unit;
          u && u.call(a, t, this);
        },
        run: function(e, g, t) {
          var u = this,
        ...
        step: function(e) {
          var g = +new Date,
              ...
              m = u.duration,
              f = u.curAnim;
          q.attr && !q.element ? e = !1 : e || g >= m + this.startTime ? (this.now = this.end, this.pos = 1, this.update(), t = f[this.prop] = !0, a.objectEach(f, function(a) {
            !0 !== a && (t = !1);
        ...
        initPath: function(e, g, t) {
          function u(a) {
            var b,
                d;
            for (c = a.length; c--; )
              b = "M" === a[c] || "L" === a[c], d = /[a-zA-Z]/.test(a[c + 3]), b && d && a.splice(c + 1, 0, a[c + 1], a[c + 2], a[c + 1], a[c + 2]);
          }
          function q(a, b) {
            for (; a.length < d; ) {
              a[0] = b[d - a.length];
          ...
          function r(a, c) {
            for (var f = (d - a.length) / k; 0 < f && f--; )
              b = a.slice().splice(a.length / C - k, k * C), b[0] = c[d - k - f * k], n && (b[k - 6] = b[k - 2], b[k - 5] = b[k - 1]), [].splice.apply(a, [a.length / C, 0].concat(b)), l && f--;
          }
          g = g || "";
          var m,
              f = e.startX,
      ...
      a.merge = function() {
        var e,
            ...
            q = function(e, m) {
              "object" !== typeof e && (e = {});
              a.objectEach(m, function(f, h) {
                !a.isObject(f, !0) || a.isClass(f) || a.isDOMElement(f) ? e[h] = m[h] : e[h] = q(e[h] || {}, f);
              });
              return e;
            };
      ...
      a.attr = function(e, g, t) {
        var u;
        a.isString(g) ? a.defined(t) ? e.setAttribute(g, t) : e && e.getAttribute && (u = e.getAttribute(g)) : a.defined(g) && a.isObject(g) && a.objectEach(g, function(a, g) {
          e.setAttribute(g, a);
        });
        return u;
      };
      ...
      a.normalizeTickInterval = function(e, g, t, u, q) {
        ...
        t = a.pick(t, 1);
        r = e / t;
        g || (g = q ? [1, 1.2, 1.5, 2, 2.5, 3, 4, 5, 6, 8, 10] : [1, 2, 2.5, 5, 10], !1 === u && (1 === t ? g = a.grep(g, function(a) {
          return 0 === a % 1;
        }) : .1 >= t && (g = [1 / t])));
      ...
      a.animObject = function(e) {
        return a.isObject(e) ? a.merge(e) : {duration: e ? 500 : 0};
      };
      a.timeUnits = {
        millisecond: 1,
        second: 1E3,
      ...
      a.numberFormat = function(e, g, t, u) {
        ...
        -1 === g ? g = Math.min(r, 20) : a.isNumber(g) ? g && h[1] && 0 > h[1] && (m = g + +h[1], 0 <= m ? (h[0] = (+h[0]).toExponential(m).split("e")[0], g = m) : (h[0] = h[0].split(".")[0] || 0, e = 20 > g ? (h[0] * Math.pow(10, h[1])).toFixed(g) : 0, h[1] = 0)) : g = 2;
      ...
      a.getStyle = function(e, g, t) {
        if ("width" === g)
          return Math.min(e.offsetWidth, e.scrollWidth) - a.getStyle(e, "padding-left") - a.getStyle(e, "padding-right");
        if ("height" === g)
          return Math.min(e.offsetHeight, e.scrollHeight) - a.getStyle(e, "padding-top") - a.getStyle(e, "padding-bottom");
        y.getComputedStyle || a.error(27, !0);
        if (e = y.getComputedStyle(e, void 0))
          e = e.getPropertyValue(g), a.pick(t, "opacity" !== g) && (e = a.pInt(e));
        return e;
      };
      ...
      a.stop = function(e, g) {
        for (var t = a.timers.length; t--; )
          a.timers[t].elem !== e || g && g !== a.timers[t].prop || (a.timers[t].stopped = !0);
      };
      ...
      a.objectEach = function(a, g, t) {
        for (var e in a)
          a.hasOwnProperty(e) && g.call(t, a[e], e, a);
      };
      ...
      a.addEvent = function(e, g, t) {
        var u,
            q = e.addEventListener || a.addEventListenerPolyfill;
      ...
      a.removeEvent = function(e, g, t) {
        ...
        function q(f) {
          var h,
              m;
          e.nodeName && (g ? (h = {}, h[g] = !0) : h = f, a.objectEach(h, function(a, d) {
            if (f[d])
              for (m = f[d].length; m--; )
                u(d, f[d][m]);
          }));
      ...
      a.fireEvent = function(e, g, t, u) {
        var q,
            ...
            h;
        t = t || {};
        B.createEvent && (e.dispatchEvent || e.fireEvent) ? (q = B.createEvent("Events"), q.initEvent(g, !0, !0), a.extend(q, t), e.dispatchEvent ? e.dispatchEvent(q) : e.fireEvent(g, q)) : a.each(["protoEvents", "hcEvents"], function(n) {
          if (e[n])
            for (r = e[n][g] || [], m = r.length, t.target || a.extend(t, {
              ...
              (h = r[f]) && !1 === h.call(e, t) && t.preventDefault();
        });
      ...
      a.seriesType = function(e, g, t, u, q) {
        ...
        m[e] = a.extendClass(m[g] || function() {}, u);
      ...
      y.jQuery && (y.jQuery.fn.highcharts = function() {
        ...
        if (this[0])
          return e[0] ? (new (a[a.isString(e[0]) ? e.shift() : "Chart"])(this[0], e[0], e[1]), this) : z[a.attr(this[0], "data-highcharts-chart")];
      });
    })(J);
    (function(a) {
      var z = a.each,
      ...
      a.Color.prototype = {
        ...
        init: function(g) {
          ...
          if ((this.input = g = this.names[g && g.toLowerCase ? g.toLowerCase() : ""] || g) && g.stops)
            this.stops = y(g.stops, function(f) {
              return new a.Color(f[1]);
            });
          else if (g && g.charAt && "#" === g.charAt() && (e = g.length, g = parseInt(g.substr(1), 16), 7 === e ? q = [(g & 16711680) >> 16, (g & 65280) >> 8, g & 255, 1] : 4 === e && (q = [(g & 3840) >> 4 | (g & 3840) >> 8, (g & 240) >> 4 | g & 240, (g & 15) << 4 | g & 15, 1])), !q)
            for (r = this.parsers.length; r-- && !q; )
              m = this.parsers[r], (e = m.regex.exec(g)) && (q = m.parse(e));
          this.rgba = q || [];
        },
        get: function(a) {
          var g = this.input,
              q = this.rgba,
              r;
          this.stops ? (r = e(g), r.stops = [].concat(r.stops), z(this.stops, function(m, f) {
        ...
        brighten: function(a) {
          var e,
              q = this.rgba;
          if (this.stops)
            z(this.stops, function(g) {
              g.brighten(a);
            });
          else if (B(a) && 0 !== a)
            for (e = 0; 3 > e; e++)
              q[e] += g(255 * a), 0 > q[e] && (q[e] = 0), 255 < q[e] && (q[e] = 255);
          return this;
        },
      ...
      a.Time.prototype = {
        ...
        update: function(q) {
          var r = g(q && q.useUTC, !0),
              m = this;
          this.options = q = e(!0, this.options || {}, q);
          this.Date = q.Date || u.Date;
          this.timezoneOffset = (this.useUTC = r) && q.timezoneOffset;
          this.getTimezoneOffset = this.timezoneOffsetFunction();
          (this.variableTimezone = !(r && !q.getTimezoneOffset && !q.timezone)) || this.timezoneOffset ? (this.get = function(a, h) {
            var f = h.getTime(),
            ...
            if (-1 !== a.inArray(f, ["Milliseconds", "Seconds", "Minutes"]))
              ...
              k = m.getTimezoneOffset(h), k = h.getTime() - k, h.setTime(k), h["setUTC" + f](g), f = m.getTimezoneOffset(h), k = h.getTime() + f, h.setTime(k);
        ...
        timezoneOffsetFunction: function() {
          ...
          return this.useUTC && e.getTimezoneOffset ? function(a) {
        ...
        dateFormat: function(g, e, m) {
          ...
          a.objectEach(h, function(a, b) {
            for (; -1 !== g.indexOf("%" + b); )
              g = g.replace("%" + b, "function" === typeof a ? a.call(f, e) : a);
          });
        ...
        getTimeTicks: function(a, e, m, f) {
          ...
          if (z(e)) {
            ...
            b = b.getTime();
            for (e = 1; b < m; )
              n.push(b), b = c === t.year ? h.makeTime(d + e * l, 0) : c === t.month ? h.makeTime(d, f + e * l) : !C || c !== t.day && c !== t.week ? C && c === t.hour && 1 < l ? h.makeTime(d, f, r, x + e * l) : b + c * l : h.makeTime(d, f, r + e * l * (c === t.day ? 1 : 7)), e++;
            n.push(b);
            c <= t.hour && 1E4 > n.length && B(n, function(a) {
    ...
    (function(a) {
      ...
      d(z.prototype, {
        ...
        colorGradient: function(A, b, p) {
          ...
          }), "radialGradient" === f && n && !m(l.gradientUnits) && (F = l, l = G(l, c.getRadialAttr(n, F), {gradientUnits: "userSpaceOnUse"})), I(l, function(a, A) {
            "id" !== A && M.push(A, a);
          }), I(N, function(a) {
            M.push(a);
          }), M = M.join(","), h[M] ? n = h[M].attr("id") : (l.id = n = a.uniqueKey(), h[M] = w = c.createElement(f).attr(l).add(c.defs), w.radAttr = F, w.stops = [], k(N, function(A) {
        ...
        applyTextOutline: function(A) {
          var p = this.element,
              ...
              l,
              F;
          -1 !== A.indexOf("contrast") && (A = A.replace(/contrast/g, this.renderer.getContrast(p.style.fill)));
          A = A.split(" ");
          d = A[A.length - 1];
          if ((f = A[0]) && "none" !== f && a.svg) {
            ...
            f = f.replace(/(^[\d\.]+)(.*?)$/g, function(a, A, b) {
              return 2 * A + b;
            });
            for (F = A.length; F--; )
              c = A[F], "highcharts-text-outline" === c.getAttribute("class") && b(A, p.removeChild(c));
            l = p.firstChild;
            k(A, function(a, A) {
        ...
        attr: function(a, b, p, c) {
          ...
          "string" === typeof a ? l = (this[a + "Getter"] || this._defaultGetter).call(this, a, d) : (I(a, function(A, b) {
            k = !1;
            c || O(this, b);
            this.symbolName && /^(x|y|width|height|r|start|end|innerR|anchorX|anchorY)$/.test(b) && (f || (this.symbolAttr(a), f = !0), k = !0);
        ...
        updateShadows: function(a, b, p) {
          for (var A = this.shadows,
              c = A.length; c--; )
            p.call(A[c], "height" === a ? Math.max(b - (A[c].cutHeight || 0), 0) : "d" === a ? this.d : b, a, A[c]);
        },
        addClass: function(a, b) {
          var A = this.attr("class") || "";
          -1 === A.indexOf(a) && (b || (a = (A + (A ? " " : "") + a).replace("  ", " ")), this.attr("class", a));
          return this;
        },
        hasClass: function(a) {
        ...
        on: function(a, b) {
          ...
          l && "click" === a ? (p.ontouchstart = function(a) {
            ...
            (-1 === Q.navigator.userAgent.indexOf("Android") || 1100 < Date.now() - (A.touchEventFired || 0)) && b.call(p, a);
          }) : p["on" + a] = b;
          return this;
        },
        ...
        updateTransform: function() {
          ...
          d ? a.push("rotate(90) scale(-1,1)") : f && a.push("rotate(" + f + " " + E(this.rotationOriginX, k.getAttribute("x"), 0) + " " + E(this.rotationOriginY, k.getAttribute("y") || 0) + ")");
          (m(p) || m(c)) && a.push("scale(" + E(p, 1) + " " + E(c, 1) + ")");
        ...
        align: function(a, p, c) {
          ...
          var F,
              h;
          if (a) {
            if (this.alignOptions = a, this.alignByTranslate = p, !c || v(c))
              this.alignTo = A = c || "renderer", b(f, this), f.push(this), c = null;
          } else
            a = this.alignOptions, p = this.alignByTranslate, A = this.alignTo;
          c = E(c, d[A], d);
          A = a.align;
          d = a.verticalAlign;
          f = (c.x || 0) + (a.x || 0);
            ...
            if (l.namespaceURI === this.SVG_NS || c.forExport) {
              try {
                (N = this.fakeTS && function(a) {
                  k(l.querySelectorAll(".highcharts-text-outline"), function(b) {
                    b.style.display = a;
                  });
                }) && N("none"), p = l.getBBox ? d({}, l.getBBox()) : {
                  width: l.offsetWidth,
        ...
        destroy: function() {
          ...
          O(a);
          l && d && (k(d.querySelectorAll("[clip-path],[CLIP-PATH]"), function(a) {
            var b = a.getAttribute("clip-path"),
                p = l.element.id;
            (-1 < b.indexOf("(#" + p + ")") || -1 < b.indexOf('("#' + p + '")')) && a.removeAttribute("clip-path");
          ...
          for (a.destroyShadows(); c && c.div && 0 === c.div.childNodes.length; )
            p = c.parentGroup, a.safeRemoveChild(c.div), delete c.div, c = p;
        ...
        shadow: function(a, b, p) {
          ...
          if (!a)
            ...
            for (d = 1; d <= k; d++)
              A = l.cloneNode(0), f = 2 * k + 1 - 2 * d, g(A, {
                isShadow: "true",
                ...
                fill: "none"
              }), p && (g(A, "height", Math.max(g(A, "height") - f, 0)), A.cutHeight = f), b ? b.element.appendChild(A) : l.parentNode && l.parentNode.insertBefore(A, l), c.push(A);
            this.shadows = c;
          }
          return this;
        },
        ...
        zIndexSetter: function(a, b) {
          ...
          if (f) {
            ...
            b = l.childNodes;
            for (h = b.length - 1; 0 <= h && !F; h--)
              if (d = b[h], f = d.zIndex, A = !m(f), d !== k)
                if (0 > a && A && !c && !h)
                  l.insertBefore(k, b[h]), F = !0;
                else if (p(f) <= a || A && (!m(a) || 0 <= a))
                  l.insertBefore(k, b[h + 1] || null), F = !0;
      ...
      d(B.prototype, {
        ...
        applyEllipsis: function(a, b, p, c) {
          ...
          if (A = l > c) {
            for (; k <= F; )
              f = Math.ceil((k + F) / 2), l = p.substring(0, f) + "\u2026", h(l), l = this.getSpanWidth(a, b), k === F ? k = F + 1 : l > c ? F = f - 1 : k = f;
            0 === F && h("");
          }
          a.rotation = d;
          return A;
        ...
        buildText: function(a) {
          ...
          if (K !== a.textCache) {
            for (a.textCache = K; t--; )
              b.removeChild(h[t]);
            F || v || P || x || -1 !== f.indexOf(" ") ? (A = /<.*class="([^"]+)".*>/, w = /<.*style="([^"]+)".*>/, m = /<.*href="([^"]+)".*>/, e && e.appendChild(b), f = F ? f.replace(/<(b|strong)>/g, '\x3cspan style\x3d"font-weight:bold"\x3e').replace(/<(i|em)>/g, '\x3cspan style\x3d"font-style:italic"\x3e').replace(/<a/g, "\x3cspan").replace(/<\/(b|strong|i|em|a)>/g, "\x3c/span\x3e").split(/<br.*?>/g) : [f], f = c(f, function(a) {
              return "" !== a;
            }), k(f, function(p, c) {
              var f,
                  F = 0;
              ...
              k(f, function(p) {
                if ("" !== p || 1 === f.length) {
                  ...
                  m.test(p) && !l && (g(h, "onclick", 'location.href\x3d"' + p.match(m)[1] + '"'), g(h, "class", "highcharts-anchor"), q(h, {cursor: "pointer"}));
                  ...
                  if (" " !== p) {
                    ...
                    g(h, k);
                    b.appendChild(h);
                    !F && L && (!M && l && q(h, {display: "block"}), g(h, "dy", Q(h)));
                    if (x) {
                      ...
                      var H = [],
                          ...
                          r = Q(h),
                          E = a.rotation;
                      for (P && (G = d.applyEllipsis(a, h, p, x)); !P && e && (k.length || H.length); )
                        a.rotation = 0, v = d.getSpanWidth(a, h), p = v > x, void 0 === G && (G = p), p && 1 !== k.length ? (h.removeChild(h.firstChild), H.unshift(k.pop())) : (k = H, H = [], k.length && !D && (h = n.createElementNS(N, "tspan"), g(h, {
                          dy: r,
                          x: O
                        }), C && g(h, "style", C), b.appendChild(h)), v > x && (x = v)), k.length && h.appendChild(n.createTextNode(k.join(" ").replace(/- /g, "-")));
                      a.rotation = E;
                    }
                    F++;
                  }
        ...
        button: function(a, b, p, c, f, l, k, F, h) {
          ...
          m = k.style;
          delete k.style;
          F = G(f, {style: {color: "#cccccc"}}, F);
          n = F.style;
          delete F.style;
          y(A.element, L ? "mouseover" : "mouseenter", function() {
            3 !== w && A.setState(1);
          });
          y(A.element, L ? "mouseout" : "mouseleave", function() {
            3 !== w && A.setState(w);
          });
          ...
          A.attr(f).css(d({cursor: "default"}, N));
        ...
        clipRect: function(b, p, c, d) {
          var f = a.uniqueKey(),
              l = this.createElement("clipPath").attr({id: f}).add(this.defs);
        ...
        text: function(a, b, p, c) {
          ...
          c || (a.xSetter = function(a, b, p) {
            ...
            for (l = 0; l < c.length; l++)
              d = c[l], d.getAttribute(b) === f && d.setAttribute(b, a);
            p.setAttribute(b, a);
          });
          return a;
        },
        ...
        label: function(b, p, c, f, l, h, w, N, g) {
          var n = this,
              ...
              M = e.text = n.text("", 0, 0, w).attr({zIndex: 1}),
              O,
              x,
              C = 0,
              H = 3,
          ...
          R = function() {
            ...
            if (a !== M.x || b !== M.y)
              M.attr("x", a), void 0 !== b && M.attr("y", b);
            M.x = a;
            M.y = b;
          };
          T = function(a, b) {
          ...
          if (this.added) {
            ...
            if ("SPAN" === b.tagName) {
              var D = this.rotation,
                  ...
                  H;
              (H = w !== this.oldTextWidth) && !(H = w > this.oldTextWidth) && ((H = this.textPxLength) || (y(b, {
                width: "",
                whiteSpace: v || "nowrap"
      ...
      a.Tick.prototype = {
        addLabel: function() {
          ...
          if (B(f))
            ...
            if (this.label = f = B(e) && k.enabled ? m.renderer.text(e, 0, 0, k.useHTML).css(g(k.style)).add(a.labelGroup) : null)
        ...
        handleOverflow: function(a) {
          var e = this.axis,
              ...
              D = {};
          if (b || !1 === g.overflow)
            0 > b && f - c * l < k ? L = Math.round(f / Math.cos(b * u) - k) : 0 < b && f + c * l > n && (L = Math.round((h - f) / Math.cos(b * u)));
          else if (h = f + (1 - c) * l, f - c * l < k ? q = a.x + q * (1 - c) - k : h > n && (q = n - a.x + q * c, x = -1), q = Math.min(C, q), q < C && "center" === e.labelAlign && (a.x += x * (C - q - c * (C - Math.min(l, q)))), l > q || e.autoRotation && (d.styles || {}).width)
            L = q;
        ...
        renderGridLine: function(a, e, g) {
          ...
          if (!a && n && (a = f.getPlotLinePath(d + c, n.strokeWidth() * g, a, !0)))
    ...
    var V = function(a) {
      ...
      a.extend(E.prototype, {
        ...
        init: function(a, b) {
          ...
          b = d.options.events;
          -1 === c(d, a.axes) && (p ? a.axes.splice(a.xAxis.length, 0, d) : a.axes.push(d), a[d.coll].push(d));
          d.series = d.series || [];
        ...
        defaultLabelFormatter: function() {
          ...
          if (n)
            ...
            for (; w-- && void 0 === g; )
              d = Math.pow(h, w + 1), b >= d && 0 === 10 * c % d && null !== e[w] && 0 !== c && (g = a.numberFormat(c / d, -1) + e[w]);
        ...
        getSeriesExtremes: function() {
          ...
          f(a.series, function(p) {
            if (p.visible || !c.options.chart.ignoreHiddenSeries) {
              ...
              if (a.isXAxis)
                d = p.xData, d.length && (p = e(d), k = y(d), C(p) || p instanceof Date || (d = b(d, C), p = e(d), k = y(d)), d.length && (a.dataMin = Math.min(v(a.dataMin, d[0], p), p), a.dataMax = Math.max(v(a.dataMax, d[0], k), k)));
              else if (p.getExtremes(), k = p.dataMax, p = p.dataMin, q(p) && q(k) && (a.dataMin = Math.min(v(a.dataMin, p), p), a.dataMax = Math.max(v(a.dataMax, k), k)), q(f) && (a.threshold = f), !d.softThreshold || a.positiveValuesOnly)
                a.softThreshold = !1;
            }
          });
        },
        ...
        getPlotLinePath: function(a, b, d, c, f) {
          var p = this.chart,
              ...
              F,
              h,
              e = d && p.oldChartHeight || p.chartHeight,
              g = d && p.oldChartWidth || p.chartWidth,
              w;
          F = this.transB;
          var N = function(a, b, p) {
            if (a < b || a > p)
              c ? a = Math.min(Math.max(b, a), p) : w = !0;
            return a;
          };
        ...
        getMinorTickPositions: function() {
          ...
          if (e && e / c < a.len / 3)
            if (a.isLog)
              f(this.paddedTicks, function(b, d, p) {
                d && k.push.apply(k, a.getLogTickPositions(c, p[d - 1], p[d], !0));
              });
            else if (a.isDatetimeAxis && "auto" === this.getMinorTickInterval())
              k = k.concat(a.getTimeTicks(a.normalizeTimeTickInterval(c), h, l, b.startOfWeek));
            else
              for (b = h + (d[0] - h) % c; b <= l && b !== k[0]; b += c)
                k.push(b);
        ...
        adjustForMinRange: function() {
          var a = this.options,
              ...
              n,
              m;
          this.isXAxis && void 0 === this.minRange && !this.isLog && (q(a.min) || q(a.max) ? this.minRange = null : (f(this.series, function(a) {
            w = a.xData;
            for (h = n = a.xIncrement ? 1 : w.length - 1; 0 < h; h--)
              if (g = w[h] - w[h - 1], void 0 === l || g < l)
                l = g;
        ...
        getClosest: function() {
          ...
          this.categories ? a = 1 : f(this.series, function(b) {
            ...
            !b.noSharedTooltip && q(d) && c && (a = q(a) ? Math.min(a, d) : d);
          });
          return a;
        },
        nameToX: function(a) {
          ...
          q(p) || (p = !1 === this.options.uniqueNames ? a.series.autoIncrement() : b ? c(a.name, d) : v(d.keys[a.name], -1));
          -1 === p ? b || (f = d.length) : f = p;
        ...
        updateNames: function() {
          var b = this,
              d = this.names;
          0 < d.length && (f(a.keys(d.keys), function(a) {
            delete d.keys[a];
          }), d.length = 0, this.minRange = this.userMinRange, f(this.series || [], function(a) {
            a.xIncrement = null;
            if (!a.points || a.isDirtyData)
              a.processData(), a.generatePoints();
            f(a.points, function(d, c) {
              var p;
        ...
        setAxisTranslation: function(a) {
          var b = this,
              ...
              g = b.isXAxis;
          if (g || e || c)
            p = b.getClosest(), h ? (k = h.minPointOffset, l = h.pointRangePadding) : f(b.series, function(a) {
              var d = e ? 1 : g ? v(a.options.pointRange, p, 0) : b.axisPointRange || 0;
              a = a.options.pointPlacement;
              c = Math.max(c, d);
              b.single || (k = Math.max(k, K(a) ? 0 : d / 2), l = Math.max(l, "on" === a ? 0 : d));
            }), h = b.ordinalSlope && p ? b.ordinalSlope / p : 1, b.minPointOffset = k *= h, b.pointRangePadding = l *= h, b.pointRange = Math.min(c, d), g && (b.closestPointRange = p);
          a && (b.oldTransA = w);
        ...
        setTickInterval: function(b) {
          ...
          c.adjustForMinRange();
          !(D || c.axisPointRange || c.usePercentage || g) && q(c.min) && q(c.max) && (h = c.max - c.min) && (!q(u) && G && (c.min -= h * G), !q(y) && m && (c.max += h * m));
          ...
          b = v(k.minTickInterval, c.isDatetimeAxis && c.closestPointRange);
        ...
        alignToOthers: function() {
          var a = {},
              b,
              c = this.options;
          !1 === this.chart.options.chart.alignTicks || !1 === c.alignTicks || this.isLog || f(this.chart[this.coll], function(c) {
            var d = c.options,
        ...
        adjustTickAmount: function() {
          ...
          if (this.hasData()) {
            if (f < c) {
              for (; b.length < c; )
                b.length % 2 || this.min === k ? b.push(t(b[b.length - 1] + a)) : b.unshift(t(b[0] - a));
              this.transA *= (f - 1) / (c - 1);
              this.min = b[0];
        ...
        zoom: function(a, b) {
          ...
          if (a !== this.min || b !== this.max)
            this.allowZoomOutside || (q(c) && (a < f && (a = f), a > p && (a = p)), q(d) && (b < f && (b = f), b > p && (b = p))), this.displayBtn = void 0 !== a || void 0 !== b, this.setExtremes(a, b, !1, void 0, {trigger: "zoom"});
          return !0;
        },
        ...
        tickSize: function(a) {
          ...
          if (d && c)
            return "inside" === b[a + "Position"] && (c = -c), [c, d];
        },
        ...
        unsquish: function() {
          ...
          b ? (m = !a.staggerLines && !a.step && (q(h) ? [h] : k < v(a.autoRotationLimit, 80) && a.autoRotation)) && f(m, function(a) {
            var b;
            if (a === h || a && -90 <= a && 90 >= a)
              g = n(Math.abs(e.h / Math.sin(r * a))), b = g + Math.abs(a / 360), b < w && (w = b, l = a, d = g);
          }) : a.step || (d = n(e.h));
          this.autoRotation = m;
        ...
        renderUnsquish: function() {
          ...
          f(c, function(a) {
            (a = d[a]) && a.label && a.label.textPxLength > x && (x = a.label.textPxLength);
          });
          this.maxLabelLength = x;
          if (this.autoRotation)
            x > e && x > w.h ? g.rotation = this.labelRotation : this.labelRotation = 0;
          else if (h && (n = e, !m))
            for (G = "clip", e = c.length; !l && e--; )
              if (H = c[e], H = d[H].label)
                H.styles && "ellipsis" === H.styles.textOverflow ? H.css({textOverflow: "clip"}) : H.textPxLength > h && H.css({width: h + "px"}), H.getBBox().height > this.len / c.length - (w.h - w.f) && (H.specificTextOverflow = "ellipsis");
        ...
        getOffset: function() {
          ...
          a.axisGroup || (a.gridGroup = c.g("grid").attr({zIndex: d.gridZIndex || 1}).addClass("highcharts-" + this.coll.toLowerCase() + "-grid " + (K || "")).add(L), a.axisGroup = c.g("axis").attr({zIndex: d.zIndex || 2}).addClass("highcharts-" + this.coll.toLowerCase() + " " + (K || "")).add(L), a.labelGroup = c.g("axis-labels").attr({zIndex: C.zIndex || 7}).addClass("highcharts-" + a.coll.toLowerCase() + "-labels " + (K || "")).add(L));
          w || a.isLinked ? (f(k, function(b, c) {
            a.generateTick(b, c);
          }), a.renderUnsquish(), a.reserveSpaceDefault = 0 === e || 2 === e || {
            1: "left",
            3: "right"
          }[e] === a.labelAlign, v(C.reserveSpace, "center" === a.labelAlign ? !0 : null, a.reserveSpaceDefault) && f(k, function(a) {
            E = Math.max(l[a].getLabelSize(), E);
          }), a.staggerLines && (E *= a.staggerLines), a.labelOffset = E * (a.opposite ? -1 : 1)) : D(l, function(a, b) {
            a.destroy();
            delete l[b];
          });
        ...
        renderTick: function(a, b) {
          ...
          if (!c || a >= this.min && a <= this.max)
            d[a] || (d[a] = new I(this, a)), f && d[a].isNew && d[a].render(b, !0, .1), d[a].render(b);
        },
        render: function() {
          var b = this,
              c = b.chart,
          ...
          if (b.hasData() || h)
            b.minorTickInterval && !b.categories && f(b.getMinorTickPositions(), function(a) {
              b.renderMinorTick(a);
            }), e.length && (f(e, function(a, c) {
              b.renderTick(a, c);
            }), v && (0 === b.min || b.single) && (g[-1] || (g[-1] = new I(b, -1, null, !0)), g[-1].render(-1))), x && f(e, function(d, f) {
            ...
            }), b._addedPlotLB || (f((d.plotLines || []).concat(d.plotBands || []), function(a) {
          ...
          E && (E[E.isPlaced ? "animate" : "attr"]({d: this.getLinePath(E.strokeWidth())}), E.isPlaced = !0, E[r ? "show" : "hide"](!0));
        ...
        drawCrosshair: function(a, b) {
          ...
          this.crosshair && !1 !== (q(b) || !f) ? (f ? q(b) && (k = this.isXAxis ? b.plotX : this.len - b.plotY) : k = a && (this.horiz ? a.chartX - this.pos : this.len - a.chartY + this.pos), q(k) && (c = this.getPlotLinePath(b && (this.isXAxis ? b.x : v(b.stackY, b.y)), null, null, null, k) || null), q(c) ? (b = this.categories && !this.isRadial, l || (this.cross = l = this.chart.renderer.path().addClass("highcharts-crosshair highcharts-crosshair-" + (b ? "category " : "thin ") + d.className).attr({zIndex: v(d.zIndex, 2)}).add(), l.attr({
            stroke: d.color || (b ? g("#ccd6eb").setOpacity(.25).get() : "#cccccc"),
            "stroke-width": v(d.width, 1)
          }).css({"pointer-events": "none"}), d.dashStyle && l.attr({dashstyle: d.dashStyle})), l.show().attr({d: c}), b && !d.width && l.attr({"stroke-width": this.transA}), this.cross.e = a) : this.hideCrosshair()) : this.hideCrosshair();
        },
    ...
    (function(a) {
      ...
      z.prototype.getLogTickPositions = function(a, u, q, r) {
        ...
        if (.5 <= a)
          a = Math.round(a), k = this.getLinearTickPositions(a, u, q);
        else if (.08 <= a)
          for (var f = Math.floor(u),
              d,
              b,
              c,
              l,
              C,
              m = .3 < a ? [1, 2, 4] : .15 < a ? [1, 2, 4, 6, 8] : [1, 2, 3, 4, 5, 6, 7, 8, 9]; f < q + 1 && !C; f++)
            for (b = m.length, d = 0; d < b && !C; d++)
              c = n(h(f) * m[d]), c > u && (!r || l <= q) && void 0 !== l && k.push(l), l > q && (C = !0), l = c;
        else
          u = h(u), q = h(q), a = r ? this.getMinorTickInterval() : m.tickInterval, a = g("auto" === a ? null : a, this._minorAutoInterval, m.tickPixelInterval / (r ? 5 : 1) * (q - u) / ((r ? f / this.tickPositions.length : f) || 1)), a = e(a, null, B(a)), k = y(this.getLinearTickPositions(a, u, q), n), r || (this._minorAutoInterval = a / 5);
    ...
    (function(a, z) {
      ...
      a.PlotLineOrBand.prototype = {
        render: function() {
          var g = this,
              ...
              w = r(n.zIndex, 0),
              G = n.events,
              D = {"class": "highcharts-plot-" + (C ? "band " : "line ") + (n.className || "")},
              H = {},
              I = f.chart.renderer,
              E = C ? "bands" : "lines",
              p = f.log2lin;
          ...
          H.zIndex = w;
          E += "-" + w;
          (v = f.plotLinesAndBandsGroups[E]) || (f.plotLinesAndBandsGroups[E] = v = I.g("plot-" + E).attr(H).add());
          L && (g.svgElem = x = I.path().attr(D).add(v));
          if (K)
            D = f.getPlotLinePath(l, x.strokeWidth());
          else if (C)
            D = f.getPlotBandPath(c, b, n);
          else
            return;
          L && D && D.length ? (x.attr({d: D}), G && a.objectEach(G, function(a, b) {
            x.on(b, function(a) {
              G[b].apply(g, [a]);
            });
          })) : x && (D ? (x.show(), x.animate({d: D})) : (x.hide(), d && (g.label = d = d.destroy())));
      ...
      a.extend(z.prototype, {
        getPlotBandPath: function(a, f) {
          ...
          if (e && h)
            for (a && (c = e.toString() === h.toString(), b = 0), a = 0; a < e.length; a += 6)
              d && h[a + 1] === e[a + 1] ? (h[a + 1] += b, h[a + 4] += b) : d || h[a + 2] !== e[a + 2] || (h[a + 2] += b, h[a + 5] += b), k.push("M", e[a + 1], e[a + 2], "L", e[a + 4], e[a + 5], h[a + 4], h[a + 5], h[a + 1], h[a + 2], "z"), k.flat = c;
          return k;
        },
        ...
        removePlotBandOrLine: function(a) {
          for (var f = this.plotLinesAndBands,
              ...
              e = this.userOptions,
              k = f.length; k--; )
            f[k].id === a && f[k].destroy();
          t([h.plotLines || [], e.plotLines || [], h.plotBands || [], e.plotBands || []], function(d) {
            for (k = d.length; k--; )
              d[k].id === a && u(d, d[k]);
          });
        },
      ...
      a.Tooltip.prototype = {
        ...
        getPosition: function(a, h, e) {
          var f = this.chart,
              ...
              c = f.inverted && e.h || 0,
              l,
              g = ["y", f.chartHeight, h, e.plotY + f.plotTop, f.plotTop, f.plotTop + f.plotHeight],
              ...
              m = function(a, f, k, l, h, e) {
                ...
                if (x && g)
                  ...
                  b[a] = Math.min(e - k, 0 > w - c ? w : w - c);
                else if (g)
                  b[a] = Math.max(h, l + c + k > f ? l : l + c);
                else
                  return !1;
              },
              D = function(a, c, f, k) {
              ...
              w = function() {
                !1 !== m.apply(0, g) ? !1 !== D.apply(0, n) || l || (v(!0), w()) : l ? b.x = b.y = 0 : (v(!0), w());
              };
        ...
        refresh: function(a, h) {
          ...
          var l = this.shared,
              g;
          k.enabled && (clearTimeout(this.hideTimer), this.followPointer = q(b)[0].series.tooltipOptions.followPointer, c = this.getAnchor(b, h), h = c[0], d = c[1], !l || b.series && b.series.noSharedTooltip ? l = b.getLabelConfig() : (z(b, function(a) {
            a.setState("hover");
            e.push(a.getLabelConfig());
          }), l = {
            x: b[0].category,
            y: b[0].y
          }, l.points = e, b = b[0]), this.len = e.length, l = f.call(l, this), g = b.series, this.distance = u(g.tooltipOptions.distance, 16), !1 === l ? this.hide() : (f = this.getLabel(), this.isHidden && f.attr({opacity: 1}).show(), this.split ? this.renderSplit(l, q(a)) : (k.style.width || f.css({width: this.chart.spacingBox.width}), f.attr({text: l && l.join ? l.join("") : l}), f.removeClass(/highcharts-color-[\d]+/g).addClass("highcharts-color-" + u(b.colorIndex, g.colorIndex)), f.attr({stroke: k.borderColor || b.color || g.color || "#666666"}), this.updatePosition({
            plotX: h,
            plotY: d,
            negative: b.negative,
            ttBelow: b.ttBelow,
        ...
        renderSplit: function(f, h) {
          var e = this,
              ...
              m = this.getLabel();
          a.isString(f) && (f = [!1, f]);
          z(f.slice(0, h.length + 1), function(a, f) {
            if (!1 !== a) {
              f = h[f - 1] || {
                isHeader: !0,
                plotX: h[0].plotX
        ...
        getDateFormat: function(a, h, e, k) {
          ...
          for (f in m) {
            ...
            if (g[f] && b.substr(g[f]) !== "01-01 00:00:00.000".substr(g[f]))
              break;
            "week" !== f && (n = f);
          }
          f && (c = k[f]);
        ...
        tooltipFooterHeaderFormatter: function(a, h) {
          ...
          c && d && z(a.point && a.point.tooltipDateKeys || ["key"], function(a) {
      ...
      a.Pointer.prototype = {
        ...
        getHoverData: function(b, d, f, e, g, m, n) {
          var c,
              ...
              G = n && n.isBoosting;
          e = !(!e || !b);
          n = d && !d.stickyTracking ? [d] : a.grep(f, function(a) {
          ...
          c && (g && !d.noSharedTooltip ? (n = a.grep(f, function(a) {
        ...
        runPointActions: function(b, d) {
          var c = this.chart,
              ...
              h = this.getHoverData(e, h, c.series, !!d || h && h.directTouch && this.isDirectTouch, l, b, {isBoosting: c.isBoosting}),
              g,
              e = h.hoverPoint;
          g = h.hoverPoints;
          ...
          if (e && (e !== c.hoverPoint || f && f.isHidden)) {
            ...
            d && f && !f.isHidden && (e = f.getAnchor([{}], b), f.updatePosition({
              plotX: e[0],
              plotY: e[1]
            }));
        ...
        reset: function(a, b) {
          var c = this.chart,
              ...
              e = c.tooltip,
              h = e && e.shared ? l : k;
          a && h && u(d(h), function(b) {
            b.series.isCartesian && void 0 === b.plotX && (a = !1);
          });
          if (a)
            e && h && (e.refresh(h), k && (k.setState(k.state, !0), u(c.axes, function(a) {
        ...
        drop: function(a) {
          ...
          if (this.selectionMarker) {
            ...
            if (this.hasDragged || d)
              ...
              }), H && m(c, "selection", k, function(a) {
                c.zoom(q(a, d ? {animation: !1} : null));
              });
            f(c.index) && (this.selectionMarker = this.selectionMarker.destroy());
            d && this.scaleGroups();
          }
          c && f(c.index) && (g(c.container, {cursor: c._cursor}), c.cancelClick = 10 < this.hasDragged, c.mouseIsDown = this.hasDragged = this.hasPinched = !1, this.pinchDown = []);
        },
        ...
        onContainerClick: function(a) {
          var b = this.chart,
              ...
              f = b.plotTop;
          a = this.normalize(a);
          b.cancelClick || (c && this.inClass(a.target, "highcharts-tracker") ? (m(c.series, "click", q(a, {point: c})), b.hoverPoint && c.firePointEvent("click", a)) : (q(a, this.getCoordinates(a)), b.isInsidePlot(a.chartX - d, a.chartY - f) && m(b, "click", a)));
        },
      ...
      y(a.Pointer.prototype, {
        ...
        pinchTranslateDirection: function(a, e, g, m, f, h, n, k) {
          var d = this.chart,
              ...
              F;
          g = function() {
            !G && 20 < Math.abs(H - E) && (D = k || Math.abs(I - p) / Math.abs(H - E));
            t = (q - I) / D + H;
        ...
        pinch: function(a) {
          ...
          }), n.x = [m[0].chartX, m[1] && m[1].chartX], n.y = [m[0].chartY, m[1] && m[1].chartY], B(r.axes, function(a) {
            if (a.zoomEnabled) {
      ...
      if (!a.hasTouch && (r.PointerEvent || r.MSPointerEvent)) {
        ...
        g(u.prototype, {
          ...
          onContainerPointerMove: function(a) {
            k(a, "onContainerTouchMove", "touchmove", function(a) {
              f[a.pointerId] = {
                pageX: a.pageX,
                pageY: a.pageY
              };
        ...
        m(u.prototype, "init", function(a, b, c) {
          a.call(this, b, c);
    ...
    (function(a) {
      ...
      a.Legend.prototype = {
        ...
        positionItem: function(a) {
          var d = this.options,
              ...
              c = c[1],
              k = a.checkbox;
          (a = a.legendGroup) && a.element && a.translate(d ? f : this.legendWidth - f - 2 * b - 4, c);
          k && (k.x = f, k.y = c);
        },
        ...
        positionCheckboxes: function() {
          var a = this.group && this.group.alignAttr,
              ...
              c = this.titleHeight;
          a && (d = a.translateY, g(this.allItems, function(f) {
            var k = f.checkbox,
                e;
        ...
        setText: function(f) {
          var d = this.options;
          f.legendItem.attr({text: d.labelFormat ? a.format(d.labelFormat, f, this.chart.time) : d.labelFormatter.call(f)});
        },
        renderItem: function(a) {
          ...
          E || (a.legendGroup = b.g("legend-item").addClass("highcharts-" + t.type + "-series highcharts-color-" + a.colorIndex + (P ? " " + P : "") + (p ? " highcharts-series-" + a.index : "")).attr({zIndex: 1}).add(this.scrollGroup), a.legendItem = E = b.text("", w ? k + e : -e, this.baseline || 0, N).css(q(a.visible ? h : g)).attr({
            align: w ? "left" : "right",
            zIndex: 2
          ...
          h.width || E.css({width: (c.itemWidth || c.width || d.spacingBox.width) - u});
          this.setText(a);
          b = E.getBBox();
        ...
        getAllItems: function() {
          var a = [];
          g(this.chart.series, function(d) {
            var b = d && d.options;
        ...
        adjustMargins: function(a, d) {
          var b = this.chart,
              c = this.options,
              f = this.getAlignment();
          f && g([/(lth|ct|rth)/, /(rtv|rm|rbv)/, /(rbh|cb|lbh)/, /(lbv|lm|ltv)/], function(k, h) {
        ...
        render: function() {
          ...
          a.offsetWidth = 0;
          a.lastItemY = 0;
          c || (a.group = c = b.g("legend").attr({zIndex: 7}).add(), a.contentGroup = b.g().attr({zIndex: 1}).add(c), a.scrollGroup = b.g().add(a.contentGroup));
          a.renderTitle();
          e = a.getAllItems();
          f(e, function(a, b) {
          ...
          n += v;
          r || (a.box = r = b.rect().addClass("highcharts-legend-box").attr({r: D.borderRadius}).add(c), r.isNew = !0);
          r.attr({
          ...
          h && (b = d.spacingBox, /(lth|ct|rth)/.test(a.getAlignment()) && (b = q(b, {y: b.y + d.titleOffset + d.options.title.margin})), c.align(q(D, {
            width: m,
            height: n
          }), !0, b));
        ...
        handleOverflow: function(a) {
          ...
          e && (b = Math.min(b, e));
          H.length = 0;
          a > b && !1 !== n.enabled ? (this.clipHeight = h = Math.max(b - 20 - this.titleHeight - k, 0), this.currentPage = r(this.currentPage, 1), this.fullHeight = a, g(E, function(a, b) {
            var c = a._legendItemPos[1],
                d = Math.round(a.legendItem.getBBox().height),
                f = H.length;
            if (!f || c - H[f - 1] > h && (I || c) !== H[f - 1])
              H.push(I || c), f++;
            a.pageIx = f - 1;
            I && (E[b - 1].pageIx = f - 1);
            b === E.length - 1 && c + d - H[f - 1] > h && (H.push(c), a.pageIx = f);
            c !== I && (I = c);
          }), m || (m = d.clipRect = c.clipRect(0, k, 9999, 0), d.contentGroup.clip(m)), p(h), G || (this.nav = G = c.g().attr({zIndex: 1}).add(this.group), this.up = c.symbol("triangle", 0, 0, w, w).on("click", function() {
            d.scroll(-1, v);
          }).add(G), this.pager = c.text("", 15, 10).addClass("highcharts-legend-navigation").css(n.style).add(G), this.down = c.symbol("triangle-down", 0, 0, w, w).on("click", function() {
            d.scroll(1, v);
          }).add(G)), d.scroll(0), a = b) : G && (p(), this.nav = G.destroy(), this.scrollGroup.attr({translateY: 1}), this.clipHeight = 0);
          return a;
        },
        scroll: function(a, d) {
          var b = this.pages,
      ...
      a.LegendSymbolMixin = {
        drawRectangle: function(a, d) {
          ...
          d.legendSymbol = this.chart.renderer.rect(c ? (a.symbolWidth - b) / 2 : 0, a.baseline - b + 1, c ? b : a.symbolWidth, b, r(a.options.symbolRadius, b / 2)).addClass("highcharts-point").attr({zIndex: 3}).add(d.legendGroup);
        },
      ...
      (/Trident\/7\.0/.test(h.navigator.userAgent) || t) && n(a.Legend.prototype, "positionItem", function(a, d) {
        var b = this,
            c = function() {
      ...
      k(M.prototype, {
        ...
        init: function(b, c) {
          ...
          for (f in d.plotOptions)
            d.plotOptions[f].tooltip = h[f] && D(h[f].tooltip) || void 0;
        ...
        redraw: function(c) {
          ...
          this.layOutTitles();
          for (c = f.length; c--; )
            if (G = f[c], G.options.stacking && (l = !0, G.isDirty)) {
              p = !0;
              break;
            }
          if (p)
            for (c = f.length; c--; )
              G = f[c], G.options.stacking && (G.isDirty = !0);
          n(f, function(a) {
        ...
        setTitle: function(a, b, c) {
          ...
          f = f.subtitle = D({style: {color: "#666666"}}, f.subtitle, b);
          n([["title", a, e], ["subtitle", b, f]], function(a, b) {
            var c = a[0],
                f = d[c],
                e = a[1];
            a = a[2];
        ...
        layOutTitles: function(a) {
          ...
          n(["title", "subtitle"], function(a) {
            ...
            var h;
            c && (h = e.style.fontSize, h = d.fontMetrics(h, c).b, c.css({width: (e.width || f.width + e.widthAdjust) + "px"}).align(k({y: a + h}, e), !1, "spacingBox"), e.floating || e.verticalAlign || (b = Math.ceil(b + c.getBBox(e.useHTML).height)));
          }, this);
        ...
        getContainer: function() {
          ...
          this.container = b = u("div", {id: p}, w, b);
        ...
        reflow: function(b) {
          ...
          if (!e && !c.isPrinting && k && d && (f === O || f === g)) {
            if (k !== c.containerWidth || d !== c.containerHeight)
              clearTimeout(c.reflowTimeout), c.reflowTimeout = F(function() {
        ...
        drawChartBox: function() {
          ...
          h[D](x);
          h.attr({fill: w || "none"}).shadow(a.plotShadow);
          ...
          D = "animate";
          k || (D = "attr", this.plotBorder = k = c.rect().addClass("highcharts-plot-border").attr({zIndex: 1}).add());
          k.attr({
        ...
        propFromSeries: function() {
          ...
          n(["inverted", "angular", "polar"], function(h) {
            ...
            for (f = d && d.length; !e && f--; )
              (c = E[d[f].type]) && c.prototype[h] && (e = !0);
            a[h] = e;
          });
        },
        linkSeries: function() {
        ...
        renderLabels: function() {
          ...
          b.items && n(b.items, function(c) {
            ...
            delete d.left;
            delete d.top;
            a.renderer.text(c.html, f, e).attr({zIndex: 2}).css(d).add();
          });
        },
        render: function() {
          var a = this.axes,
      ...
      a.Point.prototype = {
        ...
        optionsToObject: function(a) {
          ...
          if (q(a) || null === a)
            ...
            for (!k && a.length > b && (e = typeof a[0], "string" === e ? f.name = a[0] : "number" === e && (f.x = a[0]), c++); g < b; )
              k && void 0 === a[c] || (f[d[g]] = a[c]), c++, g++;
          else
            "object" === typeof a && (f = a, a.dataLabels && (e._hasPointLabels = !0), a.marker && (e._hasPointMarkers = !0));
          return f;
        },
        ...
        tooltipFormatter: function(a) {
          var f = this.series,
              ...
              d = e.valuePrefix || "",
              b = e.valueSuffix || "";
          B(f.pointArrayMap || ["y"], function(c) {
            c = "{point." + c;
            if (d || b)
              a = a.replace(c + "}", d + c + "}" + b);
            a = a.replace(c + "}", c + ":,." + k + "f}");
    ...
    (function(a) {
      ...
      a.Series = a.seriesType("line", null, {
        ...
        insert: function(a) {
          ...
          if (d(b)) {
            for (c = a.length; c--; )
              if (b >= C(a[c].options.index, a[c]._i)) {
                a.splice(c + 1, 0, this);
                break;
              }
            -1 === c && a.unshift(this);
        ...
        setData: function(c, f, e, h) {
          ...
          w = c.length;
          f = C(f, !0);
          if (!1 !== h && w && m === w && !g.cropped && !g.hasGroupedData && g.visible)
            r(c, function(a, b) {
            ...
            if (H && w > H) {
              ...
              if (d(x))
                for (e = 0; e < w; e++)
                  D[e] = this.autoIncrement(), q[e] = c[e];
              else if (k(x))
                if (I)
                  for (e = 0; e < w; e++)
                    x = c[e], D[e] = x[0], q[e] = x.slice(1, I + 1);
                else
                  for (e = 0; e < w; e++)
                    x = c[e], D[e] = x[0], q[e] = x[1];
              else
                a.error(12);
            } else
              for (e = 0; e < w; e++)
                void 0 !== c[e] && (x = {series: g}, g.pointClass.prototype.applyOptions.apply(x, [c[e]]), g.updateParallelArrays(x, e));
        ...
        processData: function(b) {
          ...
          if (n && this.sorted && !w && (!l || f > l || this.forceCrop))
            if (c[f - 1] < v || c[0] > D)
              c = [], d = [];
            else if (c[0] < v || c[f - 1] > D)
              e = this.cropData(this.xData, this.yData, v, D), c = e.xData, d = e.yData, e = e.start, h = !0;
          for (l = c.length || 1; --l; )
            f = x ? m(c[l]) - m(c[l - 1]) : c[l] - c[l - 1], 0 < f && (void 0 === k || f < k) ? k = f : 0 > f && r && (a.error(15), r = !1);
          this.cropped = h;
          this.cropStart = e;
        ...
        generatePoints: function() {
          ...
          for (v = 0; v < k; v++)
            l = g + v, m ? (n = (new h).init(this, [f[v]].concat(x(e[v]))), n.dataGroup = this.groupMap[v]) : (n = c[l]) || void 0 === b[l] || (c[l] = n = (new h).init(this, b[l], f[v])), n && (n.index = l, r[v] = n);
          this.options.keys = a;
          if (c && (k !== (d = c.length) || m))
            for (v = 0; v < d; v++)
              v !== g || m || (v += k), c[v] && (c[v].destroyElements(), c[v].plotX = void 0);
          this.data = c;
          this.points = r;
        },
        getExtremes: function(a) {
          ...
          f = a.length;
          for (x = 0; x < f; x++)
            if (n = c[x], v = a[x], w = (d(v, !0) || k(v)) && (!b.positiveValuesOnly || v.length || 0 < v), n = this.getExtremesFromAll || this.options.getExtremesFromAll || this.cropped || (c[x + 1] || n) >= l && (c[x - 1] || n) <= m, w && n)
              if (w = v.length)
                for (; w--; )
                  "number" === typeof v[w] && (h[g++] = v[w]);
              else
                h[g++] = v;
          this.dataMin = e(h);
          this.dataMax = y(h);
        ...
        getValidPoints: function(a, b) {
          var c = this.chart;
          return n(a || this.points || [], function(a) {
        ...
        setClip: function(a) {
          var b = this.chart,
              ...
              g = b[k],
              l = b[k + "m"];
          g || (a && (h.width = 0, f && (h.x = b.plotSizeX), b[k + "m"] = l = d.clipRect(f ? b.plotSizeX + 99 : -99, f ? -b.plotLeft : -b.plotTop, 99, f ? b.chartWidth : b.chartHeight)), b[k] = g = d.clipRect(h), g.count = {length: 0});
          a && !g.count[this.index] && (g.count[this.index] = !0, g.count.length += 1);
          !1 !== c.clip && (this.group.clip(a || e ? g : b.clipRect), this.markerGroup.clip(l), this.sharedClipKey = k);
        ...
        drawPoints: function() {
          ...
          if (!1 !== h.enabled || this._hasPointMarkers)
            for (c = 0; c < a.length; c++)
              d = a[c], e = d.graphic, k = d.marker || {}, g = !!d.marker, f = v && void 0 === k.enabled || k.enabled, l = d.isInside, f && !d.isNull ? (f = C(k.symbol, this.symbol), n = this.markerAttribs(d, d.selected && "select"), e ? e[l ? "show" : "hide"](!0).animate(n) : l && (0 < n.width || d.hasImage) && (d.graphic = e = b.renderer.symbol(f, n.x, n.y, n.width, n.height, g ? k : h).add(m)), e && e.attr(this.pointAttribs(d, d.selected && "select")), e && e.addClass(d.getClassName(), !0)) : e && (d.graphic = e.destroy());
        },
        ...
        destroy: function() {
          ...
          r(a.axisTypes || [], function(b) {
            (g = a[b]) && g.series && (m(g.series, a), g.isDirty = g.forceRedraw = !0);
          });
          a.legendItem && a.chart.legend.destroyItem(a);
          for (f = e.length; f--; )
            (k = e[f]) && k.destroy && k.destroy();
          a.points = null;
        ...
        getGraphPath: function(a, b, c) {
          ...
          r(a, function(h, p) {
            var m = h.plotX,
                n = h.plotY,
                w = a[p - 1];
            (h.leftCliff || w && w.rightCliff) && !c && (l = !0);
        ...
        applyZones: function() {
          var a = this,
              ...
              L,
              K = !1;
          d.length && (g || l) && n && void 0 !== n.min && (x = n.reversed, q = n.horiz, g && g.hide(), l && l.hide(), v = n.getExtremes(), r(d, function(d, p) {
    ...
    (function(a) {
      ...
      r(a.Chart.prototype, {
        addSeries: function(a, b, d) {
          var f,
              e = this;
          a && (b = c(b, !0), m(e, "addSeries", {options: a}, function() {
            f = e.initSeries(a);
            e.isDirtyLegend = !0;
            e.linkSeries();
            b && e.redraw(d);
        ...
        showLoading: function(a) {
          ...
          d || (b.loadingDiv = d = e("div", {className: "highcharts-loading highcharts-loading-hidden"}, null, b.container), b.loadingSpan = e("span", {className: "highcharts-loading-inner"}, null, d), z(b, "redraw", h));
          d.className = "highcharts-loading";
          b.loadingSpan.innerHTML = a || c.lang.loading;
          g(d, r(f.style, {zIndex: 10}));
          g(b.loadingSpan, f.labelStyle);
          b.loadingShown || (g(d, {
            opacity: 0,
            display: ""
          }), B(d, {opacity: f.style.opacity || .5}, {duration: f.showDuration || 0}));
          b.loadingShown = !0;
          h();
        },
        ...
        update: function(a, e, k) {
          ...
          if (m) {
            ...
            if ("inverted" in m || "polar" in m)
              g.propFromSeries(), n = !0;
            "alignTicks" in m && (n = !0);
            b(m, function(a, b) {
              -1 !== f("chart." + b, g.propsRequireUpdateSeries) && (p = !0);
              -1 !== f(b, g.propsRequireDirtyBox) && (g.isDirtyBox = !0);
            });
          ...
          b(a, function(a, b) {
            if (g[b] && "function" === typeof g[b].update)
              g[b].update(a, !1);
            else if ("function" === typeof g[l[b]])
              g[l[b]](a);
            "chart" !== b && -1 !== f(b, g.propsRequireUpdateSeries) && (p = !0);
          });
          u("xAxis yAxis zAxis series colorAxis pane".split(" "), function(b) {
            a[b] && (u(L(a[b]), function(a, c) {
              (c = t(a.id) && g.get(a.id) || g[b][c]) && c.coll === b && (c.update(a, !1), k && (c.touched = !0));
              if (!c && k)
                if ("series" === b)
                  g.addSeries(a, !1).touched = !0;
                else if ("xAxis" === b || "yAxis" === b)
                  g.addAxis(a, "xAxis" === b, !1).touched = !0;
            }), k && u(g[b], function(a) {
          ...
          n && u(g.axes, function(a) {
            a.update({}, !1);
          });
          p && u(g.series, function(a) {
            a.update({}, !1);
          });
      ...
      r(l.prototype, {
        update: function(a, b, d, f) {
          function e() {
            ...
            !k.fixedBox && k.hasCartesianSeries && (m.isDirtyBox = !0);
      ...
      r(C.prototype, {
        addPoint: function(a, b, d, f) {
          ...
          v = m.x;
          r = x.length;
          if (this.requireSorting && v < x[r - 1])
            for (n = !0; r && x[r - 1] > v; )
              r--;
        ...
        update: function(a, b) {
          var f = this,
              ...
              v = f.finishedAnimating && {animation: !1};
          ...
          f.init(e, a);
          a.zIndex !== h.zIndex && u(n, function(b) {
    ...
    (function(a) {
      ...
      r("column", "line", {
        ...
        init: function() {
          ...
          var a = this,
              e = a.chart;
          e.hasRendered && y(e.series, function(f) {
        ...
        getColumnMetrics: function() {
          var a = this,
              ...
              c = {},
              l = 0;
          !1 === e.grouping ? l = 1 : y(a.chart.series, function(d) {
            var f = d.options,
                e = d.yAxis,
                h;
        ...
        drawPoints: function() {
          ...
          y(a.points, function(c) {
            ...
            if (g(c.plotY) && null !== c.y) {
              b = c.shapeArgs;
              if (f)
                f[e.pointCount < d ? "animate" : "attr"](t(b));
              else
                c.graphic = f = k[c.shapeType](b).add(c.group || a.group);
        ...
        animate: function(a) {
          var f = this,
              ...
              l;
          m && (a ? (b.scaleY = .001, a = Math.min(g.pos + g.len, Math.max(g.pos, g.toPixels(k.threshold))), d ? b.translateX = a - g.len : b.translateY = a, f.group.attr(b)) : (l = f.group.attr(c), f.group.animate({scaleY: 1}, e(z(f.options.animation), {step: function(a, d) {
              b[c] = l + d.pos * (g.pos - l);
              f.group.attr(b);
            }})), f.animate = null));
        },
    ...
    (function(a) {
      ...
      a.distribute = function(a, b) {
        ...
        for (a = u(a, function(a) {
          ...
          for (d = a.length; d--; )
            f = a[d], n = (Math.min.apply(0, f.targets) + Math.max.apply(0, f.targets)) / 2, f.pos = Math.min(Math.max(0, n - f.size * f.align), b - f.size);
          d = a.length;
          for (f = !1; d--; )
            0 < d && a[d - 1].pos + a[d - 1].size > a[d].pos && (a[d - 1].size += a[d].size, a[d - 1].targets = a[d - 1].targets.concat(a[d].targets), a[d - 1].align = .5, a[d - 1].pos + a[d - 1].size > b && (a[d - 1].pos = b - a[d - 1].size), a.splice(d, 1), f = !0);
        }
        d = 0;
        e(a, function(a) {
          var b = 0;
      ...
      h.prototype.drawDataLabels = function() {
        ...
        var b = this,
            ...
            v,
            w,
            u = m(h.defer, !!f.animation),
            H = c.renderer;
        if (h.enabled || b._hasPointLabels)
          b.dlProcessOptions && b.dlProcessOptions(h), w = b.plotGroup("dataLabelsGroup", "data-labels", u && !r ? "hidden" : "visible", h.zIndex || 6), u && (w.attr({opacity: +r}), r || z(b, "afterAnimate", function() {
            b.visible && w.show(!0);
            w[f.animation ? "animate" : "attr"]({opacity: 1}, {duration: 200});
          })), n = h, e(g, function(e) {
            var g,
                l = e.dataLabel,
                x,
            ...
            (g = m(k && k.enabled, n.enabled) && !e.isNull) && (g = !0 === d(e, k || h));
      ...
      n.pie && (n.pie.prototype.drawDataLabels = function() {
        var d = this,
            ...
            Q,
            A = [0, 0, 0, 0];
        d.visible && (g.enabled || d._hasPointLabels) && (e(b, function(a) {
          a.dataLabel && a.visible && a.dataLabel.shortened && (a.dataLabel.attr({width: "auto"}).css({
            width: "auto",
            textOverflow: "clip"
          }), a.dataLabel.shortened = !1);
        }), h.prototype.drawDataLabels.apply(d), e(b, function(a) {
          ...
          var l,
              ...
              v;
          if (x)
            for (d.sortByAngle(b, h - .5), 0 < d.maxLabelDistance && (l = Math.max(0, H - G - d.maxLabelDistance), n = Math.min(H + G + d.maxLabelDistance, f.plotHeight), e(b, function(a) {
            ...
            }), a.distribute(t, n + v - l)), Q = 0; Q < x; Q++)
              c = b[Q], n = c.positionsIndex, p = c.labelPos, z = c.dataLabel, J = !1 === c.visible ? "hidden" : "inherit", N = l = p[1], t && y(t[n]) && (void 0 === t[n].pos ? J = "hidden" : (F = t[n].size, N = c.top + t[n].pos)), delete c.positionIndex, M = g.justify ? u[0] + (h ? -1 : 1) * (G + c.labelDistance) : d.getX(N < c.top + 2 || N > c.bottom - 2 ? l : N, h, c), z._attr = {
                visibility: J,
                align: p[6]
              }, z._pos = {
                x: M + g.x + ({
                ...
                y: N + g.y - 10
              }, p.x = M, p.y = N, m(g.crop, !0) && (E = z.getBBox().width, l = null, M - E < k ? (l = Math.round(E - M + k), A[3] = Math.max(l, A[3])) : M + E > r - k && (l = Math.round(M + E - r + k), A[1] = Math.max(l, A[1])), 0 > N - F / 2 ? A[0] = Math.max(Math.round(-N + F / 2), A[0]) : N + F / 2 > q && (A[2] = Math.max(Math.round(N + F / 2 - q), A[2])), z.sideOverflow = l);
        }), 0 === B(A) || this.verifyDataLabelOverflow(A)) && (this.placeDataLabels(), n && e(this.points, function(a) {
          var b;
          t = a.connector;
          if ((z = a.dataLabel) && z._pos && a.visible && 0 < a.labelDistance) {
            J = z._attr.visibility;
            if (b = !t)
              a.connector = t = f.renderer.path().addClass("highcharts-data-label-connector  highcharts-color-" + a.colorIndex).add(d.dataLabelsGroup), t.attr({
                "stroke-width": n,
    ...
    (function(a) {
      ...
      a(z.prototype, "render", function() {
        var a = [];
        B(this.labelCollectors || [], function(e) {
          a = a.concat(e());
        });
        B(this.yAxis || [], function(e) {
          e.options.stackLabels && !e.options.stackLabels.allowOverlap && y(e.stacks, function(e) {
            y(e, function(e) {
              a.push(e.label);
            });
          });
        ...
        B(this.series || [], function(g) {
          var t = g.options.dataLabels,
              q = g.dataLabelCollections || ["dataLabel"];
          (t.enabled || g._hasPointLabels) && !t.allowOverlap && g.visible && B(q, function(r) {
      ...
      z.prototype.hideOverlappingLabels = function(a) {
        var e = a.length,
            ...
            k,
            d,
            b = function(a, b, d, f, e, h, g, k) {
              return !(e > a + d || e + g < a || h > b + f || h + k < b);
            };
        for (q = 0; q < e; q++)
          if (g = a[q])
            g.oldOpacity = g.opacity, g.newOpacity = 1, g.width || (r = g.getBBox(), g.width = r.width, g.height = r.height);
        a.sort(function(a, b) {
          return (b.labelrank || 0) - (a.labelrank || 0);
        });
        for (q = 0; q < e; q++)
          for (r = a[q], g = q + 1; g < e; ++g)
            if (m = a[g], r && m && r !== m && r.placed && m.placed && 0 !== r.newOpacity && 0 !== m.newOpacity && (f = r.alignAttr, h = m.alignAttr, n = r.parentGroup, k = m.parentGroup, d = 2 * (r.box ? 0 : r.padding || 0), f = b(f.x + n.translateX, f.y + n.translateY, r.width - d, r.height - d, h.x + k.translateX, h.y + k.translateY, m.width - d, m.height - d)))
    ...
    (function(a) {
      ...
      K = a.TrackerMixin = {
        ...
        drawTrackerGraph: function() {
          ...
          if (f && !c)
            for (n = f + 1; n--; )
              "M" === d[n] && d.splice(n + 1, 0, d[n + 1] - k, d[n + 2], "L"), (n && "M" === d[n] || n === f) && d.splice(n, 0, "L", d[n - 2] + k, d[n - 1]);
          l ? l.attr({d: d}) : a.graph && (a.tracker = g.path(d).attr({
            "stroke-linejoin": "round",
      ...
      q(B.prototype, {
        ...
        pan: function(a, b) {
          ...
          u("xy" === b ? [1, 0] : [1], function(b) {
            ...
            n = l - g;
            0 < n && (l = g, h -= n);
            b.series.length && h !== k.min && l !== k.max && (b.setExtremes(h, l, !1, !1, {trigger: "pan"}), f = !0);
            c[d] = e;
          });
          f && c.redraw(!1);
      ...
      q(b.prototype, {
        select: function(a, b) {
          ...
          c.firePointEvent(a ? "select" : "unselect", {accumulate: b}, function() {
            ...
            c.setState(a && "select");
            b || u(h.getSelectedPoints(), function(a) {
        ...
        setState: function(a, b) {
          ...
          if (!(a === this.state && !b || this.selected && "select" !== a || !1 === h.enabled || a && (m || k && !1 === l.enabled) || a && x.states && x.states[a] && !1 === x.states[a].enabled)) {
            ...
            if (this.graphic)
              this.state && this.graphic.removeClass("highcharts-point-" + this.state), a && this.graphic.addClass("highcharts-point-" + a), this.graphic.animate(e.pointAttribs(this, a), d(u.options.chart.animation, h.animation)), C && this.graphic.animate(C, d(u.options.chart.animation, l.animation, g.animation)), n && n.hide();
            else {
              if (a && l) {
                g = x.symbol || e.symbol;
                ...
                if (n)
                  ...
                  g && (e.stateMarkerGraphic = n = u.renderer.symbol(g, C.x, C.y, C.width, C.height).add(e.markerGroup), n.currentSymbol = g);
                n && n.attr(e.pointAttribs(this, a));
              }
              n && (n[a && u.isInsidePlot(c, f, u.inverted) ? "show" : "hide"](), n.element.point = this);
            }
            (c = h.halo) && c.size ? (y || (e.halo = y = u.renderer.path().add((this.graphic || n).parentGroup)), y.show()[b ? "animate" : "attr"]({d: this.haloPath(c.size)}), y.attr({"class": "highcharts-halo highcharts-color-" + d(this.colorIndex, e.colorIndex)}), y.point = this, y.attr(q({
              fill: this.color || e.color,
              "fill-opacity": c.opacity,
              zIndex: -1
            }, c.attributes))) : y && y.point && y.point.haloPath && y.animate({d: y.point.haloPath(0)}, null, y.hide);
            this.state = a;
      ...
      q(c.prototype, {
        ...
        setState: function(a) {
          ...
          }), b.state = a, !e[a] || !1 !== e[a].enabled) && (a && (h = e[a].lineWidth || h + (e[a].lineWidthPlus || 0)), f && !f.dashstyle))
            for (h = {"stroke-width": h}, f.animate(h, d(e[a || "normal"] && e[a || "normal"].animation, b.chart.options.chart.animation)); b["zone-graph-" + c]; )
              b["zone-graph-" + c].attr(h), c += 1;
        },
    ...
    (function(a) {
      ...
      z.prototype.setResponsive = function(e) {
        ...
        g && g.rules && B(g.rules, function(f) {
          void 0 === f._id && (f._id = a.uniqueKey());
          this.matchResponsiveRule(f, m, e);
        }, this);
        var h = a.merge.apply(0, a.map(m, function(f) {
      ...
      z.prototype.currentOptions = function(q) {
        function r(f, h, m, k) {
          ...
          a.objectEach(f, function(a, c) {
            if (!k && -1 < y(c, ["series", "xAxis", "yAxis"]))
              for (a = u(a), m[c] = [], d = 0; d < a.length; d++)
                h[c][d] && (m[c][d] = {}, r(a[d], h[c][d], m[c][d], k + 1));
            else
              g(a) ? (m[c] = e(a) ? [] : {}, r(a, h[c] || {}, m[c], k + 1)) : m[c] = h[c] || null;
          });
        }
        var m = {};
    ...
    (function(a) {
      ...
      a(z.prototype, "getSeriesExtremes", function(a) {
        var e = this.isXAxis,
            ...
            q = [],
            r;
        e && B(this.series, function(a, f) {
          a.useMapGeometry && (q[f] = a.xData, a.xData = []);
        });
        a.call(this);
        e && (t = y(this.dataMin, Number.MAX_VALUE), u = y(this.dataMax, -Number.MAX_VALUE), B(this.series, function(a, f) {
      ...
      a(z.prototype, "setAxisTranslation", function(a) {
        var e = this.chart,
            ...
            u;
        a.call(this);
        "yAxis" === this.coll && void 0 !== e.transA && B(this.series, function(a) {
        ...
        if (u && (this.transA = e.transA = Math.min(this.transA, e.transA), a = t / ((e.max - e.min) / (this.max - this.min)), a = 1 > a ? this : e, t = (a.max - a.min) * a.transA, a.pixelPadding = a.len - t, a.minPixelPadding = a.pixelPadding / 2, t = a.fixTo)) {
          ...
          t *= a.transA;
          if (Math.abs(t) > a.minPixelPadding || a.min === a.dataMin && a.max === a.dataMax)
            t = 0;
          a.minPixelPadding -= t;
        }
      });
    ...
    (function(a) {
      ...
      a.ColorAxis || (e = a.ColorAxis = function() {
        ...
        setTickPositions: function() {
          if (!this.dataClasses)
            return z.prototype.setTickPositions.call(this);
        },
        initStops: function() {
        ...
        drawLegendSymbol: function(a, d) {
          ...
          this.setLegendColor();
          d.legendSymbol = this.chart.renderer.rect(0, a.baseline - 11, e, g).attr({zIndex: 1}).add(d.legendGroup);
        ...
        getSeriesExtremes: function() {
          ...
          for (this.dataMax = -Infinity; d--; )
            void 0 !== a[d].valueMin && (this.dataMin = Math.min(this.dataMin, a[d].valueMin), this.dataMax = Math.max(this.dataMax, a[d].valueMax));
        },
        ...
        getDataClassLegendSymbols: function() {
          var f = this,
              ...
              h = c.valueSuffix || "",
              n;
          b.length || g(this.dataClasses, function(c, k) {
            var l = !0,
                q = c.from,
                u = c.to;
            n = "";
        ...
        name: ""
      }), g(["fill", "stroke"], function(f) {
        a.Fx.prototype[f + "Setter"] = function() {
          this.elem.attr(f, y(this.start).tweenTo(y(this.end), this.pos), null, !0);
        };
      }), n(B.prototype, "getAxes", function(a) {
        var d = this.options.colorAxis;
        a.call(this);
        this.colorAxis = [];
        d && new e(this, d);
      }), n(q.prototype, "getAllItems", function(a) {
        var d = [],
            b = this.chart.colorAxis[0];
        b && b.options && (b.options.showInLegend && (b.options.dataClasses ? d = d.concat(b.getDataClassLegendSymbols()) : d.push(b)), g(b.series, function(a) {
          a.options.showInLegend = !1;
        }));
        return d.concat(a.call(this));
      }), n(q.prototype, "colorizeItem", function(a, d, b) {
        a.call(this, d, b);
        b && d.legendColor && d.legendSymbol.attr({fill: d.legendColor});
      }), n(q.prototype, "update", function(a) {
      ...
      a.colorSeriesMixin = {
        ...
        translateColors: function() {
          var a = this,
              ...
              u = this.colorAxis,
              q = this.colorKey;
          B(this.data, function(g) {
            var m = g[q];
            if (m = g.options.color || (g.isNull ? e : u && void 0 !== m ? u.toColor(m, g) : g.color || a.color))
              g.color = m;
          });
        },
    ...
    (function(a) {
      ...
      B.prototype.update = function(f) {
        ...
        for (; t.length; )
          t.pop().destroy();
        r(g.enableButtons, g.enabled) && !e.renderer.forExport && a.objectEach(g.buttons, function(a, f) {
      ...
      B.prototype.updateEvents = function(a) {
        var f = this.chart;
        r(a.enableDoubleClickZoom, a.enabled) || a.enableDoubleClickZoomTo ? this.unbindDblClick = this.unbindDblClick || y(f.container, "dblclick", function(a) {
          f.pointer.onContainerDblClick(a);
        }) : this.unbindDblClick && (this.unbindDblClick = this.unbindDblClick());
        r(a.enableMouseWheelZoom, a.enabled) ? this.unbindMouseWheel = this.unbindMouseWheel || y(f.container, void 0 === g.onmousewheel ? "DOMMouseScroll" : "mousewheel", function(a) {
      ...
      m(e.prototype, "render", function(a) {
    ...
    (function(a) {
      ...
      a(y.prototype, "pinchTranslate", function(a, g, t, u, q, r, m) {
    ...
    (function(a) {
      ...
      h("map", "scatter", {
        ...
        getBox: function(b) {
          ...
          B(b || [], function(b) {
            if (b.path) {
              ...
              if (!b._foundBox) {
                for (; m--; )
                  e(l[m]) && (n ? (p = Math.max(p, l[m]), t = Math.min(t, l[m])) : (u = Math.max(u, l[m]), v = Math.min(v, l[m])), n = !n);
        ...
        translatePath: function(a) {
          ...
          if (a)
            for (n = a.length; n--; )
              e(a[n]) ? (r[n] = b ? (a[n] - h) * g + d : (a[n] - k) * m + f, b = !b) : r[n] = a[n];
          return r;
        },
        setData: function(b, c, d, h) {
          ...
          b && B(b, function(a, c) {
            ...
            if (e(a))
              ...
              b[c] = {};
              !m.keys && a.length > y.length && "string" === typeof a[0] && (b[c]["hc-key"] = a[0], ++d);
              for (var f = 0; f < y.length; ++f, ++d)
                y[f] && (b[c][y[f]] = a[d]);
            }
            w && (b[c]._i = c);
          });
          this.getBox(b);
          (this.chart.mapTransforms = E = l && l.mapTransforms || q && q["hc-transform"] || E) && a.objectEach(E, function(a) {
          ...
          if (q) {
            ...
            for (E = 0; E < q.length; E++)
              l = q[E], n = l.properties, l._i = E, u[0] && n && n[u[0]] && (l[u[0]] = n[u[0]]), C[l[u[0]]] = l;
            this.mapMap = C;
            b && u[1] && B(b, function(a) {
              C[a[u[1]]] && z.push(C[a[u[1]]]);
            });
            m.allAreas ? (this.getBox(q), b = b || [], u[1] && B(b, function(a) {
              z.push(a[u[1]]);
            }), z = "|" + g(z, function(a) {
              return a && a[u[0]];
            }).join("|") + "|", B(q, function(a) {
              u[0] && -1 !== z.indexOf("|" + a[u[0]] + "|") || (b.push(t(a, {value: null})), h = !1);
            })) : this.getBox(z);
          }
        ...
        drawPoints: function() {
          ...
          a.doFullTranslate() ? (h.hasRendered && B(a.points, function(b) {
          ...
          }), a.group = a.transformGroup, n.column.prototype.drawPoints.apply(a), a.group = e, B(a.points, function(a) {
            ...
            scaleX: 1,
            scaleY: 1
          })) : (k = c.transA / t.transAX, m = f.transA / t.transAY, r = c.toPixels(t.originX, !0), q = f.toPixels(t.originY, !0), .99 < k && 1.01 > k && .99 < m && 1.01 > m && (m = k = 1, r = Math.round(r), q = Math.round(q)), u = this.transformGroup, h.renderer.globalAnimation ? (y = u.attr("translateX"), z = u.attr("translateY"), p = u.attr("scaleX"), F = u.attr("scaleY"), u.attr({animator: 0}).animate({animator: 1}, {step: function(a, b) {
              u.attr({
        ...
        onMouseOver: function(a) {
          ...
          if (null !== this.value || this.series.options.nullInteraction)
            m.prototype.onMouseOver.call(this, a);
          else
    ...
    (function(a) {
      ...
      h("bubble", "scatter", {
        ...
        getRadii: function(a, d, b, c) {
          ...
          for (f = g.length; e < f; e++)
            h = g[e], m.sizeByAbsoluteValue && null !== h && (h = Math.abs(h - r), d = Math.max(d - r, Math.abs(a - r)), a = 0), null === h ? h = null : h < a ? h = b / 2 - 1 : (h = 0 < q ? (h - a) / q : .5, n && 0 <= h && (h = Math.sqrt(h)), h = Math.ceil(b + h * (c - b)) / 2), k.push(h);
          this.radii = k;
        },
        animate: function(a) {
        ...
        translate: function() {
          ...
          for (f = d.length; f--; )
            b = d[f], c = e ? e[f] : 0, t(c) && c >= this.minPxSize / 2 ? (b.marker = a.extend(b.marker, {
              radius: c,
              width: 2 * c,
              height: 2 * c
            }), b.dlBox = {
      ...
      y.prototype.beforePadding = function() {
        ...
        g(this.series, function(c) {
          var d = c.options;
          !c.bubblePadding || !c.visible && b.options.chart.ignoreHiddenSeries || (a.allowZoomOutside = !0, I.push(c), e && (g(["minSize", "maxSize"], function(a) {
            var b = d[a],
                c = /%$/.test(b),
                b = r(b);
            n[a] = c ? u * b / 100 : b;
        ...
        g(I, function(b) {
          ...
          if (0 < y)
            for (; g--; )
              t(d[g]) && a.dataMin <= d[g] && d[g] <= a.dataMax && (k = b.radii[g], c = Math.min((d[g] - m) * H - k, c), f = Math.max((d[g] - m) * H + k, f));
        });
        I.length && 0 < y && !this.isLog && (f -= d, H *= (d + c - f) / d, g([["min", "userMin", c], ["max", "userMax", f]], function(b) {
    ...
    (function(a) {
      function z(a, e) {
        var f,
            ...
            b = a.y;
        a = 0;
        for (f = e.length - 1; a < e.length; f = a++)
          h = e[a][1] > b, g = e[f][1] > b, h !== g && d < (e[f][0] - e[a][0]) * (b - e[a][1]) / (e[f][1] - e[a][1]) + e[a][0] && (k = !k);
        return k;
      }
      var B = a.Chart,
          y = a.each,
        ...
        if (g) {
          for (f in g)
            if (g.hasOwnProperty(f) && g[f].hitZone && z({
              x: e.x,
              y: -e.y
            }, g[f].hitZone.coordinates[0]))
              return this.transformToLatLon(e, g[f]);
      ...
      B.prototype.fromLatLonToPoint = function(e) {
        ...
        for (f in g)
          if (g.hasOwnProperty(f) && g[f].hitZone && (h = this.transformFromLatLon(e, g[f]), z({
            x: h.x,
            y: -h.y
          }, g[f].hitZone.coordinates[0])))
            return h;
      ...
      a.geojson = function(a, m, f) {
        ...
        y(a.features, function(a) {
          ...
          var d;
          n = [];
          "map" === m || "mapbubble" === m ? ("Polygon" === c ? (y(b, k), n.push("Z")) : "MultiPolygon" === c && (y(b, function(a) {
            y(a, k);
          }), n.push("Z")), n.length && (d = {path: n})) : "mapline" === m ? ("LineString" === c ? k(b) : "MultiLineString" === c && y(b, k), n.length && (d = {path: n})) : "mappoint" === m && "Point" === c && (d = {
            x: b[0],
            y: -b[1]
          });
          d && h.push(e(d, {
        ...
        f && a.copyrightShort && (f.chart.mapCredits = g(f.chart.options.credits.mapText, {geojson: a}), f.chart.mapCreditsFull = g(f.chart.options.credits.mapTextFull, {geojson: a}));
        return h;
      };
      q(B.prototype, "addCredits", function(a, e) {
    ...
    (function(a) {
      ...
      a.splitPath = function(a) {
        ...
        for (e = 0; e < a.length; e++)
          /[a-zA-Z]/.test(a[e]) || (a[e] = parseFloat(a[e]));
        return a;
      };
      a.maps = {};
      ...
      q === m && e(["topbutton", "bottombutton"], function(a) {
