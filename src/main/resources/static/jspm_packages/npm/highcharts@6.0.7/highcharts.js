...
(function(process) {
  (function(S, K) {
    ...
    (function(a) {
      ...
      a.Fx.prototype = {
        dSetter: function() {
          ...
          if (1 === t)
            ...
            for (; n--; )
              v = parseFloat(a[n]), l[n] = isNaN(v) ? f[n] : t * parseFloat(f[n] - v) + v;
          else
            l = f;
        ...
        update: function() {
          ...
          if (this[f + "Setter"])
            ...
            a.attr ? a.element && a.attr(f, l, null, !0) : a.style[f] = l + this.unit;
          t && t.call(a, l, this);
        },
        run: function(q, f, l) {
          var t = this,
          ...
          q === f ? (delete n.curAnim[this.prop], n.complete && 0 === a.keys(n.curAnim).length && n.complete.call(this.elem)) : (this.startTime = +new Date, this.start = q, this.end = f, this.unit = l, this.now = this.start, this.pos = 0, v.elem = this.elem, v.prop = this.prop, v() && 1 === a.timers.push(v) && u(c));
        },
        step: function(q) {
          var f = +new Date,
              l,
        ...
        initPath: function(q, f, l) {
          function t(a) {
            var c,
                h;
            for (e = a.length; e--; )
              c = "M" === a[e] || "L" === a[e], h = /[a-zA-Z]/.test(a[e + 3]), c && h && a.splice(e + 1, 0, a[e + 1], a[e + 2], a[e + 1], a[e + 2]);
          }
          function n(a, c) {
            for (; a.length < h; ) {
              a[0] = c[h - a.length];
          ...
          function v(a, c) {
            for (var b = (h - a.length) / d; 0 < b && b--; )
              k = a.slice().splice(a.length / r - d, d * r), k[0] = c[h - d - b * d], m && (k[d - 6] = k[d - 2], k[d - 5] = k[d - 1]), [].splice.apply(a, [a.length / r, 0].concat(k)), p && b--;
          }
          f = f || "";
          var u,
              c = q.startX,
          ...
          f.length && a.isNumber(u) && (h = l.length + u * r * d, I ? (n(f, l), v(l, f)) : (n(l, f), v(f, l)));
          return [f, l];
        }
      };
      ...
      a.stop = function(q, f) {
        for (var l = a.timers.length; l--; )
          a.timers[l].elem !== q || f && f !== a.timers[l].prop || (a.timers[l].stopped = !0);
      };
      ...
      a.objectEach = function(a, f, l) {
        for (var t in a)
          a.hasOwnProperty(t) && f.call(l, a[t], t, a);
      };
      ...
      a.fireEvent = function(q, f, l, t) {
        var n,
            ...
            b;
        l = l || {};
        H.createEvent && (q.dispatchEvent || q.fireEvent) ? (n = H.createEvent("Events"), n.initEvent(f, !0, !0), a.extend(n, l), q.dispatchEvent ? q.dispatchEvent(n) : q.fireEvent(f, n)) : a.each(["protoEvents", "hcEvents"], function(m) {
          if (q[m])
      ...
      E.jQuery && (E.jQuery.fn.highcharts = function() {
        ...
        if (this[0])
          return q[0] ? (new (a[a.isString(q[0]) ? q.shift() : "Chart"])(this[0], q[0], q[1]), this) : B[a.attr(this[0], "data-highcharts-chart")];
      });
    })(K);
    (function(a) {
      var B = a.each,
      ...
      a.Color.prototype = {
        ...
        get: function(a) {
          var l = this.input,
              n = this.rgba,
              v;
          this.stops ? (v = q(l), v.stops = [].concat(v.stops), B(this.stops, function(n, c) {
    ...
    (function(a) {
      ...
      h(B.prototype, {
        ...
        colorGradient: function(y, g, c) {
          ...
          b && (e = y[b], p = w.gradients, x = y.stops, A = c.radialReference, I(e) && (y[b] = e = {
          ...
          }), "radialGradient" === b && A && !u(e.gradientUnits) && (k = e, e = F(e, w.getRadialAttr(A, k), {gradientUnits: "userSpaceOnUse"})), J(e, function(a, y) {
            "id" !== y && r.push(y, a);
          }), J(x, function(a) {
            r.push(a);
            ...
            Q.stops.push(y);
          })), P = "url(" + w.url + "#" + A + ")", c.setAttribute(g, P), c.gradient = r, y.toString = function() {
            return P;
          });
        },
        applyTextOutline: function(y) {
          ...
          if ((h = y[0]) && "none" !== h && a.svg) {
            ...
            for (b = y.length; b--; )
              c = y[b], "highcharts-text-outline" === c.getAttribute("class") && k(y, g.removeChild(c));
            e = g.firstChild;
            d(y, function(a, y) {
        ...
        attr: function(a, g, c, w) {
          ...
          "string" === typeof a ? e = (this[a + "Getter"] || this._defaultGetter).call(this, a, h) : (J(a, function(y, g) {
            d = !1;
            w || L(this, g);
        ...
        updateShadows: function(a, g, c) {
          for (var y = this.shadows,
              w = y.length; w--; )
            c.call(y[w], "height" === a ? Math.max(g - (y[w].cutHeight || 0), 0) : "d" === a ? this.d : g, a, y[w]);
        },
        ...
        on: function(a, g) {
          ...
          p && "click" === a ? (c.ontouchstart = function(a) {
            ...
            (-1 === R.navigator.userAgent.indexOf("Android") || 1100 < Date.now() - (y.touchEventFired || 0)) && g.call(c, a);
          }) : c["on" + a] = g;
          return this;
        },
        ...
        align: function(a, g, c) {
          ...
          if (a) {
            ...
            a = this.alignOptions, g = this.alignByTranslate, y = this.alignTo;
          c = G(c, w[y], w);
          y = a.align;
          w = a.verticalAlign;
          h = (c.x || 0) + (a.x || 0);
        ...
        destroy: function() {
          ...
          h && w && (d(w.querySelectorAll("[clip-path],[CLIP-PATH]"), function(a) {
            var g = a.getAttribute("clip-path"),
                y = h.element.id;
            (-1 < g.indexOf("(#" + y + ")") || -1 < g.indexOf('("#' + y + '")')) && a.removeAttribute("clip-path");
        ...
        shadow: function(a, g, c) {
          ...
          if (!a)
            ...
            for (w = 1; w <= d; w++)
              h = e.cloneNode(0), b = 2 * d + 1 - 2 * w, f(h, {
                isShadow: "true",
      ...
      B.prototype.translateXSetter = B.prototype.translateYSetter = B.prototype.rotationSetter = B.prototype.verticalAlignSetter = B.prototype.rotationOriginXSetter = B.prototype.rotationOriginYSetter = B.prototype.scaleXSetter = B.prototype.scaleYSetter = B.prototype.matrixSetter = function(a, g) {
        this[g] = a;
        this.doTransform = !0;
      };
      ...
      h(H.prototype, {
        ...
        applyEllipsis: function(a, g, c, w) {
          ...
          if (p = y > w) {
            for (; e <= d; )
              b = Math.ceil((e + d) / 2), y = c.substring(0, b) + "\u2026", k(y), y = this.getSpanWidth(a, g), e === d ? e = d + 1 : y > w ? d = b - 1 : e = b;
            0 === d && k("");
          }
          a.rotation = h;
          return p;
        ...
        buildText: function(a) {
          ...
          if (M !== a.textCache) {
            for (a.textCache = M; I--; )
              c.removeChild(k[I]);
            y || D || C || O || -1 !== b.indexOf(" ") ? (p = /<.*class="([^"]+)".*>/, x = /<.*style="([^"]+)".*>/, A = /<.*href="([^"]+)".*>/, L && L.appendChild(c), b = y ? b.replace(/<(b|strong)>/g, '\x3cspan style\x3d"font-weight:bold"\x3e').replace(/<(i|em)>/g, '\x3cspan style\x3d"font-style:italic"\x3e').replace(/<a/g, "\x3cspan").replace(/<\/(b|strong|i|em|a)>/g, "\x3c/span\x3e").split(/<br.*?>/g) : [b], b = e(b, function(a) {
              return "" !== a;
            }), d(b, function(g, b) {
              var e,
                  y = 0;
              ...
              d(e, function(g) {
                if ("" !== g || 1 === e.length) {
                  ...
                  A.test(g) && !h && (f(k, "onclick", 'location.href\x3d"' + g.match(A)[1] + '"'), f(k, "class", "highcharts-anchor"), n(k, {cursor: "pointer"}));
                  ...
                  if (" " !== g) {
                    ...
                    if (O) {
                      ...
                      var l = [],
                          ...
                          J = R(k),
                          G = a.rotation;
                      for (C && (F = w.applyEllipsis(a, k, g, O)); !C && r && (d.length || l.length); )
                        a.rotation = 0, D = w.getSpanWidth(a, k), g = D > O, void 0 === F && (F = g), g && 1 !== d.length ? (k.removeChild(k.firstChild), l.unshift(d.pop())) : (d = l, l = [], d.length && !v && (k = m.createElementNS(N, "tspan"), f(k, {
                          dy: J,
                          x: z
        ...
        symbols: {
          ...
          callout: function(a, g, c, w, b) {
            ...
            b = b && b.anchorY;
            var k;
            k = ["M", a + h, g, "L", a + c - h, g, "C", a + c, g, a + c, g, a + c, g + h, "L", a + c, g + w - h, "C", a + c, g + w, a + c, g + w, a + c - h, g + w, "L", a + h, g + w, "C", a, g + w, a, g + w, a, g + w - h, "L", a, g + h, "C", a, g, a, g, a + h, g];
        ...
        label: function(g, c, b, e, k, p, x, N, m) {
          ...
          q = function() {
            ...
            I && (L || (r.box = L = A.symbols[e] || t ? A.symbol(e) : A.rect(), L.addClass(("button" === m ? "" : "highcharts-label-box") + (m ? " highcharts-" + m + "-box" : "")), L.add(r), a = R(), g.x = a, g.y = (N ? -M : 0) + a), g.width = Math.round(r.width), g.height = Math.round(r.height), L.attr(h(g, G)), G = {});
          };
          Q = function() {
            var a = l + O,
                g;
        ...
        htmlUpdateTransform: function() {
          if (this.added) {
            ...
            if ("SPAN" === b.tagName) {
              ...
              A && /[ \-]/.test(b.textContent || b.innerText) && (E(b, {
                width: x + "px",
                display: "block",
                whiteSpace: C || "normal"
              }), this.oldTextWidth = x);
      ...
      a.Time.prototype = {
        ...
        update: function(n) {
          ...
          (this.variableTimezone = !(l && !n.getTimezoneOffset && !n.timezone)) || this.timezoneOffset ? (this.get = function(a, b) {
            ...
            if (-1 !== a.inArray(c, ["Milliseconds", "Seconds", "Minutes"]))
              ...
              d = u.getTimezoneOffset(b), d = b.getTime() - d, b.setTime(d), b["setUTC" + c](m), c = u.getTimezoneOffset(b), d = b.getTime() + c, b.setTime(d);
        ...
        makeTime: function(l, v, u, c, b, m) {
          var d,
              h,
              k;
          this.useUTC ? (d = this.Date.UTC.apply(0, arguments), h = this.getTimezoneOffset(d), d += h, k = this.getTimezoneOffset(d), h !== k ? d += k - h : h - 36E5 !== this.getTimezoneOffset(d - 36E5) || a.isSafari || (d -= 36E5)) : d = (new this.Date(l, v, f(u, 1), f(c, 0), f(b, 0), f(m, 0))).getTime();
          return d;
        },
        ...
        getTimeTicks: function(a, v, u, c) {
          ...
          if (B(v)) {
            ...
            e >= l.second && b.set("Seconds", k, e >= l.minute ? 0 : p * Math.floor(b.get("Seconds", k) / p));
            ...
            k = k.getTime();
            for (v = 1; k < u; )
              m.push(k), k = e === l.year ? b.makeTime(h + v * p, 0) : e === l.month ? b.makeTime(h, c + v * p) : !r || e !== l.day && e !== l.week ? r && e === l.hour && 1 < p ? b.makeTime(h, c, n, z + v * p) : k + e * p : b.makeTime(h, c, n + v * p * (e === l.day ? 1 : 7)), v++;
            m.push(k);
      ...
      a.Tick.prototype = {
        addLabel: function() {
          ...
          if (H(c))
            ...
            if (this.label = c = H(v) && d.enabled ? u.renderer.text(v, 0, 0, d.useHTML).css(f(d.style)).add(a.labelGroup) : null)
        ...
        handleOverflow: function(a) {
          var f = this.axis,
              ...
              D = {};
          if (k || !1 === n.overflow)
            0 > k && c - e * p < d ? M = Math.round(c / Math.cos(k * t) - d) : 0 < k && c + e * p > m && (M = Math.round((b - c) / Math.cos(k * t)));
          else if (b = c + (1 - e) * p, c - e * p < d ? I = a.x + I * (1 - e) - d : b > m && (I = m - a.x + I * e, z = -1), I = Math.min(r, I), I < r && "center" === f.labelAlign && (a.x += z * (r - I - e * (r - Math.min(p, I)))), p > I || f.autoRotation && (h.styles || {}).width)
            M = I;
        ...
        getPosition: function(l, f, u, c) {
          ...
          return {
            ...
            y: l ? d - b.bottom + b.offset - (b.opposite ? b.height : 0) : a.correctFloat(d - b.translate(f + u, null, null, c) - b.transB)
          };
        },
        ...
        renderGridLine: function(a, l, f) {
          var c = this.axis,
              ...
              z = b[r + "LineColor"],
              b = b[r + "LineDashStyle"];
          m || (d.stroke = z, d["stroke-width"] = n, b && (d.dashstyle = b), k || (d.zIndex = 1), a && (d.opacity = 0), this.gridLine = m = p.path().attr(d).addClass("highcharts-" + (k ? k + "-" : "") + "grid-line").add(c.gridGroup));
        ...
        renderMark: function(a, f, u) {
          ...
          var n = l(b[h + "Width"], !d && c.isXAxis ? 1 : 0),
              b = b[h + "Color"];
          k && (c.opposite && (k[0] = -k[0]), p && (this.mark = e = m.path().addClass("highcharts-" + (d ? d + "-" : "") + "tick").add(c.axisGroup), e.attr({
            stroke: b,
            "stroke-width": n
          })), e[p ? "attr" : "animate"]({
      ...
      a.extend(G.prototype, {
        ...
        defaultLabelFormatter: function() {
          ...
          if (m)
            ...
            for (; x-- && void 0 === r; )
              b = Math.pow(k, x + 1), g >= b && 0 === 10 * c % b && null !== p[x] && 0 !== c && (r = a.numberFormat(c / b, -1) + p[x]);
        ...
        getSeriesExtremes: function() {
          ...
          c(a.series, function(g) {
            if (g.visible || !b.options.chart.ignoreHiddenSeries) {
              ...
              if (a.isXAxis)
                c = g.xData, c.length && (g = q(c), d = E(c), r(g) || g instanceof Date || (c = k(c, r), g = q(c), d = E(c)), c.length && (a.dataMin = Math.min(C(a.dataMin, c[0], g), g), a.dataMax = Math.max(C(a.dataMax, c[0], d), d)));
              else if (g.getExtremes(), d = g.dataMax, g = g.dataMin, n(g) && n(d) && (a.dataMin = Math.min(C(a.dataMin, g), g), a.dataMax = Math.max(C(a.dataMax, d), d)), n(w) && (a.threshold = w), !c.softThreshold || a.positiveValuesOnly)
                a.softThreshold = !1;
            }
          });
        },
        ...
        getPlotLinePath: function(a, c, b, d, e) {
          ...
          r(e) ? this.horiz ? (k = h, p = x - this.bottom, a = b = A(a, w, w + this.width)) : (a = w, b = m - this.right, k = p = A(k, h, h + this.height)) : (N = !0, d = !1);
        ...
        getMinorTickPositions: function() {
          ...
          if (x && x / e < a.len / 3)
            if (a.isLog)
              ...
              h = h.concat(a.getTimeTicks(a.normalizeTimeTickInterval(e), p, k, b.startOfWeek));
            else
              for (b = p + (d[0] - p) % e; b <= k && b !== h[0]; b += e)
                h.push(b);
        ...
        adjustForMinRange: function() {
          ...
          this.isXAxis && void 0 === this.minRange && !this.isLog && (n(a.min) || n(a.max) ? this.minRange = null : (c(this.series, function(a) {
            ...
            for (p = m = a.xIncrement ? 1 : r.length - 1; 0 < p; p--)
              if (x = r[p] - r[p - 1], void 0 === k || x < k)
                k = x;
          }), this.minRange = Math.min(5 * k, this.dataMax - this.dataMin)));
          d - b < this.minRange && (h = this.dataMax - this.dataMin >= this.minRange, A = this.minRange, e = (A - d + b) / 2, e = [b - e, C(a.min, b - e)], h && (e[2] = this.isLog ? this.log2lin(this.dataMin) : this.dataMin), b = E(e), d = [b + A, C(a.max, b + A)], h && (d[2] = this.isLog ? this.log2lin(this.dataMax) : this.dataMax), d = q(d), d - b < A && (e[0] = d - A, e[1] = C(a.min, d - A), b = E(e)));
          this.min = b;
          this.max = d;
        },
        getClosest: function() {
        ...
        updateNames: function() {
          ...
          0 < b.length && (c(a.keys(b.keys), function(a) {
            ...
            c(a.points, function(c, b) {
              var d;
              c.options && (d = g.nameToX(c), void 0 !== d && d !== c.x && (c.x = d, a.xData[b] = d));
            });
          }));
        },
        setAxisTranslation: function(a) {
          var g = this,
              ...
              m = g.isXAxis;
          if (m || x || d)
            e = g.getClosest(), p ? (h = p.minPointOffset, k = p.pointRangePadding) : c(g.series, function(a) {
              var c = x ? 1 : m ? C(a.options.pointRange, e, 0) : g.axisPointRange || 0;
              a = a.options.pointPlacement;
              d = Math.max(d, c);
              g.single || (h = Math.max(h, I(a) ? 0 : c / 2), k = Math.max(k, "on" === a ? 0 : c));
            }), p = g.ordinalSlope && e ? g.ordinalSlope / e : 1, g.minPointOffset = h *= p, g.pointRangePadding = k *= p, g.pointRange = Math.min(d, b), m && (g.closestPointRange = e);
          a && (g.oldTransA = r);
        ...
        setTickInterval: function(g) {
          ...
          k && (b.positiveValuesOnly && !g && 0 >= Math.min(b.min, C(b.dataMin, b.min)) && a.error(10, 1), b.min = l(p(b.min), 15), b.max = l(p(b.max), 15));
        ...
        alignToOthers: function() {
          var a = {},
              b,
              d = this.options;
          !1 === this.chart.options.chart.alignTicks || !1 === d.alignTicks || this.isLog || c(this.chart[this.coll], function(g) {
            var c = g.options,
        ...
        adjustTickAmount: function() {
          ...
          if (this.hasData()) {
            if (e < c) {
              for (; b.length < c; )
                b.length % 2 || this.min === h ? b.push(l(b[b.length - 1] + a)) : b.unshift(l(b[0] - a));
              this.transA *= (e - 1) / (c - 1);
              this.min = b[0];
        ...
        zoom: function(a, b) {
          ...
          if (a !== this.min || b !== this.max)
            this.allowZoomOutside || (n(g) && (a < e && (a = e), a > d && (a = d)), n(c) && (b < e && (b = e), b > d && (b = d))), this.displayBtn = void 0 !== a || void 0 !== b, this.setExtremes(a, b, !1, void 0, {trigger: "zoom"});
          return !0;
        },
        setAxisSize: function() {
          var b = this.chart,
              ...
              p = this.top = Math.round(a.relativeLength(C(c.top, b.plotTop + d[0]), b.plotHeight, b.plotTop)),
        ...
        unsquish: function() {
          ...
          b ? (A = !a.staggerLines && !a.step && (n(p) ? [p] : h < C(a.autoRotationLimit, 80) && a.autoRotation)) && c(A, function(a) {
            var b;
            if (a === p || a && -90 <= a && 90 >= a)
              r = F(Math.abs(x.h / Math.sin(v * a))), b = r + Math.abs(a / 360), b < m && (m = b, k = a, e = r);
          }) : a.step || (e = F(x.h));
          this.autoRotation = A;
        ...
        renderUnsquish: function() {
          ...
          if (this.autoRotation)
            ...
            for (l = "clip", x = d.length; !k && x--; )
              if (z = d[x], z = e[z].label)
                z.styles && "ellipsis" === z.styles.textOverflow ? z.css({textOverflow: "clip"}) : z.textPxLength > p && z.css({width: p + "px"}), z.getBBox().height > this.len / d.length - (m.h - m.f) && (z.specificTextOverflow = "ellipsis");
          ...
          c(d, function(a) {
            ...
            }), delete b.specificTextOverflow, a.rotation = r.rotation);
          });
        ...
        getOffset: function() {
          ...
          a.axisGroup || (a.gridGroup = d.g("grid").attr({zIndex: e.gridZIndex || 1}).addClass("highcharts-" + this.coll.toLowerCase() + "-grid " + (v || "")).add(M), a.axisGroup = d.g("axis").attr({zIndex: e.zIndex || 2}).addClass("highcharts-" + this.coll.toLowerCase() + " " + (v || "")).add(M), a.labelGroup = d.g("axis-labels").attr({zIndex: J.zIndex || 7}).addClass("highcharts-" + a.coll.toLowerCase() + "-labels " + (v || "")).add(M));
          ...
          z && z.text && !1 !== z.enabled && (a.addTitle(A), A && !1 !== z.reserveSpace && (a.titleOffset = F = a.axisTitle.getBBox()[p ? "height" : "width"], l = z.offset, f = n(l) ? 0 : C(z.margin, p ? 5 : 10)));
          a.renderLine();
        ...
        renderTick: function(a, b) {
          ...
          if (!c || a >= this.min && a <= this.max)
            g[a] || (g[a] = new J(this, a)), d && g[a].isNew && g[a].render(b, !0, .1), g[a].render(b);
        },
        render: function() {
          var b = this,
              d = b.chart,
          ...
          if (b.hasData() || p)
            b.minorTickInterval && !b.categories && c(b.getMinorTickPositions(), function(a) {
              ...
              b.renderTick(a, c);
            }), n && (0 === b.min || b.single) && (F[-1] || (F[-1] = new J(b, -1, null, !0)), F[-1].render(-1))), G && c(x, function(c, e) {
    ...
    (function(a) {
      ...
      B.prototype.normalizeTimeTickInterval = function(a, l) {
        ...
        var n = q[l[0]],
            v = l[1],
            u;
        for (u = 0; u < f.length && !(l = f[u], n = q[l[0]], v = l[1], f[u + 1] && a <= (n * v[v.length - 1] + q[f[u + 1][0]]) / 2); u++)
          ;
      ...
      B.prototype.getLogTickPositions = function(a, t, n, v) {
        ...
        if (.5 <= a)
          ...
          for (var c = Math.floor(t),
              ...
              p,
              r,
              l = .3 < a ? [1, 2, 4] : .15 < a ? [1, 2, 4, 6, 8] : [1, 2, 3, 4, 5, 6, 7, 8, 9]; c < n + 1 && !r; c++)
            for (k = l.length, h = 0; h < k && !r; h++)
              e = m(b(c) * l[h]), e > t && (!v || p <= n) && void 0 !== p && d.push(p), p > n && (r = !0), p = e;
        else
          t = b(t), n = b(n), a = v ? this.getMinorTickInterval() : l.tickInterval, a = f("auto" === a ? null : a, this._minorAutoInterval, l.tickPixelInterval / (v ? 5 : 1) * (n - t) / ((v ? c / this.tickPositions.length : c) || 1)), a = q(a, null, H(a)), d = E(this.getLinearTickPositions(a, t, n), m), v || (this._minorAutoInterval = a / 5);
    ...
    (function(a, B) {
      ...
      a.PlotLineOrBand.prototype = {
        render: function() {
          var f = this,
              ...
              x = v(m.zIndex, 0),
              F = m.events,
              D = {"class": "highcharts-plot-" + (r ? "band " : "line ") + (m.className || "")},
              A = {},
              J = c.chart.renderer,
              G = r ? "bands" : "lines",
              g = c.log2lin;
          ...
          if (l)
            D = c.getPlotLinePath(p, z.strokeWidth());
          else if (r)
            D = c.getPlotBandPath(e, k, m);
          else
            return;
      ...
      a.extend(B.prototype, {
        getPlotBandPath: function(a, c) {
          ...
          if (m && b)
            for (a && (e = m.toString() === b.toString(), k = 0), a = 0; a < m.length; a += 6)
              h && b[a + 1] === m[a + 1] ? (b[a + 1] += k, b[a + 4] += k) : h || b[a + 2] !== m[a + 2] || (b[a + 2] += k, b[a + 5] += k), d.push("M", m[a + 1], m[a + 2], "L", m[a + 4], m[a + 5], b[a + 4], b[a + 5], b[a + 1], b[a + 2], "z"), d.flat = e;
          return d;
        },
      ...
      a.Tooltip.prototype = {
        ...
        getPosition: function(a, b, m) {
          var c = this.chart,
              ...
              e = c.inverted && m.h || 0,
              p,
              r = ["y", c.chartHeight, b, m.plotY + c.plotTop, c.plotTop, c.plotTop + c.plotHeight],
        ...
        refresh: function(a, b) {
          ...
          var p = this.shared,
              f;
          d.enabled && (clearTimeout(this.hideTimer), this.followPointer = n(k)[0].series.tooltipOptions.followPointer, e = this.getAnchor(k, b), b = e[0], h = e[1], !p || k.series && k.series.noSharedTooltip ? p = k.getLabelConfig() : (B(k, function(a) {
            a.setState("hover");
            r.push(a.getLabelConfig());
          }), p = {
            x: k[0].category,
            y: k[0].y
          }, p.points = r, k = k[0]), this.len = r.length, p = c.call(p, this), f = k.series, this.distance = t(f.tooltipOptions.distance, 16), !1 === p ? this.hide() : (c = this.getLabel(), this.isHidden && c.attr({opacity: 1}).show(), this.split ? this.renderSplit(p, n(a)) : (d.style.width || c.css({width: this.chart.spacingBox.width}), c.attr({text: p && p.join ? p.join("") : p}), c.removeClass(/highcharts-color-[\d]+/g).addClass("highcharts-color-" + t(k.colorIndex, f.colorIndex)), c.attr({stroke: d.borderColor || k.color || f.color || "#666666"}), this.updatePosition({
            plotX: b,
            plotY: h,
            negative: k.negative,
            ttBelow: k.ttBelow,
        ...
        renderSplit: function(c, b) {
          ...
          B(c.slice(0, b.length + 1), function(a, c) {
            if (!1 !== a) {
              ...
              c.isHeader ? (r = a.height, x = Math.max(0, Math.min(c.plotX + h.plotLeft - x / 2, h.chartWidth - x))) : x = c.plotX + h.plotLeft - t(p.distance, 16) - x;
              0 > x && (e = !1);
        ...
        getDateFormat: function(a, b, m, d) {
          ...
          for (p in u) {
            ...
            if (r[p] && k.substr(r[p]) !== "01-01 00:00:00.000".substr(r[p]))
              break;
            "week" !== p && (f = p);
          }
          p && (e = d[p]);
      ...
      a.Pointer.prototype = {
          ...
          t(a, function(a) {
            ...
            if ((h = b(a, !0)) && !(h = !b(e, !0)))
              var h = e.distX - a.distX,
                  ...
                  h = 0 < (0 !== h && c ? h : 0 !== k ? k : 0 !== p ? p : e.series.index > a.series.index ? -1 : 1);
            h && (e = a);
          });
          return e;
        },
        ...
        getHoverData: function(c, h, k, f, m, l, n) {
          ...
          n = h && !h.stickyTracking ? [h] : a.grep(k, function(a) {
            return a.visible && !(!m && a.directTouch) && d(a.options.enableMouseTracking, !0) && a.stickyTracking;
          });
        ...
        runPointActions: function(b, c) {
          ...
          if (p && (p !== e.hoverPoint || h && h.isHidden)) {
            ...
            c && h && !h.isHidden && (p = h.getAnchor([{}], b), h.updatePosition({
              plotX: p[0],
              plotY: p[1]
            }));
        ...
        reset: function(a, b) {
          ...
          if (a)
            p && f && (p.refresh(f), e && (e.setState(e.state, !0), t(c.axes, function(a) {
        ...
        drag: function(a) {
          ...
          n && n.touch || (d < f ? d = f : d > f + m && (d = f + m), e < x ? e = x : e > x + A && (e = x + A), this.hasDragged = Math.sqrt(Math.pow(g - d, 2) + Math.pow(w - e, 2)), 10 < this.hasDragged && (l = b.isInsidePlot(g - f, w - x), b.hasCartesianSeries && (this.zoomX || this.zoomY) && l && !t && !n && (this.selectionMarker = n = b.renderer.rect(f, x, h ? 1 : m, k ? 1 : A, 0).attr({
        ...
        drop: function(a) {
          ...
          d && c(d.index) && (f(d.container, {cursor: d._cursor}), d.cancelClick = 10 < this.hasDragged, d.mouseIsDown = this.hasDragged = this.hasPinched = !1, this.pinchDown = []);
        },
      ...
      E(a.Pointer.prototype, {
        ...
        pinch: function(a) {
          ...
          "touchstart" === a.type ? (H(c, function(a, b) {
            ...
            destroy: f,
            touch: !0
          }, t.plotBox)), n.pinchTranslate(u, c, k, h, p, m), n.hasPinched = d, n.scaleGroups(k, p), n.res && (n.res = !1, this.reset(!1, 0)));
        },
        touch: function(f, n) {
          var t = this.chart,
              q,
    ...
    (function(a) {
      ...
      a.Legend.prototype = {
        ...
        renderItem: function(a) {
          ...
          G || (a.legendGroup = c.g("legend-item").addClass("highcharts-" + w.type + "-series highcharts-color-" + a.colorIndex + (O ? " " + O : "") + (g ? " highcharts-series-" + a.index : "")).attr({zIndex: 1}).add(this.scrollGroup), a.legendItem = G = c.text("", x ? m + l : -l, this.baseline || 0, N).css(n(a.visible ? z : q)).attr({
            align: x ? "left" : "right",
            zIndex: 2
          }).add(a.legendGroup), this.baseline || (m = z.fontSize, this.fontMetrics = c.fontMetrics(m, G), this.baseline = this.fontMetrics.f + 3 + J, G.attr("y", this.baseline)), this.symbolHeight = d.symbolHeight || this.fontMetrics.f, w.drawLegendSymbol(this, a), this.setItemEvents && this.setItemEvents(a, G, N), u && this.createCheckboxForItem(a));
        ...
        handleOverflow: function(a) {
          ...
          a > c && !1 !== D.enabled ? (this.clipHeight = z = Math.max(c - 20 - this.titleHeight - n, 0), this.currentPage = v(this.currentPage, 1), this.fullHeight = a, f(G, function(a, b) {
            ...
            b.scroll(-1, t);
          }).add(F), this.pager = d.text("", 15, 10).addClass("highcharts-legend-navigation").css(D.style).add(F), this.down = d.symbol("triangle-down", 0, 0, x, x).on("click", function() {
            b.scroll(1, t);
        ...
        scroll: function(a, b) {
          ...
          0 < a && (void 0 !== b && u(b, this.chart), this.nav.attr({
            ...
            visibility: "visible"
          }), this.up.attr({"class": 1 === a ? "highcharts-legend-nav-inactive" : "highcharts-legend-nav-active"}), m.attr({text: a + "/" + d}), this.down.attr({
        ...
        reflow: function(c) {
          ...
          if (!h && !g.isPrinting && k && d && (e === L || e === f)) {
            if (k !== g.containerWidth || d !== g.containerHeight)
              clearTimeout(g.reflowTimeout), g.reflowTimeout = w(function() {
    ...
    (function(a) {
      ...
      a.Point.prototype = {
        init: function(a, b, m) {
          ...
          a.options.colorByPoint ? (b = a.options.colors || a.chart.options.colors, this.color = this.color || b[a.colorCounter], b = b.length, m = a.colorCounter, a.colorCounter++, a.colorCounter === b && (a.colorCounter = 0)) : m = a.colorIndex;
        ...
        optionsToObject: function(a) {
          ...
          if (n(a) || null === a)
            ...
            for (!d && a.length > k && (c = typeof a[0], "string" === c ? b.name = a[0] : "number" === c && (b.x = a[0]), e++); f < k; )
      ...
      a.Series = a.seriesType("line", null, {
        ...
        bindAxes: function() {
          ...
          v(b.axisTypes || [], function(h) {
            v(d[h], function(a) {
              e = a.options;
              if (c[h] === e.index || void 0 !== c[h] && c[h] === e.id || void 0 === c[h] && 0 === e.index)
        ...
        getCyclic: function(a, b, c) {
          ...
          b || (d = r(g[h], g["_" + h]), n(d) || (e.series.length || (e[k] = 0), g["_" + h] = d = e[k] % f, e[k] += 1), c && (b = c[d]));
          void 0 !== d && (this[h] = d);
          this[a] = b;
        },
        getColor: function() {
        ...
        setData: function(b, c, e, f) {
          ...
          if (!1 !== f && x && l === x && !m.cropped && !m.hasGroupedData && m.visible)
            ...
            if (z && x > z) {
              ...
              for (e = 0; e < x; e++)
                void 0 !== b[e] && (n = {series: m}, m.pointClass.prototype.applyOptions.apply(n, [b[e]]), m.updateParallelArrays(n, e));
        ...
        processData: function(b) {
          ...
          var x = this.getExtremesFromAll || l.getExtremesFromAll,
              ...
              z,
              q;
          if (p && !this.isDirty && !f.isDirty && !this.yAxis.isDirty && !b)
            return !1;
          ...
          if (p && this.sorted && !x && (!m || e > m || this.forceCrop))
            if (c[e - 1] < z || c[0] > q)
              ...
              h = this.cropData(this.xData, this.yData, z, q), c = h.xData, d = h.yData, h = h.start, g = !0;
          for (m = c.length || 1; --m; )
            e = n ? l(c[m]) - l(c[m - 1]) : c[m] - c[m - 1], 0 < e && (void 0 === k || e < k) ? k = e : 0 > e && r && (a.error(15), r = !1);
          this.cropped = g;
          this.cropStart = h;
        ...
        generatePoints: function() {
          ...
          for (r = 0; r < k; r++)
            m = f + r, l ? (p = (new h).init(this, [e[r]].concat(z(g[r]))), p.dataGroup = this.groupMap[r]) : (p = c[m]) || void 0 === b[m] || (c[m] = p = (new h).init(this, b[m], e[r])), p && (p.index = m, n[r] = p);
          this.options.keys = a;
          if (c && (k !== (d = c.length) || l))
            for (r = 0; r < d; r++)
              r !== f || l || (r += k), c[r] && (c[r].destroyElements(), c[r].plotX = void 0);
          this.data = c;
          this.points = n;
        },
        ...
        translate: function() {
          ...
          for (a = 0; a < m; a++) {
            var I = g[a],
                ...
                E = I.y;
            C = I.low;
            var H = c && k.stacks[(this.negStacks && E < (D ? 0 : q) ? "-" : "") + this.stackKey],
                K;
            k.positiveValuesOnly && null !== E && 0 >= E && (I.isNull = !0);
            I.plotX = t = f(Math.min(Math.max(-1E5, e.translate(B, 0, 0, 0, 1, p, "flags" === this.type)), 1E5));
            c && this.visible && !I.isNull && H && H[B] && (u = this.getStackIndicator(u, B, this.index), K = H[B], E = K.points[u.key], C = E[0], E = E[1], C === D && u.key === H[B].base && (C = r(q, k.min)), k.positiveValuesOnly && 0 >= C && (C = null), I.total = I.stackTotal = K.total, I.percentage = K.total && I.y / K.total * 100, I.stackY = E, K.setOffset(this.pointXOffset || 0, this.barW || 0));
        ...
        setClip: function(a) {
          var b = this.chart,
              ...
              f = b[k],
              m = b[k + "m"];
          f || (a && (h.width = 0, d && (h.x = b.plotSizeX), b[k + "m"] = m = e.clipRect(d ? b.plotSizeX + 99 : -99, d ? -b.plotLeft : -b.plotTop, 99, d ? b.chartWidth : b.chartHeight)), b[k] = f = e.clipRect(h), f.count = {length: 0});
        ...
        drawPoints: function() {
          ...
          if (!1 !== h.enabled || this._hasPointMarkers)
            for (c = 0; c < a.length; c++)
              e = a[c], g = e.graphic, k = e.marker || {}, f = !!e.marker, d = n && void 0 === k.enabled || k.enabled, m = e.isInside, d && !e.isNull ? (d = r(k.symbol, this.symbol), p = this.markerAttribs(e, e.selected && "select"), g ? g[m ? "show" : "hide"](!0).animate(p) : m && (0 < p.width || e.hasImage) && (e.graphic = g = b.renderer.symbol(d, p.x, p.y, p.width, p.height, f ? k : h).add(l)), g && g.attr(this.pointAttribs(e, e.selected && "select")), g && g.addClass(e.getClassName(), !0)) : g && (e.graphic = g.destroy());
        },
        ...
        applyZones: function() {
          var a = this,
              ...
              u,
              M = !1;
          e.length && (f || m) && p && void 0 !== p.min && (z = p.reversed, D = p.horiz, f && f.hide(), m && m.hide(), n = p.getExtremes(), v(e, function(e, x) {
        ...
        buildKDTree: function() {
          function a(c, e, d) {
            var g,
                h;
            if (h = c && c.length)
              return g = b.kdAxisArray[e % d], c.sort(function(a, b) {
                return a[g] - b[g];
              }), h = Math.floor(h / 2), {
                point: c[h],
    ...
    (function(a) {
      ...
      a.StackItem.prototype = {
        ...
        setOffset: function(a, b) {
          ...
          if (b = this.label)
            b.align(this.alignOptions, null, h), h = b.alignAttr, b[!1 === this.options.crop || d.isInsidePlot(h.x, h.y) ? "show" : "hide"](!0);
        },
      ...
      H.prototype.getStacks = function() {
        ...
        l(a.series, function(b) {
          !b.options.stacking || !0 !== b.visible && !1 !== a.options.chart.ignoreHiddenSeries || (b.stackKey = b.type + v(b.options.stack, ""));
        });
      };
      ...
      u.prototype.modifyStacks = function() {
        ...
        a[k + "Stacker"] && l([b, "-" + b], function(b) {
          for (var c = d.length,
              e,
              l; c--; )
            if (e = d[c], h = a.getStackIndicator(h, e, a.index, b), l = (e = f[b] && f[b][e]) && e.points[h.key])
              a[k + "Stacker"](l, e, c);
        });
      };
      ...
      l("area", "line", {
          ...
          if (this.options.stacking) {
            ...
            H(t, function(a, h) {
              var f = 0,
                  ...
                  z;
              if (m[a] && !m[a].isNull)
                l.push(m[a]), H([-1, 1], function(c) {
                  var f = 1 === c ? "rightNull" : "leftNull",
                      l = 0,
                      q = b[t[h + c]];
                  if (q)
                    for (r = d; 0 <= r && r < k; )
                      n = q.points[r], n || (r === d ? m[a][f] = !0 : e[r] && (z = b[a].points[r]) && (l -= z[1] - z[0])), r += p;
        ...
        getGraphPath: function(a) {
          ...
          for (b = 0; b < a.length; b++)
            if (m = a[b].isNull, e = q(a[b].rectPlotX, a[b].plotX), z = q(a[b].yBottom, I), !m || t)
              t || M(b, b - 1, "left"), m && !u && t || (h.push(a[b]), d.push({
                x: b,
                plotX: e,
                plotY: z
              })), t || M(b, b + 1, "right");
        ...
        drawGraph: function() {
          ...
          H(u, function(c) {
            var b = c[0],
                f = a[b];
            f ? (f.endX = a.preventGraphAnimation ? null : l.xMap, f.animate({d: l})) : (f = a[b] = a.chart.renderer.path(l).addClass(c[1]).attr({
    ...
    (function(a) {
      var B = a.pick;
      a = a.seriesType;
      a("spline", "line", {}, {getPointSpline: function(a, E, q) {
          var f = E.plotX,
              l = E.plotY,
              t = a[q - 1];
          q = a[q + 1];
          var n,
              ...
              u,
              c;
          if (t && !t.isNull && !1 !== t.doCurve && !E.isCliff && q && !q.isNull && !1 !== q.doCurve && !E.isCliff) {
            a = t.plotY;
            u = q.plotX;
            q = q.plotY;
            var b = 0;
      ...
      v("column", "line", {
        ...
        getColumnMetrics: function() {
          ...
          var n = Math.min(Math.abs(f.transA) * (f.ordinalSlope || b.pointRange || f.closestPointRange || f.tickInterval || 1), f.len),
              q = n * b.groupPadding,
              z = (n - 2 * q) / (l || 1),
              b = Math.min(b.maxPointWidth || f.len, t(b.pointWidth, z * (1 - 2 * b.pointPadding)));
          a.columnMetrics = {
            width: b,
        ...
        translate: function() {
          ...
          E(a.points, function(c) {
            var d = t(c.yBottom, e),
                ...
                r,
                g = Math.max(f, d) - n;
            l && Math.abs(g) < l && (g = l, r = !h.reversed && !c.negative || h.reversed && c.negative, c.y === k && a.dataMax <= k && h.min < k && (r = !r), n = Math.abs(n - e) > l ? d - l : e - (r ? l : 0));
            c.barX = p;
            c.pointWidth = q;
          ...
          E(a.points, function(c) {
            ...
            if (f(c.plotY) && null !== c.y) {
              ...
              if (e)
                ...
                c.graphic = e = d[c.shapeType](k).add(c.group || a.group);
        ...
        animate: function(a) {
          var b = this,
              ...
              l;
          u && (a ? (f.scaleY = .001, a = Math.min(c.pos + c.len, Math.max(c.pos, c.toPixels(d.threshold))), h ? f.translateX = a - c.len : f.translateY = a, b.group.attr(f)) : (l = b.group.attr(e), b.group.animate({scaleY: 1}, q(B(b.options.animation), {step: function(a, d) {
              f[e] = l + d.pos * (c.pos - l);
              b.group.attr(f);
            }})), b.animate = null));
        },
      ...
      a.CenteredSeriesMixin = {
        getCenter: function() {
          var a = this.options,
              ...
              b;
          for (c = 0; 4 > c; ++c)
            b = v[c], a = 2 > c || 2 === c && /%$/.test(b), v[c] = q(b, [n, l, u, v[2]][c]) + (a ? t : 0);
          v[3] > v[2] && (v[3] = v[2]);
          return v;
        },
    ...
    (function(a) {
      ...
      b("pie", "line", {
        ...
        updateTotals: function() {
          ...
          this.total = b;
          for (a = 0; a < e; a++)
            f = c[a], f.percentage = 0 < b && (f.visible || !l) ? f.y / b * 100 : 0, f.total = b;
        },
        generatePoints: function() {
    ...
    (function(a) {
      ...
      a.distribute = function(a, b) {
        ...
        for (a = t(a, function(a) {
          ...
          for (f = a.length; f--; )
            h = a[f], m = (Math.min.apply(0, h.targets) + Math.max.apply(0, h.targets)) / 2, h.pos = Math.min(Math.max(0, m - h.size * h.align), b - h.size);
          f = a.length;
          for (h = !1; f--; )
            0 < f && a[f - 1].pos + a[f - 1].size > a[f].pos && (a[f - 1].size += a[f].size, a[f - 1].targets = a[f - 1].targets.concat(a[f].targets), a[f - 1].align = .5, a[f - 1].pos + a[f - 1].size > b && (a[f - 1].pos = b - a[f - 1].size), a.splice(f, 1), h = !0);
        }
        f = 0;
        q(a, function(a) {
          var b = 0;
      ...
      b.prototype.drawDataLabels = function() {
        ...
        if (f.enabled || c._hasPointLabels)
          c.dlProcessOptions && c.dlProcessOptions(f), x = c.plotGroup("dataLabelsGroup", "data-labels", F && !v ? "hidden" : "visible", f.zIndex || 6), F && (x.attr({opacity: +v}), v || B(c, "afterAnimate", function() {
            c.visible && x.show(!0);
            x[d.animation ? "animate" : "attr"]({opacity: 1}, {duration: 200});
          })), t = f, q(m, function(h) {
            var k,
                g = h.dataLabel,
                m,
            ...
            k && (f = n(t, z), m = h.getLabelConfig(), v = f[h.formatPrefix + "Format"] || f.format, C = E(v) ? l(v, m, e.time) : (f[h.formatPrefix + "Formatter"] || f.formatter).call(m, f), v = f.style, m = f.rotation, v.color = u(f.color, v.color, c.color, "#000000"), "contrast" === v.color && (h.contrastColor = A.getContrast(h.color || c.color), v.color = f.inside || 0 > u(h.labelDistance, f.distance) || d.stacking ? h.contrastColor : "#000000"), d.cursor && (v.cursor = d.cursor), p = {
      ...
      b.prototype.alignDataLabel = function(a, b, c, d, l) {
        var e = this.chart,
            ...
            q = c.rotation,
            r = c.align,
            t = this.visible && (a.series.forceDL || e.isInsidePlot(k, Math.round(m), h) || d && e.isInsidePlot(k, h ? d.x + 1 : d.y + d.height - 1, h)),
      ...
      m.pie && (m.pie.prototype.drawDataLabels = function() {
        ...
        c.visible && (l.enabled || c._hasPointLabels) && (q(d, function(a) {
          ...
          var h,
              ...
              r;
          if (n)
            for (c.sortByAngle(b, d - .5), 0 < c.maxLabelDistance && (h = Math.max(0, A - F - c.maxLabelDistance), k = Math.min(A + F + c.maxLabelDistance, f.plotHeight), q(b, function(a) {
            ...
            }), a.distribute(p, k + r - h)), K = 0; K < n; K++)
              e = b[K], k = e.positionsIndex, g = e.labelPos, B = e.dataLabel, O = !1 === e.visible ? "hidden" : "inherit", N = h = g[1], p && E(p[k]) && (void 0 === p[k].pos ? O = "hidden" : (w = p[k].size, N = e.top + p[k].pos)), delete e.positionIndex, P = l.justify ? x[0] + (d ? -1 : 1) * (F + e.labelDistance) : c.getX(N < e.top + 2 || N > e.bottom - 2 ? h : N, d, e), B._attr = {
                visibility: O,
                align: g[6]
              }, B._pos = {
                x: P + l.x + ({
                ...
                y: N + l.y - 10
              }, g.x = P, g.y = N, u(l.crop, !0) && (G = B.getBBox().width, h = null, P - G < m ? (h = Math.round(G - P + m), y[3] = Math.max(h, y[3])) : P + G > t - m && (h = Math.round(P + G - t + m), y[1] = Math.max(h, y[1])), 0 > N - w / 2 ? y[0] = Math.max(Math.round(-N + w / 2), y[0]) : N + w / 2 > v && (y[2] = Math.max(Math.round(N + w / 2 - v), y[2])), B.sideOverflow = h);
          ...
          if ((B = a.dataLabel) && B._pos && a.visible && 0 < a.labelDistance) {
            ...
            if (b = !C)
              a.connector = C = f.renderer.path().addClass("highcharts-data-label-connector  highcharts-color-" + a.colorIndex).add(c.dataLabelsGroup), C.attr({
                "stroke-width": n,
        ...
        var b = this.center,
            ...
            h,
            l = null !== e.size;
        l || (null !== d[0] ? h = Math.max(b[2] - Math.max(a[1], a[3]), f) : (h = Math.max(b[2] - a[1] - a[3], f), b[0] += (a[3] - a[1]) / 2), null !== d[1] ? h = Math.max(Math.min(h, b[2] - Math.max(a[0], a[2])), f) : (h = Math.max(Math.min(h, b[2] - a[0] - a[2]), f), b[1] += (a[0] - a[2]) / 2), h < b[2] ? (b[2] = h, b[3] = Math.min(c(e.innerSize || 0, h), h), this.translate(b), this.drawDataLabels && this.drawDataLabels()) : l = !0);
        return l;
      });
      ...
      B.prototype.hideOverlappingLabels = function(a) {
        ...
        for (n = 0; n < f; n++)
          for (v = a[n], q = n + 1; q < f; ++q)
            if (u = a[q], v && u && v !== u && v.placed && u.placed && 0 !== v.newOpacity && 0 !== u.newOpacity && (c = v.alignAttr, b = u.alignAttr, m = v.parentGroup, d = u.parentGroup, h = 2 * (v.box ? 0 : v.padding || 0), c = k(c.x + m.translateX, c.y + m.translateY, v.width - h, v.height - h, b.x + d.translateX, b.y + d.translateY, u.width - h, u.height - h)))
      ...
      n(k.prototype, {
        ...
        setState: function(a, b) {
          var c = Math.floor(this.plotX),
              ...
              B = k && e.markerAttribs;
          a = a || "";
          if (!(a === this.state && !b || this.selected && "select" !== a || !1 === f.enabled || a && (g || m && !1 === p.enabled) || a && r.states && r.states[a] && !1 === r.states[a].enabled)) {
            B && (z = e.markerAttribs(this, a));
            if (this.graphic)
              this.state && this.graphic.removeClass("highcharts-point-" + this.state), a && this.graphic.addClass("highcharts-point-" + a), this.graphic.animate(e.pointAttribs(this, a), h(t.options.chart.animation, f.animation)), z && this.graphic.animate(z, h(t.options.chart.animation, p.animation, k.animation)), q && q.hide();
            else {
              if (a && p) {
                k = r.symbol || e.symbol;
                ...
                if (q)
                  ...
                  k && (e.stateMarkerGraphic = q = t.renderer.symbol(k, z.x, z.y, z.width, z.height).add(e.markerGroup), q.currentSymbol = k);
      ...
      n(e.prototype, {
        ...
        setState: function(a) {
          ...
          if (b.state !== a && (t([b.group, b.markerGroup, b.dataLabelsGroup], function(c) {
            ...
            for (f = {"stroke-width": f}, d.animate(f, h(e[a || "normal"] && e[a || "normal"].animation, b.chart.options.chart.animation)); b["zone-graph-" + c]; )
      ...
      B.prototype.setResponsive = function(f) {
        ...
        var b = a.merge.apply(0, a.map(n, function(b) {
          return a.find(l.rules, function(a) {
            ...
            n = n.toString() || void 0;
        n !== (c && c.ruleIds) && (c && this.update(c.undoOptions, f), n ? (this.currentResponsive = {
          ruleIds: n,
          mergedOptions: b,
        ...
        function n(c, b, l, d) {
          ...
          a.objectEach(c, function(a, c) {
            if (!d && -1 < E(c, ["series", "xAxis", "yAxis"]))
              ...
              f(a) ? (l[c] = q(a) ? [] : {}, n(a, b[c] || {}, l[c], d + 1)) : l[c] = b[c] || null;
          });
        }
        var u = {};
