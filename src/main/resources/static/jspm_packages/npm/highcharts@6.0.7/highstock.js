  ...
  (function(T, L) {
    ...
    var L = function() {
      var a = "undefined" === typeof T ? window : T,
          ...
          r = /(edge|msie|trident)/i.test(E) && !a.opera,
          m = -1 !== E.indexOf("Firefox"),
          l = -1 !== E.indexOf("Chrome"),
          w = m && 4 > parseInt(E.split("Firefox/")[1], 10);
    ...
    (function(a) {
      ...
      a.Fx.prototype = {
        dSetter: function() {
          ...
          if (1 === w)
            l = this.toD;
          else if (p === m.length && 1 > w)
            for (; p--; )
              v = parseFloat(a[p]), l[p] = isNaN(v) ? m[p] : w * parseFloat(m[p] - v) + v;
          else
            l = m;
        ...
        update: function() {
          ...
          if (this[m + "Setter"])
            ...
            a.attr ? a.element && a.attr(m, l, null, !0) : a.style[m] = l + this.unit;
          w && w.call(a, l, this);
        },
        run: function(r, m, l) {
          var w = this,
          ...
          r === m ? (delete p.curAnim[this.prop], p.complete && 0 === a.keys(p.curAnim).length && p.complete.call(this.elem)) : (this.startTime = +new Date, this.start = r, this.end = m, this.unit = l, this.now = this.start, this.pos = 0, v.elem = this.elem, v.prop = this.prop, v() && 1 === a.timers.push(v) && B(e));
        },
        step: function(r) {
          var m = +new Date,
              l,
          ...
          p.attr && !p.element ? r = !1 : r || m >= B + this.startTime ? (this.now = this.end, this.pos = 1, this.update(), l = e[this.prop] = !0, a.objectEach(e, function(a) {
            !0 !== a && (l = !1);
          }), l && v && v.call(p), r = !1) : (this.pos = w.easing((m - this.startTime) / B), this.now = this.start + (this.end - this.start) * this.pos, this.update(), r = !0);
          return r;
        },
        initPath: function(r, m, l) {
          function w(a) {
            var g,
                b;
            for (t = a.length; t--; )
              g = "M" === a[t] || "L" === a[t], b = /[a-zA-Z]/.test(a[t + 3]), g && b && a.splice(t + 1, 0, a[t + 1], a[t + 2], a[t + 1], a[t + 2]);
          }
          function p(a, c) {
            for (; a.length < g; ) {
              a[0] = c[g - a.length];
          ...
          function v(a, c) {
            for (var e = (g - a.length) / b; 0 < e && e--; )
              n = a.slice().splice(a.length / u - b, b * u), n[0] = c[g - b - e * b], k && (n[b - 6] = n[b - 2], n[b - 5] = n[b - 1]), [].splice.apply(a, [a.length / u, 0].concat(n)), f && e--;
          }
          m = m || "";
          var B,
              e = r.startX,
          ...
          m.length && a.isNumber(B) && (g = l.length + B * u * b, D ? (p(m, l), v(l, m)) : (p(l, m), v(m, l)));
          return [m, l];
        }
      };
      ...
      a.getStyle = function(r, m, l) {
        ...
        if (r = F.getComputedStyle(r, void 0))
          r = r.getPropertyValue(m), a.pick(l, "opacity" !== m) && (r = a.pInt(r));
        return r;
      };
      ...
      a.reduce = function(r, m, l) {
        return (a.reducePolyfill || Array.prototype.reduce).call(r, m, l);
      };
      a.offset = function(a) {
      ...
      a.stop = function(r, m) {
        for (var l = a.timers.length; l--; )
          a.timers[l].elem !== r || m && m !== a.timers[l].prop || (a.timers[l].stopped = !0);
      };
      a.each = function(r, m, l) {
        return (a.forEachPolyfill || Array.prototype.forEach).call(r, m, l);
      };
      a.objectEach = function(a, m, l) {
        for (var w in a)
          a.hasOwnProperty(w) && m.call(l, a[w], w, a);
      };
      ...
      a.addEvent = function(r, m, l) {
        var w,
            p = r.addEventListener || a.addEventListenerPolyfill;
      ...
      a.fireEvent = function(r, m, l, w) {
        var p,
            ...
            c;
        l = l || {};
        E.createEvent && (r.dispatchEvent || r.fireEvent) ? (p = E.createEvent("Events"), p.initEvent(m, !0, !0), a.extend(p, l), r.dispatchEvent ? r.dispatchEvent(p) : r.fireEvent(m, p)) : a.each(["protoEvents", "hcEvents"], function(k) {
          if (r[k])
            for (v = r[k][m] || [], B = v.length, l.target || a.extend(l, {
              ...
              (c = v[e]) && !1 === c.call(r, l) && l.preventDefault();
        });
      ...
      a.seriesType = function(r, m, l, w, p) {
        ...
        B[r] = a.extendClass(B[m] || function() {}, w);
      ...
      a.Color.prototype = {
        ...
        init: function(l) {
          ...
          if ((this.input = l = this.names[l && l.toLowerCase ? l.toLowerCase() : ""] || l) && l.stops)
            this.stops = F(l.stops, function(e) {
              return new a.Color(e[1]);
            });
          else if (l && l.charAt && "#" === l.charAt() && (m = l.length, l = parseInt(l.substr(1), 16), 7 === m ? p = [(l & 16711680) >> 16, (l & 65280) >> 8, l & 255, 1] : 4 === m && (p = [(l & 3840) >> 4 | (l & 3840) >> 8, (l & 240) >> 4 | l & 240, (l & 15) << 4 | l & 15, 1])), !p)
            for (v = this.parsers.length; v-- && !p; )
              B = this.parsers[v], (m = B.regex.exec(l)) && (p = B.parse(m));
          this.rgba = p || [];
        },
        get: function(a) {
          var l = this.input,
              p = this.rgba,
              v;
          this.stops ? (v = r(l), v.stops = [].concat(v.stops), C(this.stops, function(p, e) {
        ...
        brighten: function(a) {
          var l,
              p = this.rgba;
          if (this.stops)
            C(this.stops, function(p) {
              p.brighten(a);
            });
          else if (E(a) && 0 !== a)
            for (l = 0; 3 > l; l++)
              p[l] += m(255 * a), 0 > p[l] && (p[l] = 0), 255 < p[l] && (p[l] = 255);
          return this;
        },
    ...
    (function(a) {
      ...
      g(C.prototype, {
        ...
        colorGradient: function(h, d, x) {
          ...
          f && (c = h[f], n = K.gradients, t = h.stops, y = x.radialReference, D(c) && (h[f] = c = {
          ...
          }), "radialGradient" === f && y && !B(c.gradientUnits) && (e = c, c = J(c, K.getRadialAttr(y, e), {gradientUnits: "userSpaceOnUse"})), z(c, function(a, h) {
            "id" !== h && G.push(h, a);
          }), z(t, function(a) {
            G.push(a);
            ...
            h = K.createElement("stop").attr({
              offset: h[0],
              "stop-color": u,
              "stop-opacity": A
            }).add(q);
            q.stops.push(h);
          })), k = "url(" + K.url + "#" + y + ")", x.setAttribute(d, k), x.gradient = G, h.toString = function() {
            return k;
          });
        },
        applyTextOutline: function(h) {
          ...
          if ((g = h[0]) && "none" !== g && a.svg) {
            ...
            for (c = h.length; c--; )
              d = h[c], "highcharts-text-outline" === d.getAttribute("class") && n(h, K.removeChild(d));
            f = K.firstChild;
            b(h, function(a, h) {
        ...
        attr: function(a, h, d, x) {
          ...
          "string" === typeof a ? f = (this[a + "Getter"] || this._defaultGetter).call(this, a, g) : (z(a, function(h, d) {
            c = !1;
            x || N(this, d);
        ...
        updateShadows: function(a, h, d) {
          for (var K = this.shadows,
              x = K.length; x--; )
            d.call(K[x], "height" === a ? Math.max(h - (K[x].cutHeight || 0), 0) : "d" === a ? this.d : h, a, K[x]);
        },
        ...
        on: function(a, h) {
          ...
          f && "click" === a ? (x.ontouchstart = function(a) {
            ...
            (-1 === Q.navigator.userAgent.indexOf("Android") || 1100 < Date.now() - (d.touchEventFired || 0)) && h.call(x, a);
          }) : x["on" + a] = h;
          return this;
        },
        ...
        align: function(a, h, d) {
          ...
          var c,
              e;
          if (a) {
            if (this.alignOptions = a, this.alignByTranslate = h, !d || H(d))
              this.alignTo = x = d || "renderer", n(b, this), b.push(this), d = null;
          } else
            a = this.alignOptions, h = this.alignByTranslate, x = this.alignTo;
          d = G(d, g[x], g);
          x = a.align;
          g = a.verticalAlign;
          b = (d.x || 0) + (a.x || 0);
        ...
        destroy: function() {
          ...
          g && x && (b(x.querySelectorAll("[clip-path],[CLIP-PATH]"), function(a) {
            var h = a.getAttribute("clip-path"),
                d = g.element.id;
            (-1 < h.indexOf("(#" + d + ")") || -1 < h.indexOf('("#' + d + '")')) && a.removeAttribute("clip-path");
          ...
          a.safeRemoveChild(h);
          for (a.destroyShadows(); d && d.div && 0 === d.div.childNodes.length; )
            h = d.parentGroup, a.safeRemoveChild(d.div), delete d.div, d = h;
        ...
        shadow: function(a, h, d) {
          ...
          if (!a)
            ...
            for (g = 1; g <= e; g++)
              b = f.cloneNode(0), c = 2 * e + 1 - 2 * g, m(b, {
                isShadow: "true",
        ...
        zIndexSetter: function(a, d) {
          ...
          if (f) {
            ...
            d = b.childNodes;
            for (z = d.length - 1; 0 <= z && !e; z--)
              if (g = d[z], f = g.zIndex, n = !B(f), g !== c)
                if (0 > a && n && !x && !z)
                  b.insertBefore(c, d[z]), e = !0;
                else if (h(f) <= a || n && (!B(a) || 0 <= a))
                  b.insertBefore(c, d[z + 1] || null), e = !0;
      ...
      g(E.prototype, {
        ...
        applyEllipsis: function(a, h, d, x) {
          ...
          if (z = b > x) {
            for (; c <= e; )
              f = Math.ceil((c + e) / 2), b = d.substring(0, f) + "\u2026", n(b), b = this.getSpanWidth(a, h), c === e ? c = e + 1 : b > x ? e = f - 1 : c = f;
            0 === e && n("");
          }
          a.rotation = g;
          return z;
        ...
        buildText: function(a) {
          var d = a.element,
              ...
              J = D && D.lineHeight,
              N = D && D.textOutline,
              H = D && "ellipsis" === D.textOverflow,
              M = D && "nowrap" === D.whiteSpace,
              l = D && D.fontSize,
              v,
              B,
              Q = e.length,
              D = K && !a.added && this.box,
              w = function(a) {
                var g;
          ...
          if (v !== a.textCache) {
            for (a.textCache = v; Q--; )
              d.removeChild(e[Q]);
            c || N || H || K || -1 !== f.indexOf(" ") ? (n = /<.*class="([^"]+)".*>/, q = /<.*style="([^"]+)".*>/, A = /<.*href="([^"]+)".*>/, D && D.appendChild(d), f = c ? f.replace(/<(b|strong)>/g, '\x3cspan style\x3d"font-weight:bold"\x3e').replace(/<(i|em)>/g, '\x3cspan style\x3d"font-style:italic"\x3e').replace(/<a/g, "\x3cspan").replace(/<\/(b|strong|i|em|a)>/g, "\x3c/span\x3e").split(/<br.*?>/g) : [f], f = t(f, function(a) {
              return "" !== a;
            }), b(f, function(h, f) {
              var c,
                  e = 0;
              ...
              b(c, function(h) {
                if ("" !== h || 1 === c.length) {
                  var b = {},
                      z = k.createElementNS(x.SVG_NS, "tspan"),
                      t,
                      u;
                  n.test(h) && (t = h.match(n)[1], m(z, "class", t));
                  q.test(h) && (u = h.match(q)[1].replace(/(;| |^)color([ :])/, "$1fill$2"), m(z, "style", u));
                  A.test(h) && !g && (m(z, "onclick", 'location.href\x3d"' + h.match(A)[1] + '"'), m(z, "class", "highcharts-anchor"), p(z, {cursor: "pointer"}));
                  ...
                  if (" " !== h) {
                    ...
                    if (K) {
                      ...
                      var G = [],
                          ...
                          J = w(z),
                          N = a.rotation;
                      for (H && (y = x.applyEllipsis(a, z, h, K)); !H && t && (b.length || G.length); )
                        a.rotation = 0, D = x.getSpanWidth(a, z), h = D > K, void 0 === y && (y = h), h && 1 !== b.length ? (z.removeChild(z.firstChild), G.unshift(b.pop())) : (b = G, G = [], b.length && !M && (z = k.createElementNS(P, "tspan"), m(z, {
                          dy: J,
                          x: I
        ...
        button: function(a, h, d, x, b, f, c, e, z) {
          var n = this.label(a, h, d, z, null, null, null, null, "button"),
              q = 0;
          n.attr(J({
            padding: 8,
            r: 2
        ...
        symbol: function(a, h, d, x, f, c) {
          var e = this,
              ...
              n = /^url\((.*?)\)$/,
              q = n.test(a),
              t = !q && (this.symbols[a] ? a : "circle"),
              A = t && this.symbols[t],
              u = B(h) && A && A.call(this.symbols, Math.round(h), Math.round(d), x, f, c),
              y,
              I;
          A ? (z = this.path(u), z.attr("fill", "none"), g(z, {
            ...
            x: h,
            y: d
          }), z.isImg = !0, B(z.imgwidth) && B(z.imgheight) ? I() : (z.attr({
            width: 0,
            height: 0
          }), v("img", {
            onload: function() {
        ...
        symbols: {
          circle: function(a, h, d, x) {
            return this.arc(a + d / 2, h + x / 2, d / 2, x / 2, {
              start: 0,
              end: 2 * Math.PI,
              open: !1
            });
          ...
          callout: function(a, h, d, x, b) {
            var f = Math.min(b && b.r || 0, d, x),
                g = f + 6,
                c = b && b.anchorX;
            b = b && b.anchorY;
            var e;
            e = ["M", a + f, h, "L", a + d - f, h, "C", a + d, h, a + d, h, a + d, h + f, "L", a + d, h + x - f, "C", a + d, h + x, a + d, h + x, a + d - f, h + x, "L", a + f, h + x, "C", a, h + x, a, h + x, a, h + x - f, "L", a, h + f, "C", a, h, a, h, a + f, h];
        ...
        text: function(a, h, d, x) {
          ...
          x || (a.xSetter = function(a, h, d) {
            var x = d.getElementsByTagName("tspan"),
                b,
                f = d.getAttribute(h),
                g;
            for (g = 0; g < x.length; g++)
              b = x[g], b.getAttribute(h) === f && b.setAttribute(h, a);
            d.setAttribute(h, a);
          });
          return a;
        },
        ...
        label: function(h, d, f, c, e, z, n, q, t) {
          var A = this,
              u = A.g("button" !== t && "label"),
              y = u.text = A.text("", 0, 0, n).attr({zIndex: 1}),
              G,
              I,
              k = 0,
              P = 3,
          ...
          r = function() {
            ...
            Q && (G || (u.box = G = A.symbols[c] || K ? A.symbol(c) : A.rect(), G.addClass(("button" === t ? "" : "highcharts-label-box") + (t ? " highcharts-" + t + "-box" : "")), G.add(u), a = w(), h.x = a, h.y = (q ? -m : 0) + a), h.width = Math.round(u.width), h.height = Math.round(u.height), G.attr(g(h, l)), l = {});
          };
          Y = function() {
            var a = O + P,
                h;
            h = q ? 0 : m;
            B(D) && I && ("center" === p || "right" === p) && (a += {
              center: .5,
              right: 1
            }[p] * (D - I.width));
            if (a !== y.x || h !== y.y)
      ...
      l(a.SVGElement.prototype, {
        ...
        htmlUpdateTransform: function() {
          if (this.added) {
            ...
            if ("SPAN" === b.tagName) {
              var y = this.rotation,
                  I = this.textWidth && e(this.textWidth),
                  J = [y, q, b.innerHTML, this.textWidth, this.textAlign].join(),
                  d;
              (d = I !== this.oldTextWidth) && !(d = I > this.oldTextWidth) && ((d = this.textPxLength) || (F(b, {
                width: "",
                whiteSpace: H || "nowrap"
              }), d = b.offsetWidth), d = d > I);
              d && /[ \-]/.test(b.textContent || b.innerText) && (F(b, {
                width: I + "px",
                display: "block",
                whiteSpace: H || "normal"
              }), this.oldTextWidth = I);
      ...
      a.Time.prototype = {
        ...
        update: function(p) {
          ...
          (this.variableTimezone = !(l && !p.getTimezoneOffset && !p.timezone)) || this.timezoneOffset ? (this.get = function(a, c) {
            ...
            if (-1 !== a.inArray(e, ["Milliseconds", "Seconds", "Minutes"]))
              ...
              b = B.getTimezoneOffset(c), b = c.getTime() - b, c.setTime(b), c["setUTC" + e](k), e = B.getTimezoneOffset(c), b = c.getTime() + e, c.setTime(b);
        ...
        makeTime: function(p, l, B, e, c, k) {
          var b,
              g,
              n;
          this.useUTC ? (b = this.Date.UTC.apply(0, arguments), g = this.getTimezoneOffset(b), b += g, n = this.getTimezoneOffset(b), g !== n ? b += n - g : g - 36E5 !== this.getTimezoneOffset(b - 36E5) || a.isSafari || (b -= 36E5)) : b = (new this.Date(p, l, m(B, 1), m(e, 0), m(c, 0), m(k, 0))).getTime();
          return b;
        },
        ...
        dateFormat: function(p, l, m) {
          ...
          a.objectEach(c, function(a, b) {
            for (; -1 !== p.indexOf("%" + b); )
              p = p.replace("%" + b, "function" === typeof a ? a.call(e, l) : a);
          });
        ...
        getTimeTicks: function(a, v, B, e) {
          ...
          if (C(v)) {
            ...
            t >= l.second && c.set("Seconds", n, t >= l.minute ? 0 : f * Math.floor(c.get("Seconds", n) / f));
            ...
            n = n.getTime();
            for (v = 1; n < B; )
              k.push(n), n = t === l.year ? c.makeTime(g + v * f, 0) : t === l.month ? c.makeTime(g, e + v * f) : !u || t !== l.day && t !== l.week ? u && t === l.hour && 1 < f ? c.makeTime(g, e, D, q + v * f) : n + t * f : c.makeTime(g, e, D + v * f * (t === l.day ? 1 : 7)), v++;
            k.push(n);
      ...
      a.Tick.prototype = {
        addLabel: function() {
          ...
          if (E(e))
            ...
            if (this.label = e = E(v) && b.enabled ? B.renderer.text(v, 0, 0, b.useHTML).css(m(b.style)).add(a.labelGroup) : null)
        ...
        handleOverflow: function(a) {
          var p = this.axis,
              m = p.options.labels,
              e = a.x,
              c = p.chart.chartWidth,
              k = p.chart.spacing,
              b = l(p.labelLeft, Math.min(p.pos, k[3])),
              k = l(p.labelRight, Math.max(p.isRadial ? 0 : p.pos + p.len, c - k[1])),
              g = this.label,
              n = this.rotation,
              t = {
                left: 0,
              ...
              y = {};
          if (n || !1 === m.overflow)
            0 > n && e - t * f < b ? A = Math.round(e / Math.cos(n * w) - b) : 0 < n && e + t * f > k && (A = Math.round((c - e) / Math.cos(n * w)));
          else if (c = e + (1 - t) * f, e - t * f < b ? D = a.x + D * (1 - t) - b : c > k && (D = k - a.x + D * t, q = -1), D = Math.min(u, D), D < u && "center" === p.labelAlign && (a.x += q * (u - D - t * (u - Math.min(f, D)))), f > D || p.autoRotation && (g.styles || {}).width)
            A = D;
        ...
        getPosition: function(l, m, B, e) {
          var c = this.axis,
              k = c.chart,
              b = e && k.oldChartHeight || k.chartHeight;
          return {
            ...
            y: l ? b - c.bottom + c.offset - (c.opposite ? c.height : 0) : a.correctFloat(b - c.translate(m + B, null, null, e) - c.transB)
          };
        },
        getLabelPosition: function(a, l, m, e, c, k, b, g) {
          var n = this.axis,
              ...
              q = c.y,
              A = e || n.reserveSpaceDefault ? 0 : -n.labelOffset * ("center" === n.labelAlign ? .5 : 1);
        ...
        renderGridLine: function(a, l, m) {
          var e = this.axis,
              ...
              q = c[u + "LineColor"],
              c = c[u + "LineDashStyle"];
          k || (b.stroke = q, b["stroke-width"] = D, c && (b.dashstyle = c), n || (b.zIndex = 1), a && (b.opacity = 0), this.gridLine = k = f.path().attr(b).addClass("highcharts-" + (n ? n + "-" : "") + "grid-line").add(e.gridGroup));
          if (!a && k && (a = e.getPlotLinePath(g + t, k.strokeWidth() * m, a, !0)))
        ...
        renderMark: function(a, m, B) {
          var e = this.axis,
              ...
              u = a.x;
          a = a.y;
          var D = l(c[g + "Width"], !b && e.isXAxis ? 1 : 0),
              c = c[g + "Color"];
          n && (e.opposite && (n[0] = -n[0]), f && (this.mark = t = k.path().addClass("highcharts-" + (b ? b + "-" : "") + "tick").add(e.axisGroup), t.attr({
            stroke: c,
            "stroke-width": D
          })), t[f ? "attr" : "animate"]({
        ...
        renderLabel: function(a, m, B, e) {
          var c = this.axis,
              ...
              u = a.x;
          a = a.y;
          g && r(u) && (g.xy = a = this.getLabelPosition(u, a, g, k, n, c, e, t), this.isFirst && !this.isLast && !l(b.showFirstLabel, 1) || this.isLast && !this.isFirst && !l(b.showLastLabel, 1) ? f = !1 : !k || n.step || n.rotation || m || 0 === B || this.handleOverflow(a), t && e % t && (f = !1), f && r(a.y) ? (a.opacity = B, g[this.isNewLabel ? "attr" : "animate"](a), this.isNewLabel = !1) : (g.attr("y", -9999), this.isNewLabel = !0));
        },
        render: function(m, v, B) {
          var e = this.axis,
              c = e.horiz,
              k = this.getPosition(c, this.pos, e.tickmarkOffset, v),
              b = k.x,
              g = k.y,
    ...
    var da = function(a) {
      ...
      a.extend(G.prototype, {
        ...
        init: function(a, d) {
          ...
          var b = this.options,
              f = b.type;
          x.labelFormatter = b.labels.formatter || x.defaultLabelFormatter;
          x.userOptions = d;
          x.minPixelPadding = 0;
          ...
          x.isLog && (x.val2lin = x.log2lin, x.lin2val = x.lin2log);
        },
        ...
        defaultLabelFormatter: function() {
          ...
          if (u)
            ...
            for (; n-- && void 0 === q; )
              f = Math.pow(e, n + 1), h >= f && 0 === 10 * d % f && null !== z[n] && 0 !== d && (q = a.numberFormat(d / f, -1) + z[n]);
        ...
        getSeriesExtremes: function() {
          ...
          e(a.series, function(h) {
            if (h.visible || !d.options.chart.ignoreHiddenSeries) {
              ...
              if (a.isXAxis)
                x = h.xData, x.length && (h = r(x), f = F(x), u(h) || h instanceof Date || (x = n(x, u), h = r(x), f = F(x)), x.length && (a.dataMin = Math.min(H(a.dataMin, x[0], h), h), a.dataMax = Math.max(H(a.dataMax, x[0], f), f)));
              else if (h.getExtremes(), f = h.dataMax, h = h.dataMin, p(h) && p(f) && (a.dataMin = Math.min(H(a.dataMin, h), h), a.dataMax = Math.max(H(a.dataMax, f), f)), p(b) && (a.threshold = b), !x.softThreshold || a.positiveValuesOnly)
                a.softThreshold = !1;
            }
          });
        },
        ...
        getPlotLinePath: function(a, d, b, f, c) {
          var h = this.chart,
              ...
              e,
              z,
              q = b && h.oldChartHeight || h.chartHeight,
              n = b && h.oldChartWidth || h.chartWidth,
              t;
          e = this.transB;
          var A = function(a, h, d) {
            if (a < h || a > d)
              f ? a = Math.min(Math.max(h, a), d) : t = !0;
            return a;
          };
          ...
          u(c) ? this.horiz ? (e = g, z = q - this.bottom, a = b = A(a, x, x + this.width)) : (a = x, b = n - this.right, e = z = A(e, g, g + this.height)) : (t = !0, f = !1);
          return t && !f ? null : h.renderer.crispLine(["M", a, e, "L", b, z], d || 1);
        },
        getLinearTickPositions: function(a, d, b) {
          var h,
              x = l(Math.floor(d / a) * a);
          b = l(Math.ceil(b / a) * a);
          var f = [],
              c;
          l(x + a) === x && (c = 20);
        ...
        getMinorTickPositions: function() {
          ...
          if (q && q / f < a.len / 3)
            if (a.isLog)
              e(this.paddedTicks, function(h, d, x) {
                d && c.push.apply(c, a.getLogTickPositions(f, x[d - 1], x[d], !0));
              });
            else if (a.isDatetimeAxis && "auto" === this.getMinorTickInterval())
              c = c.concat(a.getTimeTicks(a.normalizeTimeTickInterval(f), z, g, d.startOfWeek));
            else
              for (d = z + (b[0] - z) % f; d <= g && d !== c[0]; d += f)
                c.push(d);
        ...
        adjustForMinRange: function() {
          ...
          this.isXAxis && void 0 === this.minRange && !this.isLog && (p(a.min) || p(a.max) ? this.minRange = null : (e(this.series, function(a) {
            n = a.xData;
            for (z = u = a.xIncrement ? 1 : n.length - 1; 0 < z; z--)
              if (q = n[z] - n[z - 1], void 0 === g || q < g)
                g = q;
          }), this.minRange = Math.min(5 * g, this.dataMax - this.dataMin)));
          b - d < this.minRange && (c = this.dataMax - this.dataMin >= this.minRange, t = this.minRange, f = (t - b + d) / 2, f = [d - f, H(a.min, d - f)], c && (f[2] = this.isLog ? this.log2lin(this.dataMin) : this.dataMin), d = F(f), b = [d + t, H(a.max, d + t)], c && (b[2] = this.isLog ? this.log2lin(this.dataMax) : this.dataMax), b = r(b), b - d < t && (f[0] = b - t, f[1] = H(a.min, b - t), d = F(f)));
          this.min = d;
          this.max = b;
        },
        getClosest: function() {
          ...
          this.categories ? a = 1 : e(this.series, function(h) {
            var d = h.closestPointRange,
                x = h.visible || !h.chart.options.chart.ignoreHiddenSeries;
        ...
        updateNames: function() {
          ...
          0 < d.length && (e(a.keys(d.keys), function(a) {
            ...
            e(a.points, function(d, b) {
              var x;
              d.options && (x = h.nameToX(d), void 0 !== x && x !== d.x && (d.x = x, a.xData[b] = x));
            });
          }));
        },
        setAxisTranslation: function(a) {
          var h = this,
              ...
              t = h.isXAxis;
          if (t || q || b)
            f = h.getClosest(), z ? (c = z.minPointOffset, g = z.pointRangePadding) : e(h.series, function(a) {
              var d = q ? 1 : t ? H(a.options.pointRange, f, 0) : h.axisPointRange || 0;
              a = a.options.pointPlacement;
              b = Math.max(b, d);
              h.single || (c = Math.max(c, D(a) ? 0 : d / 2), g = Math.max(g, "on" === a ? 0 : d));
            }), z = h.ordinalSlope && f ? h.ordinalSlope / f : 1, h.minPointOffset = c *= z, h.pointRangePadding = g *= z, h.pointRange = Math.min(b, d), t && (h.closestPointRange = f);
          a && (h.oldTransA = n);
        ...
        setTickInterval: function(h) {
          ...
          c && (d.positiveValuesOnly && !h && 0 >= Math.min(d.min, H(d.dataMin, d.min)) && a.error(10, 1), d.min = l(z(d.min), 15), d.max = l(z(d.max), 15));
          ...
          u(f.ceiling) && (d.max = Math.min(d.max, f.ceiling));
        ...
        alignToOthers: function() {
          var a = {},
              d,
              b = this.options;
          !1 === this.chart.options.chart.alignTicks || !1 === b.alignTicks || this.isLog || e(this.chart[this.coll], function(h) {
            var b = h.options,
        ...
        adjustTickAmount: function() {
          ...
          if (this.hasData()) {
            if (c < b) {
              for (; d.length < b; )
                d.length % 2 || this.min === g ? d.push(l(d[d.length - 1] + a)) : d.unshift(l(d[0] - a));
              this.transA *= (c - 1) / (b - 1);
              this.min = d[0];
              this.max = d[d.length - 1];
            } else
              c > b && (this.tickInterval *= 2, this.setTickPositions());
            if (p(f)) {
              for (a = b = d.length; a--; )
                (3 === f && 1 === a % 2 || 2 >= f && 0 < a && a < b - 1) && d.splice(a, 1);
        ...
        setScale: function() {
          ...
          e(this.series, function(d) {
            if (d.isDirtyData || d.isDirty || d.xAxis.isDirty)
              a = !0;
          });
        ...
        zoom: function(a, d) {
          var h = this.dataMin,
              b = this.dataMax,
              f = this.options,
              c = Math.min(h, H(f.min, h)),
              f = Math.max(b, H(f.max, b));
          if (a !== this.min || d !== this.max)
            this.allowZoomOutside || (p(h) && (a < c && (a = c), a > f && (a = f)), p(b) && (d < c && (d = c), d > f && (d = f))), this.displayBtn = void 0 !== a || void 0 !== d, this.setExtremes(a, d, !1, void 0, {trigger: "zoom"});
          return !0;
        },
        setAxisSize: function() {
          var d = this.chart,
              ...
              e = this.top = Math.round(a.relativeLength(H(b.top, d.plotTop + f[0]), d.plotHeight, d.plotTop)),
        ...
        tickSize: function(a) {
          ...
          if (b && h)
            return "inside" === d[a + "Position"] && (h = -h), [h, b];
        },
        ...
        unsquish: function() {
          var a = this.options.labels,
              ...
              b = this.tickInterval,
              f = b,
              c = this.len / (((this.categories ? 1 : 0) + this.max - this.min) / b),
              g,
              z = a.rotation,
              q = this.labelMetrics(),
              n,
          ...
          d ? (u = !a.staggerLines && !a.step && (p(z) ? [z] : c < H(a.autoRotationLimit, 80) && a.autoRotation)) && e(u, function(a) {
            var d;
            if (a === z || a && -90 <= a && 90 >= a)
              n = A(Math.abs(q.h / Math.sin(v * a))), d = n + Math.abs(a / 360), d < t && (t = d, g = a, f = n);
          }) : a.step || (f = A(q.h));
          this.autoRotation = u;
        ...
        renderUnsquish: function() {
          var a = this.chart,
              ...
              g = this.horiz,
              z = this.getSlotWidth(),
              q = Math.max(1, Math.round(z - 2 * (c.padding || 5))),
              n = {},
              t = this.labelMetrics(),
              u = c.style && c.style.textOverflow,
              A,
              G,
              y = 0,
              I;
          ...
          if (this.autoRotation)
            y > q && y > t.h ? n.rotation = this.labelRotation : this.labelRotation = 0;
          else if (z && (A = q, !u))
            for (G = "clip", q = b.length; !g && q--; )
              if (I = b[q], I = f[I].label)
                I.styles && "ellipsis" === I.styles.textOverflow ? I.css({textOverflow: "clip"}) : I.textPxLength > z && I.css({width: z + "px"}), I.getBBox().height > this.len / b.length - (t.h - t.f) && (I.specificTextOverflow = "ellipsis");
          ...
          e(b, function(a) {
            ...
            }), delete d.specificTextOverflow, a.rotation = n.rotation);
          });
        ...
        addTitle: function(a) {
          ...
          this.axisTitle || ((c = f.textAlign) || (c = (h ? {
            ...
            middle: "center",
            high: b ? "left" : "right"
          })[f.align]), this.axisTitle = d.text(f.text, 0, 0, f.useHTML).attr({
            zIndex: 7,
        ...
        getOffset: function() {
          var a = this,
              ...
              z = a.horiz,
              q = a.side,
              n = d.inverted && !a.isZAxis ? [1, 0, 3, 2][q] : q,
              t,
              u,
              A = 0,
              G,
          ...
          a.axisGroup || (a.gridGroup = b.g("grid").attr({zIndex: f.gridZIndex || 1}).addClass("highcharts-" + this.coll.toLowerCase() + "-grid " + (v || "")).add(B), a.axisGroup = b.g("axis").attr({zIndex: f.zIndex || 2}).addClass("highcharts-" + this.coll.toLowerCase() + " " + (v || "")).add(B), a.labelGroup = b.g("axis-labels").attr({zIndex: D.zIndex || 7}).addClass("highcharts-" + a.coll.toLowerCase() + "-labels " + (v || "")).add(B));
          ...
          k && k.text && !1 !== k.enabled && (a.addTitle(u), u && !1 !== k.reserveSpace && (a.titleOffset = A = a.axisTitle.getBBox()[z ? "height" : "width"], G = k.offset, I = p(G) ? 0 : H(k.margin, z ? 5 : 10)));
          a.renderLine();
        ...
        getTitlePosition: function() {
          ...
          return {
            x: a ? f + q : d + (z ? this.width : 0) + e + q,
            y: a ? d + n - (z ? this.height : 0) + e : f + n
          };
        },
        renderMinorTick: function(a) {
          var d = this.chart.hasRendered && u(this.oldMin),
              b = this.minorTicks;
        ...
        renderTick: function(a, d) {
          ...
          if (!b || a >= this.min && a <= this.max)
            h[a] || (h[a] = new z(this, a)), f && h[a].isNew && h[a].render(d, !0, .1), h[a].render(d);
        },
        render: function() {
          var b = this,
              f = b.chart,
              ...
              l = b.axisLine,
              m = b.showAxis,
              p = E(f.renderer.globalAnimation),
              v,
              B;
          ...
          if (b.hasData() || n)
            b.minorTickInterval && !b.categories && e(b.getMinorTickPositions(), function(a) {
              ...
              b.renderTick(a, d);
            }), H && (0 === b.min || b.single) && (I[-1] || (I[-1] = new z(b, -1, null, !0)), I[-1].render(-1))), J && e(t, function(d, h) {
        ...
        destroy: function(a) {
          ...
          for (f in d.plotLinesAndBandsGroups)
            d.plotLinesAndBandsGroups[f] = d.plotLinesAndBandsGroups[f].destroy();
          y(d, function(a, b) {
        ...
        drawCrosshair: function(a, d) {
          ...
          this.crosshair && !1 !== (p(d) || !h) ? (h ? p(d) && (c = this.isXAxis ? d.plotX : this.len - d.plotY) : c = a && (this.horiz ? a.chartX - this.pos : this.len - a.chartY + this.pos), p(c) && (b = this.getPlotLinePath(d && (this.isXAxis ? d.x : H(d.stackY, d.y)), null, null, null, c) || null), p(b) ? (d = this.categories && !this.isRadial, g || (this.cross = g = this.chart.renderer.path().addClass("highcharts-crosshair highcharts-crosshair-" + (d ? "category " : "thin ") + f.className).attr({zIndex: H(f.zIndex, 2)}).add(), g.attr({
    ...
    (function(a) {
      ...
      C.prototype.normalizeTimeTickInterval = function(a, l) {
        ...
        var p = r[l[0]],
            v = l[1],
            B;
        for (B = 0; B < m.length && !(l = m[B], p = r[l[0]], v = l[1], m[B + 1] && a <= (p * v[v.length - 1] + r[m[B + 1][0]]) / 2); B++)
          ;
    ...
    (function(a) {
      ...
      C.prototype.getLogTickPositions = function(a, w, p, v) {
        ...
        if (.5 <= a)
          a = Math.round(a), b = this.getLinearTickPositions(a, w, p);
        else if (.08 <= a)
          for (var e = Math.floor(w),
              g,
              n,
              t,
              f,
              u,
              l = .3 < a ? [1, 2, 4] : .15 < a ? [1, 2, 4, 6, 8] : [1, 2, 3, 4, 5, 6, 7, 8, 9]; e < p + 1 && !u; e++)
            for (n = l.length, g = 0; g < n && !u; g++)
              t = k(c(e) * l[g]), t > w && (!v || f <= p) && void 0 !== f && b.push(f), f > p && (u = !0), f = t;
        else
          w = c(w), p = c(p), a = v ? this.getMinorTickInterval() : l.tickInterval, a = m("auto" === a ? null : a, this._minorAutoInterval, l.tickPixelInterval / (v ? 5 : 1) * (p - w) / ((v ? e / this.tickPositions.length : e) || 1)), a = r(a, null, E(a)), b = F(this.getLinearTickPositions(a, w, p), k), v || (this._minorAutoInterval = a / 5);
    ...
    (function(a, C) {
      ...
      a.PlotLineOrBand.prototype = {
        render: function() {
          var l = this,
              ...
              I = v(k.zIndex, 0),
              J = k.events,
              y = {"class": "highcharts-plot-" + (u ? "band " : "line ") + (k.className || "")},
              d = {},
              z = e.chart.renderer,
              G = u ? "bands" : "lines",
              h = e.log2lin;
          ...
          if (D)
            y = e.getPlotLinePath(f, q.strokeWidth());
          else if (u)
            y = e.getPlotBandPath(t, n, k);
          else
            return;
      ...
      a.extend(C.prototype, {
        getPlotBandPath: function(a, e) {
          ...
          if (k && c)
            for (a && (t = k.toString() === c.toString(), n = 0), a = 0; a < k.length; a += 6)
              g && c[a + 1] === k[a + 1] ? (c[a + 1] += n, c[a + 4] += n) : g || c[a + 2] !== k[a + 2] || (c[a + 2] += n, c[a + 5] += n), b.push("M", k[a + 1], k[a + 2], "L", k[a + 4], k[a + 5], c[a + 4], c[a + 5], c[a + 1], c[a + 2], "z"), b.flat = t;
          return b;
        },
        ...
        addPlotBandOrLine: function(l, e) {
          var c = (new a.PlotLineOrBand(this, l)).render(),
              k = this.userOptions;
      ...
      a.Tooltip.prototype = {
        ...
        getPosition: function(a, c, k) {
          var b = this.chart,
              ...
              t = b.inverted && k.h || 0,
              f,
              u = ["y", b.chartHeight, c, k.plotY + b.plotTop, b.plotTop, b.plotTop + b.plotHeight],
              ...
              A = function(a, d, b, f, h, c) {
                ...
                if (q && n)
                  ...
                  e[a] = Math.min(c - b, 0 > u - t ? u : u - t);
                else if (n)
                  e[a] = Math.max(h, f + t + b > d ? f : f + t);
                else
                  return !1;
              },
              y = function(a, d, b, f) {
        ...
        refresh: function(a, c) {
          ...
          var f = this.shared,
              D;
          b.enabled && (clearTimeout(this.hideTimer), this.followPointer = p(n)[0].series.tooltipOptions.followPointer, t = this.getAnchor(n, c), c = t[0], g = t[1], !f || n.series && n.series.noSharedTooltip ? f = n.getLabelConfig() : (C(n, function(a) {
            a.setState("hover");
            u.push(a.getLabelConfig());
          }), f = {
            x: n[0].category,
            y: n[0].y
          }, f.points = u, n = n[0]), this.len = u.length, f = e.call(f, this), D = n.series, this.distance = w(D.tooltipOptions.distance, 16), !1 === f ? this.hide() : (e = this.getLabel(), this.isHidden && e.attr({opacity: 1}).show(), this.split ? this.renderSplit(f, p(a)) : (b.style.width || e.css({width: this.chart.spacingBox.width}), e.attr({text: f && f.join ? f.join("") : f}), e.removeClass(/highcharts-color-[\d]+/g).addClass("highcharts-color-" + w(n.colorIndex, D.colorIndex)), e.attr({stroke: b.borderColor || n.color || D.color || "#666666"}), this.updatePosition({
            plotX: c,
            plotY: g,
            negative: n.negative,
            ttBelow: n.ttBelow,
        ...
        renderSplit: function(e, c) {
          ...
          C(e.slice(0, c.length + 1), function(a, e) {
            if (!1 !== a) {
              ...
              e.isHeader ? (u = a.height, I = Math.max(0, Math.min(e.plotX + g.plotLeft - I / 2, g.chartWidth - I))) : I = e.plotX + g.plotLeft - w(f.distance, 16) - I;
              0 > I && (t = !1);
          ...
          C(b, function(a) {
            ...
            a.tt.attr({
              ...
              x: t || b.isHeader ? a.x : b.plotX + g.plotLeft + w(f.distance, 16),
              y: a.pos + g.plotTop,
        ...
        getDateFormat: function(a, c, k, b) {
          ...
          for (f in B) {
            ...
            if (u[f] && e.substr(u[f]) !== "01-01 00:00:00.000".substr(u[f]))
              break;
            "week" !== f && (D = f);
          }
          f && (t = b[f]);
        ...
        tooltipFooterHeaderFormatter: function(a, c) {
          ...
          var e = a.series,
              ...
              g = b.xDateFormat,
              n = e.xAxis,
              t = n && "datetime" === n.options.type && r(a.key),
              f = b[c + "Format"];
      ...
      a.Pointer.prototype = {
        ...
        findNearestKDPoint: function(a, b, g) {
          ...
          w(a, function(a) {
            ...
            a = a.searchPoint(g, e);
            if ((e = c(a, !0)) && !(e = !c(f, !0)))
              var e = f.distX - a.distX,
                  q = f.dist - a.dist,
                  n = (a.series.group && a.series.group.zIndex) - (f.series.group && f.series.group.zIndex),
                  e = 0 < (0 !== e && b ? e : 0 !== q ? q : 0 !== n ? n : f.series.index > a.series.index ? -1 : 1);
            e && (f = a);
          });
          return f;
        },
        ...
        getHoverData: function(g, f, e, n, q, A, y) {
          ...
          y = f && !f.stickyTracking ? [f] : a.grep(e, function(a) {
            return a.visible && !(!q && a.directTouch) && b(a.options.enableMouseTracking, !0) && a.stickyTracking;
          });
        ...
        runPointActions: function(c, f) {
          ...
          if (t && (t !== g.hoverPoint || e && e.isHidden)) {
            ...
            f && e && !e.isHidden && (t = e.getAnchor([{}], c), e.updatePosition({
              plotX: t[0],
              plotY: t[1]
            }));
          this.unDocMouseMove || (this.unDocMouseMove = C(g.container.ownerDocument, "mousemove", function(b) {
            ...
            if (f)
              f.pointer.onDocumentMouseMove(b);
          }));
          w(g.axes, function(f) {
            var g = b(f.crosshair.snap, !0),
                d = g ? a.find(k, function(a) {
        ...
        reset: function(a, b) {
          ...
          if (a)
            t && k && (t.refresh(k), e && (e.setState(e.state, !0), w(f.axes, function(a) {
        ...
        drag: function(a) {
          ...
          G && G.touch || (g < k ? g = k : g > k + J && (g = k + J), e < I ? e = I : e > I + d && (e = I + d), this.hasDragged = Math.sqrt(Math.pow(h - g, 2) + Math.pow(x - e, 2)), 10 < this.hasDragged && (z = b.isInsidePlot(h - k, x - I), b.hasCartesianSeries && (this.zoomX || this.zoomY) && z && !l && !G && (this.selectionMarker = G = b.renderer.rect(k, I, n ? 1 : J, t ? 1 : d, 0).attr({
        ...
        drop: function(a) {
          ...
          if (this.selectionMarker) {
            var n = {
              ...
              yAxis: []
                ...
                y = t.attr ? t.attr("x") : t.x,
                k = t.attr ? t.attr("y") : t.y,
                I = t.attr ? t.attr("width") : t.width,
                J = t.attr ? t.attr("height") : t.height,
                d;
            if (this.hasDragged || g)
              w(c.axes, function(f) {
                if (f.zoomEnabled && l(f.min) && (g || b[{
                  xAxis: "zoomX",
                  yAxis: "zoomY"
                }[f.coll]])) {
                  var c = f.horiz,
                      h = "touchend" === a.type ? f.minPixelPadding : 0,
                      e = f.toValue((c ? y : k) + h),
                      c = f.toValue((c ? y + I : k + J) - h);
                  n[f.coll].push({
                    axis: f,
                    min: Math.min(e, c),
                    max: Math.max(e, c)
          ...
          c && e(c.index) && (m(c.container, {cursor: c._cursor}), c.cancelClick = 10 < this.hasDragged, c.mouseIsDown = this.hasDragged = this.hasPinched = !1, this.pinchDown = []);
        },
    ...
    (function(a) {
      ...
      F(a.Pointer.prototype, {
        pinchTranslate: function(a, l, m, r, e, c) {
          ...
          this.zoomVert && this.pinchTranslateDirection(!1, a, l, m, r, e, c);
        },
        pinchTranslateDirection: function(a, l, m, r, e, c, k, b) {
          ...
          x ? (z -= .8 * (z - k[n][0]), J || (h -= .8 * (h - k[n][1])), m()) : k[n] = [z, h];
          H || (c[n] = A - D, c[u] = q);
          c = H ? 1 / y : y;
          e[u] = q;
          e[n] = l;
          ...
          "touchstart" === a.type ? (E(e, function(a, b) {
            ...
            if (a.zoomEnabled) {
              var b = v.bounds[a.horiz ? "h" : "v"],
                  f = a.minPixelPadding,
                  c = a.toPixels(l(a.options.min, a.dataMin)),
                  g = a.toPixels(l(a.options.max, a.dataMax)),
                  e = Math.max(c, g);
    ...
    (function(a) {
      ...
      a.Legend.prototype = {
        ...
        renderItem: function(a) {
          var b = this.chart,
              ...
              r = x.options,
              O = this.createCheckboxForItem && r && r.showCheckbox,
              r = k + l + m + (O ? 20 : 0),
              P = e.useHTML,
              M = a.options.className;
          G || (a.legendGroup = c.g("legend-item").addClass("highcharts-" + x.type + "-series highcharts-color-" + a.colorIndex + (M ? " " + M : "") + (h ? " highcharts-series-" + a.index : "")).attr({zIndex: 1}).add(this.scrollGroup), a.legendItem = G = c.text("", I ? k + l : -l, this.baseline || 0, P).css(p(a.visible ? q : A)).attr({
            align: I ? "left" : "right",
            zIndex: 2
          }).add(a.legendGroup), this.baseline || (k = q.fontSize, this.fontMetrics = c.fontMetrics(k, G), this.baseline = this.fontMetrics.f + 3 + z, G.attr("y", this.baseline)), this.symbolHeight = e.symbolHeight || this.fontMetrics.f, x.drawLegendSymbol(this, a), this.setItemEvents && this.setItemEvents(a, G, P), O && this.createCheckboxForItem(a));
        ...
        handleOverflow: function(a) {
          var b = this,
              ...
              k = f.y,
              l = this.padding,
              c = c.spacingBox.height + ("top" === f.verticalAlign ? -k : k) - l,
              k = f.maxHeight,
              q,
              A = this.clipRect,
              y = f.navigation,
              ...
              G = this.allItems,
              h = function(a) {
                "number" === typeof a ? A.attr({height: a}) : A && (b.clipRect = A.destroy(), b.contentGroup.clip());
          ...
          a > c && !1 !== y.enabled ? (this.clipHeight = q = Math.max(c - 20 - this.titleHeight - l, 0), this.currentPage = v(this.currentPage, 1), this.fullHeight = a, m(G, function(a, b) {
            ...
            b.scroll(-1, H);
          }).add(J), this.pager = e.text("", 15, 10).addClass("highcharts-legend-navigation").css(y.style).add(J), this.down = e.symbol("triangle-down", 0, 0, I, I).on("click", function() {
            b.scroll(1, H);
        ...
        scroll: function(a, c) {
          ...
          0 < a && (void 0 !== c && B(c, this.chart), this.nav.attr({
            ...
            visibility: "visible"
          }), this.up.attr({"class": 1 === a ? "highcharts-legend-nav-inactive" : "highcharts-legend-nav-active"}), k.attr({text: a + "/" + e}), this.down.attr({
      ...
      a.LegendSymbolMixin = {
        ...
        drawLineMarker: function(a) {
          ...
          b.dashStyle && (A.dashstyle = b.dashStyle);
    ...
    (function(a) {
      ...
      b(O.prototype, {
        ...
        init: function(d, b) {
          ...
          d.series = null;
          c = y(p, d);
          for (f in c.plotOptions)
            c.plotOptions[f].tooltip = e[f] && y(e[f].tooltip) || void 0;
        ...
        redraw: function(d) {
          ...
          this.layOutTitles();
          for (d = f.length; d--; )
            if (y = f[d], y.options.stacking && (z = !0, y.isDirty)) {
              q = !0;
              break;
            }
          if (q)
            for (d = f.length; d--; )
              y = f[d], y.options.stacking && (y.isDirty = !0);
          k(f, function(a) {
        ...
        get: function(a) {
          ...
          var b,
              c = this.series,
              f;
          b = g(this.axes, d) || g(this.series, d);
          for (f = 0; !b && f < c.length; f++)
            b = g(c[f].points || [], d);
          return b;
        },
        getAxes: function() {
        ...
        temporaryDisplay: function(d) {
          ...
          if (d)
            for (; b && b.style; )
              b.hcOrigStyle && (a.css(b, b.hcOrigStyle), delete b.hcOrigStyle), b.hcOrigDetached && (m.body.removeChild(b), b.hcOrigDetached = !1), b = b.parentNode;
          else
            for (; b && b.style; ) {
        ...
        reflow: function(d) {
          var b = this,
              f = b.options.chart,
              h = b.renderTo,
              e = c(f.width) && c(f.height),
              g = f.width || a.getStyle(h, "width"),
              f = f.height || a.getStyle(h, "height"),
              h = d ? d.target : N;
          if (!e && !b.isPrinting && g && f && (h === N || h === m)) {
            if (g !== b.containerWidth || f !== b.containerHeight)
              clearTimeout(b.reflowTimeout), b.reflowTimeout = x(function() {
        ...
        setChartSize: function(a) {
          ...
          this.clipBox = {
            ...
            height: Math.max(0, Math.floor(this.plotSizeY - Math.max(c, g[2]) / 2 - b))
          };
        ...
        drawChartBox: function() {
          ...
          q = {fill: q || "none"};
          if (g || f["stroke-width"])
            q.stroke = a.borderColor, q["stroke-width"] = g;
        ...
        propFromSeries: function() {
          ...
          k(["inverted", "angular", "polar"], function(e) {
            ...
            for (f = c && c.length; !h && f--; )
              (b = G[c[f].type]) && b.prototype[e] && (h = !0);
            a[e] = h;
          });
        },
        linkSeries: function() {
        ...
        renderLabels: function() {
          ...
          c.items && k(c.items, function(f) {
            var h = b(c.style, f.style),
                e = d(h.left) + a.plotLeft,
                g = d(h.top) + a.plotTop + 12;
            delete h.left;
            delete h.top;
    ...
    (function(a) {
      ...
      a.Point.prototype = {
        ...
        applyOptions: function(a, c) {
          ...
          b && (this.y = this[b]);
          this.isNull = v(this.isValid && !this.isValid(), null === this.x || !p(this.y, !0));
        ...
        optionsToObject: function(a) {
          ...
          if (p(a) || null === a)
            ...
            for (!b && a.length > n && (e = typeof a[0], "string" === e ? c.name = a[0] : "number" === e && (c.x = a[0]), t++); f < n; )
              b && void 0 === a[t] || (c[g[f]] = a[t]), t++, f++;
          else
        ...
        destroyElements: function() {
          for (var a = ["graphic", "dataLabel", "dataLabelUpper", "connector", "shadowGroup"],
              c,
              k = 6; k--; )
            c = a[k], this[c] && (this[c] = this[c].destroy());
        },
    ...
    (function(a) {
      ...
      a.Series = a.seriesType("line", null, {
        ...
        init: function(a, b) {
          ...
          if (c && c.click || b.point && b.point.events && b.point.events.click || b.allowPointSelect)
            a.runTrackerClick = !0;
          d.getColor();
          d.getSymbol();
        ...
        insert: function(a) {
          ...
          if (g(b)) {
            for (d = a.length; d--; )
              if (b >= u(a[d].options.index, a[d]._i)) {
                a.splice(d + 1, 0, this);
                break;
              }
            -1 === d && a.unshift(this);
        ...
        getCyclic: function(a, b, d) {
          ...
          b || (c = u(h[e], h["_" + e]), p(c) || (f.series.length || (f[g] = 0), h["_" + e] = c = f[g] % q, f[g] += 1), d && (b = d[c]));
          void 0 !== c && (this[e] = c);
          this[a] = b;
        },
        getColor: function() {
        ...
        setData: function(c, f, d, e) {
          ...
          k = c.length;
          f = u(f, !0);
          if (!1 !== e && k && q === k && !z.cropped && !z.hasGroupedData && z.visible)
            v(c, function(a, d) {
            ...
            if (l && k > l) {
              ...
              if (g(t))
                for (d = 0; d < k; d++)
                  m[d] = this.autoIncrement(), J[d] = c[d];
              else if (b(t))
                if (H)
                  for (d = 0; d < k; d++)
                    t = c[d], m[d] = t[0], J[d] = t.slice(1, H + 1);
                else
                  for (d = 0; d < k; d++)
                    t = c[d], m[d] = t[0], J[d] = t[1];
              else
                a.error(12);
            } else
              for (d = 0; d < k; d++)
                void 0 !== c[d] && (t = {series: z}, z.pointClass.prototype.applyOptions.apply(t, [c[d]]), z.updateParallelArrays(t, d));
        ...
        processData: function(b) {
          ...
          var h,
              ...
              n = this.options;
          k = n.cropThreshold;
          var y = this.getExtremesFromAll || n.getExtremesFromAll,
              A = this.isCartesian,
              n = q && q.val2lin,
              t = q && q.isLog,
              ...
              I,
              l;
          if (A && !this.isDirty && !q.isDirty && !this.yAxis.isDirty && !b)
            return !1;
          q && (b = q.getExtremes(), I = b.min, l = b.max);
          if (A && this.sorted && !y && (!k || f > k || this.forceCrop))
            if (c[f - 1] < I || c[0] > l)
              c = [], d = [];
            else if (c[0] < I || c[f - 1] > l)
              e = this.cropData(this.xData, this.yData, I, l), c = e.xData, d = e.yData, e = e.start, h = !0;
          for (k = c.length || 1; --k; )
            f = t ? n(c[k]) - n(c[k - 1]) : c[k] - c[k - 1], 0 < f && (void 0 === g || f < g) ? g = f : 0 > f && u && (a.error(15), u = !1);
          this.cropped = h;
          this.cropStart = e;
        ...
        generatePoints: function() {
          ...
          for (u = 0; u < g; u++)
            n = k + u, y ? (A = (new e).init(this, [f[u]].concat(q(h[u]))), A.dataGroup = this.groupMap[u]) : (A = d[n]) || void 0 === b[n] || (d[n] = A = (new e).init(this, b[n], f[u])), A && (A.index = n, t[u] = A);
          this.options.keys = a;
          if (d && (g !== (c = d.length) || y))
            for (u = 0; u < c; u++)
              u !== k || y || (u += g), d[u] && (d[u].destroyElements(), d[u].plotX = void 0);
          this.data = d;
          this.points = t;
        },
        getExtremes: function(a) {
          ...
          f = a.length;
          for (t = 0; t < f; t++)
            if (y = d[t], A = a[t], n = (g(A, !0) || b(A)) && (!c.positiveValuesOnly || A.length || 0 < A), y = this.getExtremesFromAll || this.options.getExtremesFromAll || this.cropped || (d[t + 1] || y) >= q && (d[t - 1] || y) <= k, n && y)
              if (n = A.length)
                for (; n--; )
                  "number" === typeof A[n] && (e[h++] = A[n]);
              else
                e[h++] = A;
          this.dataMin = r(e);
          this.dataMax = F(e);
        ...
        translate: function() {
          ...
          for (a = 0; a < q; a++) {
            var w = h[a],
                ...
                C = w.y;
            H = w.low;
            var E = b && e.stacks[(this.negStacks && C < (t ? 0 : A) ? "-" : "") + this.stackKey],
                F;
            e.positiveValuesOnly && null !== C && 0 >= C && (w.isNull = !0);
            w.plotX = l = m(Math.min(Math.max(-1E5, d.translate(B, 0, 0, 0, 1, n, "flags" === this.type)), 1E5));
            b && this.visible && !w.isNull && E && E[B] && (v = this.getStackIndicator(v, B, this.index), F = E[B], C = F.points[v.key], H = C[0], C = C[1], H === t && v.key === E[B].base && (H = u(A, e.min)), e.positiveValuesOnly && 0 >= H && (H = null), w.total = w.stackTotal = F.total, w.percentage = F.total && w.y / F.total * 100, w.stackY = C, F.setOffset(this.pointXOffset || 0, this.barW || 0));
        ...
        setClip: function(a) {
          var b = this.chart,
              ...
              q = b[g],
              n = b[g + "m"];
          q || (a && (e.width = 0, f && (e.x = b.plotSizeX), b[g + "m"] = n = c.clipRect(f ? b.plotSizeX + 99 : -99, f ? -b.plotLeft : -b.plotTop, 99, f ? b.chartWidth : b.chartHeight)), b[g] = q = c.clipRect(e), q.count = {length: 0});
        ...
        pointAttribs: function(a, b) {
          var d = this.options.marker,
              ...
              e = c && c.color,
              g = a && a.color,
              c = u(f.lineWidth, d.lineWidth);
          a = a && a.zone && a.zone.color;
          h = e || a || g || h;
          a = f.fillColor || d.fillColor || h;
        ...
        applyZones: function() {
          var a = this,
              ...
              p,
              r = !1;
          c.length && (q || n) && y && void 0 !== y.min && (t = y.reversed, m = y.horiz, q && q.hide(), n && n.hide(), A = y.getExtremes(), v(c, function(c, z) {
        ...
        buildKDTree: function() {
          function a(d, c, f) {
            var h,
                e;
            if (e = d && d.length)
              return h = b.kdAxisArray[c % f], d.sort(function(a, d) {
                return a[h] - d[h];
              }), e = Math.floor(e / 2), {
                point: d[e],
        ...
        searchKDTree: function(a, b) {
          function d(a, b, g, q) {
            ...
            n.distX = p(y) ? Math.sqrt(y) : Number.MAX_VALUE;
            k = a[k] - n[k];
            z = 0 > k ? "left" : "right";
            y = 0 > k ? "right" : "left";
    ...
    (function(a) {
      ...
      a.StackItem.prototype = {
        ...
        setOffset: function(a, c) {
          ...
          g = this.getStackBox(b, this, a, g, c, e);
          if (c = this.label)
            c.align(this.alignOptions, null, g), g = c.alignAttr, c[!1 === this.options.crop || b.isInsidePlot(g.x, g.y) ? "show" : "hide"](!0);
        },
      ...
      B.prototype.setStackedPoints = function() {
        if (this.options.stacking && (!0 === this.visible || !1 === this.chart.options.chart.ignoreHiddenSeries)) {
          ...
          A.stacksTouched += 1;
          for (G = 0; G < b; G++)
            h = e[G], x = c[G], p = this.getStackIndicator(p, h, this.index), z = p.key, d = (J = q && x < (t ? 0 : n)) ? l : u, y[d] || (y[d] = {}), y[d][h] || (m[d] && m[d][h] ? (y[d][h] = m[d][h], y[d][h].total = null) : y[d][h] = new a.StackItem(A, A.options.stackLabels, J, h, f)), d = y[d][h], null !== x ? (d.points[z] = d.points[this.index] = [v(d.cumulative, t)], r(d.cumulative) || (d.base = z), d.touched = A.stacksTouched, 0 < p.index && !1 === this.singleStacks && (d.points[z][0] = d.points[this.index + "," + h + ",0"][0])) : d.points[z] = d.points[this.index] = null, "percent" === g ? (J = J ? u : l, q && y[J] && y[J][h] ? (J = y[J][h], d.total = J.total = Math.max(J.total, d.total) + Math.abs(x) || 0) : d.total = F(d.total + (Math.abs(x) || 0))) : d.total = F(d.total + (x || 0)), d.cumulative = v(d.cumulative, t) + (x || 0), null !== x && (d.points[z].push(d.cumulative), k[G] = d.cumulative);
      ...
      B.prototype.modifyStacks = function() {
        ...
        a[n + "Stacker"] && l([c, "-" + c], function(c) {
          for (var f = b.length,
              e,
              t; f--; )
            if (e = b[f], g = a.getStackIndicator(g, e, a.index, c), t = (e = k[c] && k[c][e]) && e.points[g.key])
              a[n + "Stacker"](t, e, f);
        });
      };
    ...
    (function(a) {
      ...
      v(a.Chart.prototype, {
        ...
        update: function(a, b, f) {
          ...
          if (z) {
            ...
            if ("inverted" in z || "polar" in z)
              q.propFromSeries(), k = !0;
            "alignTicks" in z && (k = !0);
            n(z, function(a, d) {
              -1 !== e("chart." + d, q.propsRequireUpdateSeries) && (h = !0);
              -1 !== e(d, q.propsRequireDirtyBox) && (q.isDirtyBox = !0);
            });
          ...
          n(a, function(a, b) {
            if (q[b] && "function" === typeof q[b].update)
              q[b].update(a, !1);
            else if ("function" === typeof q[d[b]])
              q[d[b]](a);
          ...
          w("xAxis yAxis zAxis series colorAxis pane".split(" "), function(d) {
            a[d] && (w(A(a[d]), function(a, b) {
              (b = l(a.id) && q.get(a.id) || q[d][b]) && b.coll === d && (b.update(a, !1), f && (b.touched = !0));
              if (!b && f)
                if ("series" === d)
                  q.addSeries(a, !1).touched = !0;
                else if ("xAxis" === d || "yAxis" === d)
                  q.addAxis(a, "xAxis" === d, !1).touched = !0;
            }), f && w(q[d], function(a) {
      ...
      v(f.prototype, {
        update: function(a, b, c, f) {
          function d() {
            ...
            "point" === A.legendType && (n.isDirtyLegend = !0);
            b && n.redraw(c);
          }
          var e = this,
              g = e.series,
      ...
      v(u.prototype, {
        addPoint: function(a, b, c, f) {
          ...
          u = n.x;
          y = A.length;
          if (this.requireSorting && u < A[y - 1])
            for (k = !0; y && A[y - 1] > u; )
              y--;
        ...
        update: function(a, b) {
          var c = this,
              ...
              y = c.finishedAnimating && {animation: !1};
      ...
      l("area", "line", {
        ...
        getStackPoints: function(l) {
          var m = [],
              ...
              n = g.length,
              t,
              f = r(e.options.reversedStacks, !0) ? 1 : -1,
              u;
          l = l || this.points;
          if (this.options.stacking) {
            for (u = 0; u < l.length; u++)
              l[u].leftNull = l[u].rightNull = null, k[l[u].x] = l[u];
            a.objectEach(c, function(a, b) {
            ...
            E(v, function(a, g) {
              var q = 0,
                  ...
                  l;
              if (k[a] && !k[a].isNull)
                m.push(k[a]), E([-1, 1], function(e) {
                  var q = 1 === e ? "rightNull" : "leftNull",
                      d = 0,
                      A = c[v[g + e]];
                  if (A)
                    for (u = b; 0 <= u && u < n; )
                      y = A.points[u], y || (u === b ? k[a][q] = !0 : t[u] && (l = c[a].points[u]) && (d -= l[1] - l[0])), u += f;
                  k[a][1 === e ? "rightCliff" : "leftCliff"] = d;
                });
              else {
                for (u = b; 0 <= u && u < n; ) {
                  if (y = c[a].points[u]) {
        ...
        getGraphPath: function(a) {
          var l = m.prototype.getGraphPath,
              v = this.options,
              w = v.stacking,
              e = this.yAxis,
              c,
              ...
              u = v.threshold,
              D = e.getThreshold(v.threshold),
              q,
              v = v.connectNulls || "percent" === w,
              A = function(c, q, k) {
                var A = a[c];
                c = w && f[A.x].points[n];
                var d = A[k + "Null"] || 0;
                ...
                void 0 !== z && (g.push({
                  ...
                  plotX: t,
                  plotY: null === y ? D : e.getThreshold(y),
                  doCurve: !1
                }));
              };
          a = a || this.points;
          ...
          for (c = 0; c < a.length; c++)
            if (k = a[c].isNull, t = r(a[c].rectPlotX, a[c].plotX), q = r(a[c].yBottom, D), !k || v)
              v || A(c, c - 1, "left"), k && !w && v || (g.push(a[c]), b.push({
                x: c,
                plotX: t,
                plotY: q
              })), v || A(c, c + 1, "right");
        ...
        drawGraph: function() {
          ...
          E(B, function(e) {
            var c = e[0],
                k = a[c];
            k ? (k.endX = a.preventGraphAnimation ? null : l.xMap, k.animate({d: l})) : (k = a[c] = a.chart.renderer.path(l).addClass(e[1]).attr({
    ...
    (function(a) {
      var C = a.pick;
      a = a.seriesType;
      a("spline", "line", {}, {getPointSpline: function(a, F, r) {
          var m = F.plotX,
              l = F.plotY,
              w = a[r - 1];
          r = a[r + 1];
          var p,
              ...
              B,
              e;
          if (w && !w.isNull && !1 !== w.doCurve && !F.isCliff && r && !r.isNull && !1 !== r.doCurve && !F.isCliff) {
            a = w.plotY;
            B = r.plotX;
            r = r.plotY;
            var c = 0;
      ...
      v("column", "line", {
        ...
        getColumnMetrics: function() {
          ...
          var l = Math.min(Math.abs(k.transA) * (k.ordinalSlope || c.pointRange || k.closestPointRange || k.tickInterval || 1), k.len),
              m = l * c.groupPadding,
              q = (l - 2 * m) / (f || 1),
              c = Math.min(c.maxPointWidth || k.len, w(c.pointWidth, q * (1 - 2 * c.pointPadding)));
          a.columnMetrics = {
            width: c,
        ...
        translate: function() {
          var a = this,
              ...
              b = a.borderWidth = w(k.borderWidth, b ? 0 : 1),
              g = a.yAxis,
              n = k.threshold,
              t = a.translatedThreshold = g.getThreshold(n),
              f = w(k.minPointLength, 5),
              l = a.getColumnMetrics(),
              m = l.width,
              q = a.barW = Math.max(m, 1 + 2 * b),
              A = a.pointXOffset = l.offset;
          c.inverted && (t -= .5);
          ...
          F(a.points, function(b) {
            var e = w(b.yBottom, t),
                k = 999 + Math.abs(e),
                k = Math.min(Math.max(-k, b.plotY), g.len + k),
                y = b.plotX + A,
                d = q,
                z = Math.min(k, e),
                l,
                h = Math.max(k, e) - z;
            f && Math.abs(h) < f && (h = f, l = !g.reversed && !b.negative || g.reversed && b.negative, b.y === n && a.dataMax <= n && g.min < n && (l = !l), z = Math.abs(z - t) > f ? e - f : t - (l ? f : 0));
            b.barX = y;
            b.pointWidth = m;
        ...
        pointAttribs: function(a, c) {
          ...
          var n = g["stroke-width"] || "borderWidth",
              t = a && a.color || this.color,
              f = a && a[b] || e[b] || this.color || t,
              u = a && a[n] || e[n] || this[n] || 0,
              g = e.dashStyle;
        ...
        drawPoints: function() {
          ...
          F(a.points, function(e) {
            ...
            if (m(e.plotY) && null !== e.y) {
              n = e.shapeArgs;
              if (f)
                f[c.pointCount < g ? "animate" : "attr"](l(n));
              else
                e.graphic = f = b[e.shapeType](n).add(e.group || a.group);
        ...
        animate: function(a) {
          var c = this,
              ...
              n = {},
              l = g ? "translateX" : "translateY",
              f;
          B && (a ? (n.scaleY = .001, a = Math.min(e.pos + e.len, Math.max(e.pos, e.toPixels(b.threshold))), g ? n.translateX = a - e.len : n.translateY = a, c.group.attr(n)) : (f = c.group.attr(l), c.group.animate({scaleY: 1}, r(C(c.options.animation), {step: function(a, b) {
              n[l] = f + b.pos * (e.pos - f);
              c.group.attr(n);
            }})), c.animate = null));
        },
      ...
      a.CenteredSeriesMixin = {
        getCenter: function() {
          var a = this.options,
              ...
              c;
          for (e = 0; 4 > e; ++e)
            c = v[e], a = 2 > e || 2 === e && /%$/.test(c), v[e] = r(c, [p, l, B, v[2]][e]) + (a ? w : 0);
          v[3] > v[2] && (v[3] = v[2]);
          return v;
        },
    ...
    (function(a) {
      ...
      c("pie", "line", {
        ...
        updateTotals: function() {
          ...
          for (a = 0; a < k; a++)
            f = e[a], c += l && !f.visible ? 0 : f.isNull ? 0 : f.y;
          this.total = c;
          for (a = 0; a < k; a++)
            f = e[a], f.percentage = 0 < c && (f.visible || !l) ? f.y / c * 100 : 0, f.total = c;
        },
        generatePoints: function() {
        ...
        translate: function(a) {
          ...
          var b = 0,
              ...
              m,
              q,
              A = l(c.startAngle, c.endAngle),
              y = this.startAngleRad = A.start,
              A = (this.endAngleRad = A.end) - y,
              H = this.points,
              p,
    ...
    (function(a) {
      ...
      a.distribute = function(a, c) {
        ...
        for (a = w(a, function(a) {
          ...
          for (f = a.length; f--; )
            g = a[f], n = (Math.min.apply(0, g.targets) + Math.max.apply(0, g.targets)) / 2, g.pos = Math.min(Math.max(0, n - g.size * g.align), c - g.size);
          f = a.length;
          for (g = !1; f--; )
            0 < f && a[f - 1].pos + a[f - 1].size > a[f].pos && (a[f - 1].size += a[f].size, a[f - 1].targets = a[f - 1].targets.concat(a[f].targets), a[f - 1].align = .5, a[f - 1].pos + a[f - 1].size > c && (a[f - 1].pos = c - a[f - 1].size), a.splice(f, 1), g = !0);
        }
        f = 0;
        r(a, function(a) {
          var b = 0;
      ...
      c.prototype.drawDataLabels = function() {
        function b(a, d) {
          var b = d.filter;
          return b ? (d = b.operator, a = a[b.property], b = b.value, "\x3e" === d && a > b || "\x3c" === d && a < b || "\x3e\x3d" === d && a >= b || "\x3c\x3d" === d && a <= b || "\x3d\x3d" === d && a == b || "\x3d\x3d\x3d" === d && a === b ? !0 : !1) : !0;
        }
        var c = this,
            e = c.chart,
            f = c.options,
            ...
            H,
            v,
            w = B(k.defer, !!f.animation),
            d = e.renderer;
        if (k.enabled || c._hasPointLabels)
          c.dlProcessOptions && c.dlProcessOptions(k), v = c.plotGroup("dataLabelsGroup", "data-labels", w && !y ? "hidden" : "visible", k.zIndex || 6), w && (v.attr({opacity: +y}), y || C(c, "afterAnimate", function() {
            c.visible && v.show(!0);
            ...
            n && (k = p(A, q), z = g.getLabelConfig(), u = k[g.formatPrefix + "Format"] || k.format, H = F(u) ? l(u, z, e.time) : (k[g.formatPrefix + "Formatter"] || k.formatter).call(z, k), u = k.style, z = k.rotation, u.color = B(k.color, u.color, c.color, "#000000"), "contrast" === u.color && (g.contrastColor = d.getContrast(g.color || c.color), u.color = k.inside || 0 > B(g.labelDistance, k.distance) || f.stacking ? g.contrastColor : "#000000"), f.cursor && (u.cursor = f.cursor), y = {
            ...
            !h || n && F(H) ? n && F(H) && (h ? y.text = H : (h = g.dataLabel = z ? d.text(H, 0, -9999).addClass("highcharts-data-label") : d.label(H, 0, -9999, k.shape, null, null, k.useHTML, null, "data-label"), h.addClass(" highcharts-data-label-color-" + g.colorIndex + " " + (k.className || "") + (k.useHTML ? "highcharts-tracker" : ""))), h.attr(y), h.css(u).shadow(k.shadow), h.added || h.add(v), c.alignDataLabel(g, h, k, null, m)) : (g.dataLabel = h = h.destroy(), t && (g.connector = t.destroy()));
          });
      ...
      c.prototype.alignDataLabel = function(a, b, c, f, e) {
        var g = this.chart,
            q = g.inverted,
            k = B(a.dlBox && a.dlBox.centerX, a.plotX, -9999),
            n = B(a.plotY, -9999),
            l = b.getBBox(),
            t,
            u = c.rotation,
            d = c.align,
            z = this.visible && (a.series.forceDL || g.isInsidePlot(k, Math.round(n), q) || f && g.isInsidePlot(k, q ? f.x + 1 : f.y + f.height - 1, q)),
            G = "justify" === B(c.overflow, "justify");
        ...
        }, b[e ? "attr" : "animate"](k).attr({align: d}), n = (u + 720) % 360, n = 180 < n && 360 > n, "left" === d ? k.y -= n ? l.height : 0 : "center" === d ? (k.x -= l.width / 2, k.y -= l.height / 2) : "right" === d && (k.x -= l.width, k.y -= n ? 0 : l.height)) : (b.align(c, null, f), k = b.alignAttr), G ? a.isLabelJustified = this.justifyDataLabel(b, c, k, l, f, e) : B(c.crop, !0) && (z = g.isInsidePlot(k.x, k.y) && g.isInsidePlot(k.x + l.width, k.y + l.height)), c.shape && !u))
          b[e ? "attr" : "animate"]({
      ...
      k.pie && (k.pie.prototype.drawDataLabels = function() {
        var b = this,
            ...
            m = B(l.connectorPadding, 10),
            q = B(l.connectorWidth, 1),
            A = f.plotWidth,
            y = f.plotHeight,
            p,
            v = b.center,
        ...
        b.visible && (l.enabled || b._hasPointLabels) && (r(e, function(a) {
          ...
          var g,
              ...
              u;
          if (n)
            for (b.sortByAngle(c, e - .5), 0 < b.maxLabelDistance && (g = Math.max(0, d - w - b.maxLabelDistance), q = Math.min(d + w + b.maxLabelDistance, f.plotHeight), r(c, function(a) {
            ...
            }), a.distribute(t, q + u - g)), Q = 0; Q < n; Q++)
              k = c[Q], q = k.positionsIndex, h = k.labelPos, z = k.dataLabel, M = !1 === k.visible ? "hidden" : "inherit", C = g = h[1], t && F(t[q]) && (void 0 === t[q].pos ? M = "hidden" : (x = t[q].size, C = k.top + t[q].pos)), delete k.positionIndex, O = l.justify ? v[0] + (e ? -1 : 1) * (w + k.labelDistance) : b.getX(C < k.top + 2 || C > k.bottom - 2 ? g : C, e, k), z._attr = {
                visibility: M,
                align: h[6]
              }, z._pos = {
                x: O + l.x + ({
                ...
                y: C + l.y - 10
              }, h.x = O, h.y = C, B(l.crop, !0) && (G = z.getBBox().width, g = null, O - G < m ? (g = Math.round(G - O + m), K[3] = Math.max(g, K[3])) : O + G > A - m && (g = Math.round(O + G - A + m), K[1] = Math.max(g, K[1])), 0 > C - x / 2 ? K[0] = Math.max(Math.round(-C + x / 2), K[0]) : C + x / 2 > y && (K[2] = Math.max(Math.round(C + x / 2 - y), K[2])), z.sideOverflow = g);
          ...
          if ((z = a.dataLabel) && z._pos && a.visible && 0 < a.labelDistance) {
            ...
            if (d = !p)
              a.connector = p = f.renderer.path().addClass("highcharts-data-label-connector  highcharts-color-" + a.colorIndex).add(b.dataLabelsGroup), p.attr({
                "stroke-width": q,
        ...
        var b = this.center,
            ...
            k,
            q = null !== c.size;
        q || (null !== f[0] ? k = Math.max(b[2] - Math.max(a[1], a[3]), g) : (k = Math.max(b[2] - a[1] - a[3], g), b[0] += (a[3] - a[1]) / 2), null !== f[1] ? k = Math.max(Math.min(k, b[2] - Math.max(a[0], a[2])), g) : (k = Math.max(Math.min(k, b[2] - a[0] - a[2]), g), b[1] += (a[0] - a[2]) / 2), k < b[2] ? (b[2] = k, b[3] = Math.min(e(c.innerSize || 0, k), k), this.translate(b), this.drawDataLabels && this.drawDataLabels()) : q = !0);
        return q;
      });
      k.column && (k.column.prototype.alignDataLabel = function(a, b, e, f, k) {
        ...
        l && (f = p(l), 0 > f.y && (f.height += f.y, f.y = 0), l = f.y + f.height - q.yAxis.len, 0 < l && (f.height -= l), g && (f = {
          x: q.yAxis.len - f.y - f.height,
          y: q.xAxis.len - f.x - f.width,
          width: f.height,
          height: f.width
    ...
    (function(a) {
      ...
      a(C.prototype, "render", function() {
        ...
        E(this.series || [], function(l) {
          var m = l.options.dataLabels,
              p = l.dataLabelCollections || ["dataLabel"];
      ...
      C.prototype.hideOverlappingLabels = function(a) {
        var l = a.length,
            ...
            b,
            g,
            n = function(a, b, c, e, g, k, l, n) {
              return !(g > a + c || g + l < a || k > b + e || k + n < b);
            };
        for (p = 0; p < l; p++)
          if (m = a[p])
            m.oldOpacity = m.opacity, m.newOpacity = 1, m.width || (v = m.getBBox(), m.width = v.width, m.height = v.height);
        a.sort(function(a, b) {
          return (b.labelrank || 0) - (a.labelrank || 0);
        });
        for (p = 0; p < l; p++)
          for (v = a[p], m = p + 1; m < l; ++m)
            if (r = a[m], v && r && v !== r && v.placed && r.placed && 0 !== v.newOpacity && 0 !== r.newOpacity && (e = v.alignAttr, c = r.alignAttr, k = v.parentGroup, b = r.parentGroup, g = 2 * (v.box ? 0 : v.padding || 0), e = n(e.x + k.translateX, e.y + k.translateY, v.width - g, v.height - g, c.x + b.translateX, c.y + b.translateY, r.width - g, r.height - g)))
              (v.labelrank < r.labelrank ? v : r).newOpacity = 0;
        E(a, function(a) {
          var b,
              c;
    ...
    (function(a) {
      ...
      D = a.TrackerMixin = {
        ...
        drawTrackerGraph: function() {
          var a = this,
              b = a.options,
              c = b.trackByArea,
              f = [].concat(c ? a.areaPath : a.graphPath),
              e = f.length,
              g = a.chart,
              d = g.pointer,
              k = g.renderer,
          ...
          if (e && !c)
            for (n = e + 1; n--; )
              "M" === f[n] && f.splice(n + 1, 0, f[n + 1] - l, f[n + 2], "L"), (n && "M" === f[n] || n === e) && f.splice(n, 0, "L", f[n - 2] + l, f[n - 1]);
      ...
      p(n.prototype, {
        select: function(a, b) {
          ...
          c.firePointEvent(a ? "select" : "unselect", {accumulate: b}, function() {
            ...
            b || w(k.getSelectedPoints(), function(a) {
              a.selected && a !== c && (a.selected = a.options.selected = !1, f.options.data[e(a, f.data)] = a.options, a.setState(""), a.firePointEvent("unselect"));
            });
          });
        },
        ...
        importEvents: function() {
          if (!this.hasImportedEvents) {
            var c = this,
                f = b(c.series.options.point, c.options).events;
            c.events = f;
        ...
        setState: function(a, b) {
          var c = Math.floor(this.plotX),
              ...
              d = l[e.type].marker && e.options.marker,
              q = d && !1 === d.enabled,
              ...
              r = d && e.markerAttribs;
          a = a || "";
          if (!(a === this.state && !b || this.selected && "select" !== a || !1 === k.enabled || a && (h || q && !1 === n.enabled) || a && A.states && A.states[a] && !1 === A.states[a].enabled)) {
            r && (D = e.markerAttribs(this, a));
            if (this.graphic)
              this.state && this.graphic.removeClass("highcharts-point-" + this.state), a && this.graphic.addClass("highcharts-point-" + a), this.graphic.animate(e.pointAttribs(this, a), g(t.options.chart.animation, k.animation)), D && this.graphic.animate(D, g(t.options.chart.animation, n.animation, d.animation)), m && m.hide();
            else {
              if (a && n) {
                d = A.symbol || e.symbol;
                ...
                if (m)
                  ...
                  d && (e.stateMarkerGraphic = m = t.renderer.symbol(d, D.x, D.y, D.width, D.height).add(e.markerGroup), m.currentSymbol = d);
      ...
      p(t.prototype, {
        ...
        setState: function(a) {
          ...
          }), b.state = a, !e[a] || !1 !== e[a].enabled) && (a && (k = e[a].lineWidth || k + (e[a].lineWidthPlus || 0)), f && !f.dashstyle))
            for (k = {"stroke-width": k}, f.animate(k, g(e[a || "normal"] && e[a || "normal"].animation, b.chart.options.chart.animation)); b["zone-graph-" + c]; )
              b["zone-graph-" + c].attr(k), c += 1;
        },
        setVisible: function(a, b) {
          ...
          if (f.hoverSeries === c || (f.hoverPoint && f.hoverPoint.series) === c)
            c.onMouseOut();
      ...
      C.prototype.setResponsive = function(l) {
        ...
        var c = a.merge.apply(0, a.map(p, function(c) {
          return a.find(m.rules, function(a) {
            ...
            p = p.toString() || void 0;
        p !== (e && e.ruleIds) && (e && this.update(e.undoOptions, l), p ? (this.currentResponsive = {
          ruleIds: p,
          mergedOptions: c,
      ...
      C.prototype.currentOptions = function(l) {
        function p(e, c, k, b) {
          ...
          a.objectEach(e, function(a, e) {
            if (!b && -1 < F(e, ["series", "xAxis", "yAxis"]))
              for (a = w(a), k[e] = [], g = 0; g < a.length; g++)
                c[e][g] && (k[e][g] = {}, p(a[g], c[e][g], k[e][g], b + 1));
            else
              m(a) ? (k[e] = r(a) ? [] : {}, p(a, c[e] || {}, k[e], b + 1)) : k[e] = c[e] || null;
          });
        }
        var B = {};
      ...
      e(E.prototype, "getTimeTicks", function(a, e, b, g, l, t, f, u) {
        ...
        for (k = 0; k < r; k++) {
          ...
          if (k === r - 1 || t[k + 1] - t[k] > 5 * f || v) {
            if (t[k] > z) {
              for (n = a.call(this, e, t[c], t[k], l); n.length && n[0] <= z; )
                n.shift();
        ...
        if (u && a.unitRange <= B.hour) {
          k = d.length - 1;
          for (c = 1; c < k; c++)
            h.dateFormat("%d", d[c]) !== h.dateFormat("%d", d[c - 1]) && (y[d[c]] = "day", p = !0);
          p && (y[d[0]] = "day");
          a.higherRanks = y;
        }
        d.info = a;
        if (u && m(G)) {
          ...
          var x;
          for (p = []; u--; )
            c = this.translate(d[u]), x && (p[u] = x - c), k[u] = x = c;
          p.sort();
          p = p[Math.floor(p.length / 2)];
          p < .6 * G && (p = null);
          u = d[h - 1] > g ? h - 1 : h;
          for (x = void 0; u--; )
            c = k[u], g = Math.abs(x - c), x && g < .8 * G && (null === p || g < .8 * p) ? (y[d[u]] && !y[d[u + 1]] ? (g = u + 1, x = c) : g = u, d.splice(g, 1)) : x = c;
        }
        return d;
      });
      w(E.prototype, {
        beforeSetTickPositions: function() {
          ...
          !this.options.overscroll || this.max !== this.dataMax || this.chart.mouseIsDown && !g || this.eventArgs && (!this.eventArgs || "navigator" === this.eventArgs.trigger) || (this.max += this.options.overscroll, !g && m(this.userMin) && (this.min += this.options.overscroll));
          if (n || p) {
            l(this.series, function(b, c) {
              if (!(A && !1 === b.visible || !1 === b.takeOrdinalPosition && !p) && (e = e.concat(b.processedXData), a = e.length, e.sort(function(a, b) {
                return a - b;
              }), q = Math.min(q, v(b.closestPointRange, q)), a))
                for (c = a - 1; c--; )
            ...
            if (2 < a) {
              ...
              this.options.overscroll && (2 === a ? q = e[1] - e[0] : 1 === a ? (q = this.options.overscroll, e = [e[0], e[0] + q]) : q = this.overscrollPointsRange);
        ...
        lin2val: function(a, e) {
          ...
          if (b) {
            var c = this.ordinalSlope,
                k = this.ordinalOffset,
                l = b.length - 1,
                f;
            if (e)
              0 > a ? a = b[0] : a > l ? a = b[l] : (l = Math.floor(a), f = a - l);
            else
              for (; l--; )
                if (e = c * l + k, a >= e) {
                  c = c * (l + 1) + k;
        ...
        getExtendedPositions: function() {
          ...
          g[n] || (u = {
            ...
            options: {ordinal: !0},
            val2lin: E.prototype.val2lin,
            ordinal2lin: E.prototype.ordinal2lin
          }, l(a.series, function(c) {
            r = {
              xAxis: u,
              xData: c.xData.slice(),
    ...
    (function(a) {
      ...
      l(v.prototype, {
        ...
        isInAnyBreak: function(a, c) {
          ...
          if (b) {
            for (; b--; )
              this.isInBreak(e[b], a) && (g = !0, l || (l = F(e[b].showPoints, this.isXAxis ? !1 : !0)));
            m = g && c ? g && !l : g;
          }
          return m;
        }
      ...
      r(v.prototype, "init", function(a, c, k) {
        ...
        b.isBroken && (b.val2lin = function(a) {
          var c = a,
              e,
              f;
          for (f = 0; f < b.breakArray.length; f++)
            if (e = b.breakArray[f], e.to <= a)
              c -= e.len;
            else if (e.from >= a)
              break;
          ...
          var c,
              e;
          for (e = 0; e < b.breakArray.length && !(c = b.breakArray[e], c.from >= a); e++)
          ...
          v.prototype.setExtremes.call(this, a, b, c, f, e);
      ...
      r(B.prototype, "generatePoints", function(a) {
        ...
        var c = this.xAxis,
            ...
            f;
        if (c && e && (c.options.breaks || e.options.breaks))
          for (; l--; )
            g = b[l], f = null === g.y && !1 === m, f || !c.isInAnyBreak(g.x, !0) && !e.isInAnyBreak(g.y, !0) || (b.splice(l, 1), this.data[l] && this.data[l].destroyElements());
      });
      a.Series.prototype.drawBreaks = function(a, c) {
        ...
        a && m(c, function(c) {
          ...
          m(b, function(b) {
            f = F(b["stack" + c.toUpperCase()], b[c]);
            m(g, function(c) {
              t = !1;
              if (l < c.from && f > c.to || l > c.from && f < c.from)
                t = "pointBreak";
              else if (l < c.from && f > c.from && f < c.to || l > c.from && f > c.to && f < c.from)
                t = "pointInBreak";
              t && p(a, t, {
                point: b,
                brk: c
      ...
      a.Series.prototype.gappedPath = function() {
        var e = this.currentDataGrouping,
            ...
            g = this.yAxis;
        if (e && 0 < b)
          for ("value" !== this.options.gapUnit && (e *= this.closestPointRange), c && c > e && (e = c); b--; )
            k[b + 1].x - k[b].x > e && (c = (k[b].x + k[b + 1].x) / 2, k.splice(b + 1, 0, {
              isNull: !0,
              x: c
    ...
    (function(a) {
      ...
      g.groupData = function(a, b, c, e) {
        ...
        for (H; H <= n; H++) {
          ...
          if (r) {
            A = this.cropStart + H;
            var I = g && g[A] || this.pointClass.prototype.applyOptions.apply({series: this}, [d[A]]),
                C;
            for (A = 0; A < D; A++)
              C = I[r[A]], v(C) ? t[A].push(C) : null === C && (t[A].hasNulls = !0);
          } else
            A = p ? b[H] : null, v(A) ? t[0].push(A) : null === A && (t[0].hasNulls = !0);
        }
        return [k, m, h];
      };
      ...
      b(k.prototype, "tooltipFooterHeaderFormatter", function(a, b, c) {
        var f = this.chart.time,
            ...
            h,
            l = e.xAxis;
        return l && "datetime" === l.options.type && g && v(b.key) ? (a = e.currentDataGrouping, g = g.dateTimeLabelFormats, a ? (l = g[a.unitName], 1 === a.count ? k = l[0] : (k = l[1], h = l[2])) : !k && g && (k = this.getXDateFormat(b, d, l)), k = f.dateFormat(k, b.key), h && (k += f.dateFormat(h, b.key + a.totalRange - 1)), p(d[(c ? "footer" : "header") + "Format"], {
      ...
      b(g, "setOptions", function(a, b) {
        ...
        var c = this.type,
            ...
            g = r[c].dataGrouping;
        u[c] && (g || (g = B(f, u[c])), a.dataGrouping = B(g, e.series && e.series.dataGrouping, e[c].dataGrouping, b.dataGrouping));
      ...
      F.prototype.getGroupPixelWidth = function() {
        var a = this.series,
            ...
            d;
        for (c = b; c--; )
          (d = a[c].options.dataGrouping) && (f = Math.max(f, d.groupPixelWidth));
        for (c = b; c--; )
          (d = a[c].options.dataGrouping) && a[c].hasProcessed && (b = (a[c].processedXData || a[c].data).length, a[c].groupPixelWidth || b > this.chart.plotSizeX / f || b && d.forced) && (e = !0);
        return e ? f : 0;
      };
      F.prototype.setDataGrouping = function(a, b) {
        ...
        if (this instanceof F)
          ...
          l(this.chart.options.series, function(b) {
            b.dataGrouping = a;
          }, !1);
        b && this.chart.redraw();
      };
        ...
        drawPoints: function() {
          ...
          C(a.points, function(m) {
            var p,
                ...
                k,
                b = !c;
            void 0 !== m.plotY && (c || (m.graphic = c = l.renderer.path().add(a.group)), c.attr(a.pointAttribs(m, m.selected && "select")), r = c.strokeWidth() % 2 / 2, k = Math.round(m.plotX) - r, w = Math.round(m.shapeArgs.width / 2), e = ["M", k, Math.round(m.yBottom), "L", k, Math.round(m.plotHigh)], null !== m.open && (p = Math.round(m.plotOpen) + r, e.push("M", k, p, "L", k - w, p)), null !== m.close && (p = Math.round(m.plotClose) + r, e.push("M", k, p, "L", k + w, p)), c[b ? "attr" : "animate"]({d: e}).addClass(m.getClassName(), !0));
          });
        },
        animate: null
      }, {getClassName: function() {
        ...
        drawPoints: function() {
          ...
          E(a.points, function(l) {
            var p = l.graphic,
                ...
                n,
                t = !p;
            void 0 !== l.plotY && (p || (l.graphic = p = m.renderer.path().add(a.group)), p.attr(a.pointAttribs(l, l.selected && "select")).shadow(a.options.shadow), b = p.strokeWidth() % 2 / 2, g = Math.round(l.plotX) - b, r = l.plotOpen, e = l.plotClose, c = Math.min(r, e), r = Math.max(r, e), n = Math.round(l.shapeArgs.width / 2), e = Math.round(c) !== Math.round(l.plotHigh), k = r !== l.yBottom, c = Math.round(c) + b, r = Math.round(r) + b, b = [], b.push("M", g - n, r, "L", g - n, c, "L", g + n, c, "L", g + n, r, "Z", "M", g, c, "L", g, e ? Math.round(l.plotHigh) : c, "M", g, r, "L", g, k ? Math.round(l.yBottom) : r), p[t ? "attr" : "animate"]({d: b}).addClass(l.getClassName(), !0));
          });
        }
      });
    })(L);
      ...
      return {
        ...
        translate: function() {
          ...
          var a = a.onKey || "y",
              ...
              u;
          if (p && p.visible && c)
            for (g = (p.pointXOffset || 0) + (p.barW || 0) / 2, p = p.currentDataGrouping, t = e[c - 1].x + (p ? p.totalRange : 0), F(l, function(a, b) {
              return a.x - b.x;
            }), a = "plot" + a[0].toUpperCase() + a.substr(1); c-- && l[w] && !(n = e[c], p = l[w], p.y = n.y, n.x <= p.x && void 0 !== n[a] && (p.x <= t && (p.plotY = n[a], n.x < p.x && !B && (f = e[c + 1]) && void 0 !== f[a] && (u = (p.x - n.x) / (f.x - n.x), p.plotY += u * (f[a] - n[a]), p.y += u * (f.y - n.y))), w--, c++, 0 > w)); )
              ;
          C(l, function(a, c) {
            var f;
            a.plotX += g;
    ...
    (function(a, C) {
      ...
      p("flags", "column", {
        ...
        drawPoints: function() {
          var c = this.points,
              ...
              d = [];
          for (p = c.length; p--; )
            q = c[p], v = q.plotX > this.xAxis.len, g = q.plotX, A = q.stackIndex, u = q.options.shape || t.shape, l = q.plotY, void 0 !== l && (l = q.plotY + f - (void 0 !== A && A * t.stackDistance)), q.anchorX = A ? void 0 : q.plotX, y = A ? void 0 : q.plotY, A = q.graphic, void 0 !== l && 0 <= g && !v ? (A || (A = q.graphic = b.label("", null, null, u, null, null, t.useHTML).attr(this.pointAttribs(q)).css(m(t.style, q.style)).attr({
              ...
              y: l,
              anchorY: y
            }, t.allowOverlapX && (u.x = g, u.anchorX = q.anchorX), A.attr({text: q.options.title || t.title || "A"})[A.isNew ? "attr" : "animate"](u), t.allowOverlapX || (B[q.plotX] ? B[q.plotX].size = Math.max(B[q.plotX].size, A.width) : B[q.plotX] = {
              align: 0,
              size: A.width,
              target: g,
              anchorX: g
      ...
      e.flag = function(a, k, b, g, l) {
        var c = l && l.anchorX || a;
        l = l && l.anchorY || k;
        return e.circle(c - 1, l - 1, 2, 2).concat(["M", c, l, "L", a, k + g, a, k, a + b, k, a + b, k + g, a, k + g, "Z"]);
      };
      E("circle");
      E("square");
    ...
    (function(a) {
      ...
      C.prototype = {
        ...
        setRange: function(a, b) {
          ...
          l(g) && (a = Math.max(a, 0), k = Math.ceil(g * a), this.calculatedWidth = m = r(g * Math.min(b, 1) - k), m < e && (k = (g - e + m) * a, m = e), e = Math.floor(k + this.xOffset + this.yOffset), g = m / 2 - .5, this.from = a, this.to = b, f ? (this.scrollbarGroup[n]({translateY: e}), this.scrollbar[n]({height: m}), this.scrollbarRifles[n]({translateY: g}), this.scrollbarTop = e, this.scrollbarLeft = 0) : (this.scrollbarGroup[n]({translateX: e}), this.scrollbar[n]({width: m}), this.scrollbarRifles[n]({translateX: g}), this.scrollbarLeft = e, this.scrollbarTop = 0), 12 >= m ? this.scrollbarRifles.hide() : this.scrollbarRifles.show(!0), !1 === c.showFull && (0 >= a && 1 <= b ? this.group.hide() : this.group.show()), this.rendered = !0);
        },
        initEvents: function() {
          var a = this;
      ...
      g(F.prototype, "init", function(a) {
        ...
        b.options.scrollbar && b.options.scrollbar.enabled && (b.options.scrollbar.vertical = !b.horiz, b.options.startOnTick = b.options.endOnTick = !1, b.scrollbar = new C(b.chart.renderer, b.options.scrollbar, b.chart), E(b.scrollbar, "changed", function(a) {
          var c = Math.min(k(b.options.min, b.min), b.min, b.dataMin),
              f = Math.max(k(b.options.max, b.max), b.max, b.dataMax) - c,
              e;
      ...
      g(F.prototype, "render", function(a) {
        var b = Math.min(k(this.options.min, this.min), this.min, k(this.dataMin, this.min)),
            c = Math.max(k(this.options.max, this.max), this.max, k(this.dataMax, this.max)),
            f = this.scrollbar,
            e = this.titleOffset || 0;
        a.apply(this, Array.prototype.slice.call(arguments, 1));
        if (f) {
          this.horiz ? (f.position(this.left, this.top + this.height + 2 + this.chart.scrollbarsOffsets[1] + (this.opposite ? 0 : e + this.axisTitleMargin + this.offset), this.width, this.height), e = 1) : (f.position(this.left + this.width + 2 + this.chart.scrollbarsOffsets[0] + (this.opposite ? e + this.axisTitleMargin + this.offset : 0), this.top, this.width, this.height), e = 0);
          if (!this.opposite && !this.horiz || this.opposite && this.horiz)
            this.chart.scrollbarsOffsets[e] += this.scrollbar.size + this.scrollbar.options.margin;
      ...
      C.prototype = {
        ...
        drawOutline: function(a, b, c, f) {
          var d = this.navigatorOptions.maskInside,
              ...
              m = this.left - k,
              n = this.top;
          c ? (m -= h, c = n + b + e, b = n + a + e, a = ["M", m + g, n - k - e, "L", m + g, c, "L", m, c, "L", m, b, "L", m + g, b, "L", m + g, n + l + k].concat(d ? ["M", m + g, c - h, "L", m + g, b + h] : [])) : (a += m + k - e, b += m + k - e, n += h, a = ["M", m, n, "L", a, n, "L", a, n + g, "L", b, n + g, "L", b, n, "L", m + l + 2 * k, n].concat(d ? ["M", a - h, n, "L", b + h, n] : []));
          this.outline[f]({d: a});
        },
        ...
        renderElements: function() {
          var a = this,
              ...
              g = e.renderer,
              k;
          a.navigatorGroup = k = g.g("navigator").attr({
            zIndex: 8,
            visibility: "hidden"
          }).add();
        ...
        render: function(b, c, e, f) {
          ...
          g = d.inverted;
          var t,
              r = d.xAxis[0].minRange,
              y = d.xAxis[0].options.maxRange;
          if (!this.hasDragged || w(e)) {
            if (!n(b) || !n(c))
              if (p)
                e = 0, f = u(m.width, h.width);
              else
                return;
            this.left = u(m.left, d.plotLeft + k + (g ? d.plotWidth : 0));
            this.size = z = l = u(m.len, (g ? d.plotHeight : d.plotWidth) - 2 * k);
            d = g ? k : l + 2 * k;
            ...
            this.zoomedMin = Math.min(Math.max(this.fixedWidth ? this.zoomedMax - this.fixedWidth : Math.min(e, f), 0), z);
            ...
            this.scrollbar && (g ? (g = this.top - k, h = this.left - k + (q || !h.opposite ? 0 : (h.titleOffset || 0) + h.axisTitleMargin), k = l + 2 * k) : (g = this.top + (q ? this.height : -k), h = this.left - k), this.scrollbar.position(h, g, d, k), this.scrollbar.setRange(this.zoomedMin / l, this.zoomedMax / l));
            this.rendered = !0;
          }
        },
        addMouseEvents: function() {
          ...
          a.eventsToUnbind = f;
          a.series && a.series[0] && f.push(E(a.series[0].xAxis, "foundExtremes", function() {
          ...
          l.navigatorEnabled ? (l.xAxis = new F(a, f({
            ...
            translate: function(b, c) {
              var d = a.xAxis[0],
                  e = d.getExtremes(),
                  f = d.len - 2 * k,
                  h = J("min", d.options.min, e.dataMin),
                  d = J("max", d.options.max, e.dataMax) - h;
        ...
        updateNavigatorSeries: function(b) {
          var d = this,
              ...
              t = d.series = a.grep(d.series || [], function(b) {
                var c = b.baseSeries;
                return 0 > a.inArray(c, h) ? (c && (D(c, "updatedData", d.updatedDataHandler), delete c.navigatorSeries), b.destroy(), !1) : !0;
              });
          h && h.length && v(h, function(a) {
            var z = a.navigatorSeries,
                r = c({color: a.color}, g(n) ? l.navigator.series : n);
          ...
          if (n.data && (!h || !h.length) || g(n))
            d.hasNavigatorData = !1, n = a.splat(n), v(n, function(a, b) {
    ...
    (function(a) {
      ...
      C.prototype = {
        clickButton: function(a, c) {
          var g = this,
              ...
              l = g.buttonOptions[a],
              m = k.xAxis[0],
              q = k.scroller && k.scroller.getUnionExtremes() || m || {},
              d = q.dataMin,
              p = q.dataMax,
              t,
              h = m && Math.round(Math.min(m.max, n(p, m.max))),
              r = l.type,
              u,
              q = l._range,
              v,
          ...
          if (null !== d && null !== p) {
            ...
            if ("month" === r || "year" === r)
              m ? (r = {
                ...
                dataMin: d,
                dataMax: p
              }, t = m.minFromRange.call(r), b(r.newMax) && (h = r.newMax)) : q = l;
            else if (q)
              t = Math.max(h - q, d), h = Math.min(t + q, p);
            else if ("ytd" === r)
              if (m)
                void 0 === p && (d = Number.MAX_VALUE, p = Number.MIN_VALUE, e(k.series, function(a) {
                  a = a.xData;
                  d = Math.min(a[0], d);
                  p = Math.max(a[a.length - 1], p);
                }), c = !1), h = g.getYTDExtremes(p, d, k.time.useUTC), t = v = h.min, h = h.max;
              else {
        ...
        updateButtonStates: function() {
          var a = this.chart,
              ...
              k = a.scroller && a.scroller.getUnionExtremes() || c,
              l = k.dataMin,
              m = k.dataMax,
              a = this.getYTDExtremes(m, l, a.time.useUTC),
              d = a.min,
              n = a.max,
              p = this.selected,
              h = b(p),
        ...
        drawInput: function(a) {
          function e() {
            var a = v.value,
                ...
                d = k.xAxis[0],
                e = k.scroller && k.scroller.xAxis ? k.scroller.xAxis : d,
                g = e.dataMin,
                e = e.dataMax;
            c !== v.previousValue && (v.previousValue = c, b(c) || (c = a.split("-"), c = Date.UTC(t(c[0]), t(c[1]) - 1, t(c[2]))), b(c) && (k.time.useUTC || (c += 6E4 * (new Date).getTimezoneOffset()), u ? c > f.maxInput.HCTime ? c = void 0 : c < g && (c = g) : c < f.minInput.HCTime ? c = void 0 : c > e && (c = e), void 0 !== c && d.setExtremes(u ? c : d.min, u ? d.max : c, void 0, void 0, {trigger: "rangeSelectorInput"})));
          }
          var f = this,
              k = f.chart,
              n = k.renderer.style || {},
              p = k.renderer,
              r = k.options.rangeSelector,
              d = f.div,
              u = "min" === a,
              v,
              h,
        ...
        render: function(a, b) {
          ...
          if (!1 !== h.enabled) {
            ...
            !1 !== B && (U = d && this.titleCollision(f) && "top" === W && "right" === v.align && v.y - p.getBBox().height - 12 < (d.y || 0) + d.height + f.spacing[0] ? -40 : 0, "left" === v.align ? S = C : "right" === v.align && (S = -Math.max(f.axisOffset[1], -U)), p.align({
              ...
              align: v.align,
              x: v.x + S - 2
            }, !0, f.spacingBox), k = p.alignAttr.translateX + p.alignOptions.x - U + p.getBBox().x + 2, d = p.alignOptions.width, q = E.alignAttr.translateX + E.getBBox().x, S = E.getBBox().width + 20, (v.align === u.align || q + S > k && k + d > q && ba < X + p.getBBox().height) && p.attr({
            ...
            "bottom" === W && (Z = aa && "bottom" === aa.verticalAlign && aa.enabled && !aa.floating ? Z.legendHeight + n(aa.margin, 10) : 0, a = a + Z - 20, R = b - a - (m ? 0 : h.y) - 10);
            if ("top" === W)
              m && (R = 0), f.titleOffset && (R = f.titleOffset + f.options.title.margin), R += f.margin[0] - f.spacing[0] || 0;
            else if ("middle" === W)
              if (X === ba)
                R = 0 > X ? b + void 0 : b;
              else if (X || ba)
                R = 0 > X || 0 > ba ? R - Math.min(X, ba) : b - a + NaN;
      ...
      u(r.prototype, "update", function(b, c, e, f) {
        ...
        g && (g.render(), k = c.rangeSelector && c.rangeSelector.verticalAlign || g.options && g.options.verticalAlign, g.options.floating || ("bottom" === k ? this.extraBottomMargin = !0 : "middle" !== k && (this.extraTopMargin = !0)));
    ...
    (function(a) {
      var C = a.arrayMax,
          ...
          H = y.init,
          I = y.processData,
          J = n.prototype.tooltipFormatter;
      a.StockChart = a.stockChart = function(d, e, f) {
        var h = c(d) || d.nodeName,
            l = arguments[h ? 1 : 0],
            m = l.series,
            n = a.getOptions(),
            p,
            q = g(l.navigator && l.navigator.enabled, n.navigator.enabled, !0),
            t = q ? {
              startOnTick: !1,
              endOnTick: !1
            } : null,
        ...
        l.series = m;
        return h ? new r(d, l, f) : new r(l, e);
      };
      ...
      A(F.prototype, "getPlotLinePath", function(b, f, n, h, p, q) {
        ...
        l(d.isXAxis ? r.yAxis : r.xAxis, function(a) {
          if (m(a.options.id) ? -1 === a.options.id.indexOf("navigator") : 1) {
            var b = a.isXAxis ? "yAxis" : "xAxis",
                b = m(a.options[b]) ? r[b][a.options[b]] : r[b][0];
            d === b && G.push(a);
          }
        });
        ...
        e(E) && (d.horiz ? l(D, function(a) {
          ...
          if (x < v || x > v + d.width)
            p ? x = y = Math.min(Math.max(v, x), v + d.width) : b = !0;
          ...
          if (w < z || w > z + d.height)
            p ? w = A = Math.min(Math.max(z, w), d.top + d.height) : b = !0;
          b || C.push("M", x, w, "L", y, A);
        }));
      ...
      y.processData = function() {
        var a,
            ...
            c,
            f,
            g = !0 === this.options.compareStart ? 0 : 1,
            k,
            l;
        I.apply(this, arguments);
        if (this.xAxis && this.processedYData)
          for (c = this.processedXData, f = this.processedYData, k = f.length, this.pointArrayMap && (b = B("close", this.pointArrayMap), -1 === b && (b = B(this.pointValKey || "y", this.pointArrayMap))), a = 0; a < k - g; a++)
      ...
      n.prototype.tooltipFormatter = function(b) {
        b = b.replace("{point.change}", (0 < this.change ? "+" : "") + a.numberFormat(this.change, g(this.series.tooltipOptions.changeDecimals, 2)));
